...
public class BooksApi {
  ...
  */
  public FindSimilarBooksAPI200Response findSimilarBooksAPI (Integer id, Integer number) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling findSimilarBooksAPI",
        new ApiException(400, "Missing the required parameter 'id' when calling findSimilarBooksAPI"));
    }
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (FindSimilarBooksAPI200Response) ApiInvoker.deserialize(localVarResponse, "", FindSimilarBooksAPI200Response.class);
      } else {
         return null;
      }
  ...
  */
  public void findSimilarBooksAPI (Integer id, Integer number, final Response.Listener<FindSimilarBooksAPI200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((FindSimilarBooksAPI200Response) ApiInvoker.deserialize(localVarResponse,  "", FindSimilarBooksAPI200Response.class));
  ...
  */
  public SearchBooksAPI200Response searchBooksAPI (String query, Integer earliestPublishYear, Integer latestPublishYear, Double minRating, Double maxRating, String genres, String authors, String isbn, String oclc, String sort, String sortDirection, Boolean groupResults, Integer offset, Integer number) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (SearchBooksAPI200Response) ApiInvoker.deserialize(localVarResponse, "", SearchBooksAPI200Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
  ...
  */
  public void searchBooksAPI (String query, Integer earliestPublishYear, Integer latestPublishYear, Double minRating, Double maxRating, String genres, String authors, String isbn, String oclc, String sort, String sortDirection, Boolean groupResults, Integer offset, Integer number, final Response.Listener<SearchBooksAPI200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((SearchBooksAPI200Response) ApiInvoker.deserialize(localVarResponse,  "", SearchBooksAPI200Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
