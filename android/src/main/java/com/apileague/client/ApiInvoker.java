...
import com.apileague.client.request.GetRequest;
import com.apileague.client.request.PostRequest;
import com.apileague.client.request.PutRequest;
import com.apileague.client.request.DeleteRequest;
import com.apileague.client.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    setUserAgent("OpenAPI-Generator/1.2.0/android");
