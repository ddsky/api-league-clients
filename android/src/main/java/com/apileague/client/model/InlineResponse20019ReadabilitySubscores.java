...
public class InlineResponse20019ReadabilitySubscores {
  ...
  public boolean equals(Object o) {
    ...
    return (this.readingTimeSeconds == null ? inlineResponse20019ReadabilitySubscores.readingTimeSeconds == null : this.readingTimeSeconds.equals(inlineResponse20019ReadabilitySubscores.readingTimeSeconds)) &&
        (this.forcast == null ? inlineResponse20019ReadabilitySubscores.forcast == null : this.forcast.equals(inlineResponse20019ReadabilitySubscores.forcast)) &&
        (this.flesch == null ? inlineResponse20019ReadabilitySubscores.flesch == null : this.flesch.equals(inlineResponse20019ReadabilitySubscores.flesch)) &&
        (this.smog == null ? inlineResponse20019ReadabilitySubscores.smog == null : this.smog.equals(inlineResponse20019ReadabilitySubscores.smog)) &&
        (this.ari == null ? inlineResponse20019ReadabilitySubscores.ari == null : this.ari.equals(inlineResponse20019ReadabilitySubscores.ari)) &&
        (this.lix == null ? inlineResponse20019ReadabilitySubscores.lix == null : this.lix.equals(inlineResponse20019ReadabilitySubscores.lix)) &&
        (this.colemanLiau == null ? inlineResponse20019ReadabilitySubscores.colemanLiau == null : this.colemanLiau.equals(inlineResponse20019ReadabilitySubscores.colemanLiau)) &&
        (this.kincaid == null ? inlineResponse20019ReadabilitySubscores.kincaid == null : this.kincaid.equals(inlineResponse20019ReadabilitySubscores.kincaid)) &&
        (this.fog == null ? inlineResponse20019ReadabilitySubscores.fog == null : this.fog.equals(inlineResponse20019ReadabilitySubscores.fog));
  }
