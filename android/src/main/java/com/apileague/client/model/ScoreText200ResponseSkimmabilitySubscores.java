...
public class ScoreText200ResponseSkimmabilitySubscores {
  ...
  public boolean equals(Object o) {
    ...
    return (this.bulletPointRatioScore == null ? scoreText200ResponseSkimmabilitySubscores.bulletPointRatioScore == null : this.bulletPointRatioScore.equals(scoreText200ResponseSkimmabilitySubscores.bulletPointRatioScore)) &&
        (this.imageScore == null ? scoreText200ResponseSkimmabilitySubscores.imageScore == null : this.imageScore.equals(scoreText200ResponseSkimmabilitySubscores.imageScore)) &&
        (this.highlightedWordRatioScore == null ? scoreText200ResponseSkimmabilitySubscores.highlightedWordRatioScore == null : this.highlightedWordRatioScore.equals(scoreText200ResponseSkimmabilitySubscores.highlightedWordRatioScore)) &&
        (this.videoScore == null ? scoreText200ResponseSkimmabilitySubscores.videoScore == null : this.videoScore.equals(scoreText200ResponseSkimmabilitySubscores.videoScore)) &&
        (this.paragraphScore == null ? scoreText200ResponseSkimmabilitySubscores.paragraphScore == null : this.paragraphScore.equals(scoreText200ResponseSkimmabilitySubscores.paragraphScore)) &&
        (this.paragraphHeadlineRatioScore == null ? scoreText200ResponseSkimmabilitySubscores.paragraphHeadlineRatioScore == null : this.paragraphHeadlineRatioScore.equals(scoreText200ResponseSkimmabilitySubscores.paragraphHeadlineRatioScore));
  }
