...
public class MediaApi {
  ...
  * Rescale an image to a specific width and height. The image will be resized to fit the specified width and height while maintaining the original aspect ratio unless the crop parameter is set to true. The image will be returned in the same format as the original image.
   ...
   * @return File
  */
  public File rescaleImage (String url, Integer width, Integer height, Boolean crop) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'url' is set
    if (url == null) {
  ...
  */
  public void rescaleImage (String url, Integer width, Integer height, Boolean crop, final Response.Listener<File> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public SearchIcons200Response searchIcons (String query, Boolean onlyPublicDomain, Integer number) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'query' is set
    if (query == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'query' when calling searchIcons",
        new ApiException(400, "Missing the required parameter 'query' when calling searchIcons"));
    }
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (SearchIcons200Response) ApiInvoker.deserialize(localVarResponse, "", SearchIcons200Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
  ...
  */
  public void searchIcons (String query, Boolean onlyPublicDomain, Integer number, final Response.Listener<SearchIcons200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((SearchIcons200Response) ApiInvoker.deserialize(localVarResponse,  "", SearchIcons200Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
