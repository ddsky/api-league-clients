...
```php
findSimilarBooks($id, $number): \com.apileague.client\com.apileague.client.model\InlineResponse2001
```
...
$apiInstance = new com.apileague.client\Api\BooksApi(
...
[**\com.apileague.client\com.apileague.client.model\InlineResponse2001**](../Model/InlineResponse2001.md)
...
```php
searchBooks($query, $earliest_publish_year, $latest_publish_year, $min_rating, $max_rating, $genres, $authors, $isbn, $oclc, $sort, $sort_direction, $group_results, $offset, $number): \com.apileague.client\com.apileague.client.model\InlineResponse200
```
...
$min_rating = 0.8; // double | The minimum rating the book must have gotten in the interval [0,1].
$max_rating = 0.99; // double | The maximum rating the book must have gotten in the interval [0,1].
...
[**\com.apileague.client\com.apileague.client.model\InlineResponse200**](../Model/InlineResponse200.md)
