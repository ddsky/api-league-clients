...
class TextApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['partOfSpeechTagging'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\PartOfSpeechTagging200Response
     */
    public function partOfSpeechTagging($text, string $contentType = self::contentTypes['partOfSpeechTagging'][0])
    {
        list($response) = $this->partOfSpeechTaggingWithHttpInfo($text, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\PartOfSpeechTagging200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function partOfSpeechTaggingWithHttpInfo($text, string $contentType = self::contentTypes['partOfSpeechTagging'][0])
    {
        $request = $this->partOfSpeechTaggingRequest($text, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\PartOfSpeechTagging200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\PartOfSpeechTagging200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\PartOfSpeechTagging200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\PartOfSpeechTagging200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\PartOfSpeechTagging200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function partOfSpeechTaggingAsync($text, string $contentType = self::contentTypes['partOfSpeechTagging'][0])
    {
        return $this->partOfSpeechTaggingAsyncWithHttpInfo($text, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function partOfSpeechTaggingAsyncWithHttpInfo($text, string $contentType = self::contentTypes['partOfSpeechTagging'][0])
    {
        $returnType = '\OpenAPI\Client\Model\PartOfSpeechTagging200Response';
        $request = $this->partOfSpeechTaggingRequest($text, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function partOfSpeechTaggingRequest($text, string $contentType = self::contentTypes['partOfSpeechTagging'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['textStemming'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\TextStemming200Response
     */
    public function textStemming($text, string $contentType = self::contentTypes['textStemming'][0])
    {
        list($response) = $this->textStemmingWithHttpInfo($text, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\TextStemming200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function textStemmingWithHttpInfo($text, string $contentType = self::contentTypes['textStemming'][0])
    {
        $request = $this->textStemmingRequest($text, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\TextStemming200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\TextStemming200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\TextStemming200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\TextStemming200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\TextStemming200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function textStemmingAsync($text, string $contentType = self::contentTypes['textStemming'][0])
    {
        return $this->textStemmingAsyncWithHttpInfo($text, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function textStemmingAsyncWithHttpInfo($text, string $contentType = self::contentTypes['textStemming'][0])
    {
        $returnType = '\OpenAPI\Client\Model\TextStemming200Response';
        $request = $this->textStemmingRequest($text, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function textStemmingRequest($text, string $contentType = self::contentTypes['textStemming'][0])
    {
