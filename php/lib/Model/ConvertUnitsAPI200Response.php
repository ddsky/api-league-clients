...
/**
 * ConvertUnitsAPI200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConvertUnitsAPI200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'convertUnitsAPI_200_response';
    ...
    */
     ...
     * Sets target_unit
     *
     * @param string|null $target_unit target_unit
     *
     * @return self
     */
    public function setTargetUnit($target_unit)
    {
        if (is_null($target_unit)) {
            array_push($this->openAPINullablesSetToNull, 'target_unit');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('target_unit', $nullablesSetToNull);
            if ($index !== FALSE) {
