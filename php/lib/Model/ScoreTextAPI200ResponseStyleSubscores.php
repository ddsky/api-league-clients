...
/**
 * ScoreTextAPI200ResponseStyleSubscores Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScoreTextAPI200ResponseStyleSubscores implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scoreTextAPI_200_response_style_subscores';
    ...
    {
        $this->setIfExists('abbreviation_score', $data ?? [], null);
        $this->setIfExists('style_score', $data ?? [], null);
        $this->setIfExists('spelling_score', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($abbreviation_score)) {
            throw new \InvalidArgumentException('non-nullable abbreviation_score cannot be null');
        }
    ...
    {
        if (is_null($style_score)) {
            throw new \InvalidArgumentException('non-nullable style_score cannot be null');
        }
    ...
    {
        if (is_null($spelling_score)) {
            throw new \InvalidArgumentException('non-nullable spelling_score cannot be null');
        }
