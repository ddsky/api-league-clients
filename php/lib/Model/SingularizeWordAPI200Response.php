...
/**
 * SingularizeWordAPI200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SingularizeWordAPI200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'singularizeWordAPI_200_response';
    ...
    */
     ...
     * Sets singular
     *
     * @param string|null $singular singular
     *
     * @return self
     */
    ...
    {
        if (is_null($singular)) {
            array_push($this->openAPINullablesSetToNull, 'singular');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('singular', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
