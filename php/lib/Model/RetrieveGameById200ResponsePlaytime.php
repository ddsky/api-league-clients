...
/**
 * RetrieveGameById200ResponsePlaytime Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RetrieveGameById200ResponsePlaytime implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'retrieveGameById_200_response_playtime';
    ...
    {
        $this->setIfExists('percentiles', $data ?? [], null);
    ...
    */
     ...
     * Sets percentiles
     *
     * @param int[]|null $percentiles percentiles
     *
     * @return self
     */
    public function setPercentiles($percentiles)
    {
        if (is_null($percentiles)) {
            throw new \InvalidArgumentException('non-nullable percentiles cannot be null');
        }
