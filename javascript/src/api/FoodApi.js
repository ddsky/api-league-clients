...
export default class FoodApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the computeNutritionAPI operation.
     * @callback module:api/FoodApi~computeNutritionAPICallback
     * @param {String} error Error message, if any.
     * @param {module:model/ComputeNutritionAPI200Response} data The data returned by the service call.
     ...
     * @param {module:api/FoodApi~computeNutritionAPICallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ComputeNutritionAPI200Response}
     */
    computeNutritionAPI(ingredients, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ingredients' is set
      if (ingredients === undefined || ingredients === null) {
        throw new Error("Missing the required parameter 'ingredients' when calling computeNutritionAPI");
      }
      ...
      let returnType = ComputeNutritionAPI200Response;
    ...
    /**
     * Callback function to receive the result of the retrieveRecipeInformationAPI operation.
     * @callback module:api/FoodApi~retrieveRecipeInformationAPICallback
     * @param {String} error Error message, if any.
     * @param {module:model/RetrieveRecipeInformationAPI200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/FoodApi~retrieveRecipeInformationAPICallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RetrieveRecipeInformationAPI200Response}
     */
    retrieveRecipeInformationAPI(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling retrieveRecipeInformationAPI");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = RetrieveRecipeInformationAPI200Response;
      return this.apiClient.callApi(
        '/retrieve-recipe', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the searchDrinksAPI operation.
     * @callback module:api/FoodApi~searchDrinksAPICallback
     * @param {String} error Error message, if any.
     * @param {module:model/SearchDrinksAPI200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/FoodApi~searchDrinksAPICallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SearchDrinksAPI200Response}
     */
    searchDrinksAPI(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = SearchDrinksAPI200Response;
      return this.apiClient.callApi(
        '/search-drinks', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the searchRecipesAPI operation.
     * @callback module:api/FoodApi~searchRecipesAPICallback
     * @param {String} error Error message, if any.
     * @param {module:model/SearchRecipesAPI200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/FoodApi~searchRecipesAPICallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SearchRecipesAPI200Response}
     */
    searchRecipesAPI(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = SearchRecipesAPI200Response;
      return this.apiClient.callApi(
        '/search-recipes', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the searchRestaurantsAPI operation.
     * @callback module:api/FoodApi~searchRestaurantsAPICallback
     * @param {String} error Error message, if any.
     * @param {module:model/SearchRestaurantsAPI200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/FoodApi~searchRestaurantsAPICallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SearchRestaurantsAPI200Response}
     */
    searchRestaurantsAPI(lat, lon, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'lat' is set
      if (lat === undefined || lat === null) {
        throw new Error("Missing the required parameter 'lat' when calling searchRestaurantsAPI");
      }
      // verify the required parameter 'lon' is set
      if (lon === undefined || lon === null) {
        throw new Error("Missing the required parameter 'lon' when calling searchRestaurantsAPI");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = SearchRestaurantsAPI200Response;
      return this.apiClient.callApi(
