...
export default class TextApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the detectGenderByName operation.
     * @callback module:api/TextApi~detectGenderByNameCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DetectGenderByName200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TextApi~detectGenderByNameCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DetectGenderByName200Response}
     */
    detectGenderByName(name, callback) {
      let postBody = null;
      // verify the required parameter 'name' is set
      if (name === undefined || name === null) {
        throw new Error("Missing the required parameter 'name' when calling detectGenderByName");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = DetectGenderByName200Response;
      return this.apiClient.callApi(
        '/detect-gender', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the stemText operation.
     * @callback module:api/TextApi~stemTextCallback
     * @param {String} error Error message, if any.
     * @param {module:model/StemText200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TextApi~stemTextCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/StemText200Response}
     */
    stemText(text, callback) {
      let postBody = null;
      // verify the required parameter 'text' is set
      if (text === undefined || text === null) {
        throw new Error("Missing the required parameter 'text' when calling stemText");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = StemText200Response;
      return this.apiClient.callApi(
        '/stem-text', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the tagPartOfSpeech operation.
     * @callback module:api/TextApi~tagPartOfSpeechCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TagPartOfSpeech200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TextApi~tagPartOfSpeechCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TagPartOfSpeech200Response}
     */
    tagPartOfSpeech(text, callback) {
      let postBody = null;
      // verify the required parameter 'text' is set
      if (text === undefined || text === null) {
        throw new Error("Missing the required parameter 'text' when calling tagPartOfSpeech");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = TagPartOfSpeech200Response;
      return this.apiClient.callApi(
        '/tag-pos', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
