...
export default class MediaApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchIcons operation.
     * @callback module:api/MediaApi~searchIconsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SearchIcons200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MediaApi~searchIconsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SearchIcons200Response}
     */
    searchIcons(query, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'query' is set
      if (query === undefined || query === null) {
        throw new Error("Missing the required parameter 'query' when calling searchIcons");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = SearchIcons200Response;
      return this.apiClient.callApi(
        '/search-icons', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
