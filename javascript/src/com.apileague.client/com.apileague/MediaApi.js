...
/**
* Media service.
* @module com.apileague.client/com.apileague/MediaApi
* @version 1.0
*/
export default class MediaApi {
    ...
    * @alias module:com.apileague.client/com.apileague/MediaApi
    * @class
    ...
    */
     ...
     * @callback module:com.apileague.client/com.apileague/MediaApi~detectMainImageColorCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:com.apileague.client/com.apileague.client.model/InlineResponse20029>} data The data returned by the service call.
     ...
     * @param {module:com.apileague.client/com.apileague/MediaApi~detectMainImageColorCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:com.apileague.client/com.apileague.client.model/InlineResponse20029>}
     */
     ...
     * @callback module:com.apileague.client/com.apileague/MediaApi~rescaleImageCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:com.apileague.client/com.apileague/MediaApi~rescaleImageCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:com.apileague.client/com.apileague/MediaApi~searchRoyaltyFreeImagesCallback
     * @param {String} error Error message, if any.
     * @param {module:com.apileague.client/com.apileague.client.model/InlineResponse20028} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.number The number of images to return in range [1,10]
     * @param {module:com.apileague.client/com.apileague/MediaApi~searchRoyaltyFreeImagesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:com.apileague.client/com.apileague.client.model/InlineResponse20028}
     */
