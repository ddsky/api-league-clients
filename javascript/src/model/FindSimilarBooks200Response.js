    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('similar_books')) {
                obj['similar_books'] = ApiClient.convertToType(data['similar_books'], [SearchBooks200ResponseBooksInnerInner]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        if (data['similar_books']) { // data not null
            ...
            for (const item of data['similar_books']) {
                SearchBooks200ResponseBooksInnerInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/SearchBooks200ResponseBooksInnerInner>} similar_books
 */
