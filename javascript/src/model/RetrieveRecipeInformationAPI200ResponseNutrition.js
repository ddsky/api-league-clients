...
/**
 * The RetrieveRecipeInformationAPI200ResponseNutrition model module.
 * @module model/RetrieveRecipeInformationAPI200ResponseNutrition
 * @version 1.6.4
 */
class RetrieveRecipeInformationAPI200ResponseNutrition {
    /**
     * Constructs a new <code>RetrieveRecipeInformationAPI200ResponseNutrition</code>.
     * @alias module:model/RetrieveRecipeInformationAPI200ResponseNutrition
     */
    constructor() { 
        
        RetrieveRecipeInformationAPI200ResponseNutrition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RetrieveRecipeInformationAPI200ResponseNutrition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RetrieveRecipeInformationAPI200ResponseNutrition} obj Optional instance to populate.
     * @return {module:model/RetrieveRecipeInformationAPI200ResponseNutrition} The populated <code>RetrieveRecipeInformationAPI200ResponseNutrition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RetrieveRecipeInformationAPI200ResponseNutrition();
            ...
            if (data.hasOwnProperty('ingredient_breakdown')) {
                obj['ingredient_breakdown'] = ApiClient.convertToType(data['ingredient_breakdown'], [RetrieveRecipeInformationAPI200ResponseNutritionIngredientBreakdownInner]);
            }
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = ApiClient.convertToType(data['properties'], [SearchRecipesAPI200ResponseRecipesInnerNutritionNutrientsInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RetrieveRecipeInformationAPI200ResponseNutrition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RetrieveRecipeInformationAPI200ResponseNutrition</code>.
     */
    static validateJSON(data) {
        ...
        if (data['ingredient_breakdown']) { // data not null
            ...
            for (const item of data['ingredient_breakdown']) {
                RetrieveRecipeInformationAPI200ResponseNutritionIngredientBreakdownInner.validateJSON(item);
            };
        }
 ...
 */
RetrieveRecipeInformationAPI200ResponseNutrition.prototype['weight_per_serving'] = undefined;

/**
 * @member {module:model/SearchDrinksAPI200ResponseDrinksInnerNutritionCaloricBreakdown} caloric_breakdown
 */
RetrieveRecipeInformationAPI200ResponseNutrition.prototype['caloric_breakdown'] = undefined;

/**
 * @member {Array.<module:model/SearchDrinksAPI200ResponseDrinksInnerNutritionFlavonoidsInner>} flavonoids
 */
RetrieveRecipeInformationAPI200ResponseNutrition.prototype['flavonoids'] = undefined;

/**
 * @member {Array.<module:model/RetrieveRecipeInformationAPI200ResponseNutritionIngredientBreakdownInner>} ingredient_breakdown
 */
RetrieveRecipeInformationAPI200ResponseNutrition.prototype['ingredient_breakdown'] = undefined;

/**
 * @member {Array.<module:model/SearchRecipesAPI200ResponseRecipesInnerNutritionNutrientsInner>} properties
 */
RetrieveRecipeInformationAPI200ResponseNutrition.prototype['properties'] = undefined;

/**
 * @member {Array.<module:model/SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner>} nutrients
 */
RetrieveRecipeInformationAPI200ResponseNutrition.prototype['nutrients'] = undefined;
...
export default RetrieveRecipeInformationAPI200ResponseNutrition;
