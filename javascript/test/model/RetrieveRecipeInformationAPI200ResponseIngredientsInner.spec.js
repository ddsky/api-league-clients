...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApileagueJs.RetrieveRecipeInformationAPI200ResponseIngredientsInner();
  });
  ...
  describe('RetrieveRecipeInformationAPI200ResponseIngredientsInner', function() {
    it('should create an instance of RetrieveRecipeInformationAPI200ResponseIngredientsInner', function() {
      // uncomment below and update the code to test RetrieveRecipeInformationAPI200ResponseIngredientsInner
      //var instance = new ApileagueJs.RetrieveRecipeInformationAPI200ResponseIngredientsInner();
      //expect(instance).to.be.a(ApileagueJs.RetrieveRecipeInformationAPI200ResponseIngredientsInner);
    });
