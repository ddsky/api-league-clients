...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApileagueJs.SearchRestaurantsAPI200ResponseRestaurantsInnerAddress();
  });
  ...
  describe('SearchRestaurantsAPI200ResponseRestaurantsInnerAddress', function() {
    it('should create an instance of SearchRestaurantsAPI200ResponseRestaurantsInnerAddress', function() {
      // uncomment below and update the code to test SearchRestaurantsAPI200ResponseRestaurantsInnerAddress
      //var instance = new ApileagueJs.SearchRestaurantsAPI200ResponseRestaurantsInnerAddress();
      //expect(instance).to.be.a(ApileagueJs.SearchRestaurantsAPI200ResponseRestaurantsInnerAddress);
    });
