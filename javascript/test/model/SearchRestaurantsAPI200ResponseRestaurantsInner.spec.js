...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApileagueJs.SearchRestaurantsAPI200ResponseRestaurantsInner();
  });
  ...
  describe('SearchRestaurantsAPI200ResponseRestaurantsInner', function() {
    it('should create an instance of SearchRestaurantsAPI200ResponseRestaurantsInner', function() {
      // uncomment below and update the code to test SearchRestaurantsAPI200ResponseRestaurantsInner
      //var instance = new ApileagueJs.SearchRestaurantsAPI200ResponseRestaurantsInner();
      //expect(instance).to.be.a(ApileagueJs.SearchRestaurantsAPI200ResponseRestaurantsInner);
    });
