...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApileagueJs.RetrieveRecipeInformationAPI200ResponseNutrition();
  });
  ...
  describe('RetrieveRecipeInformationAPI200ResponseNutrition', function() {
    it('should create an instance of RetrieveRecipeInformationAPI200ResponseNutrition', function() {
      // uncomment below and update the code to test RetrieveRecipeInformationAPI200ResponseNutrition
      //var instance = new ApileagueJs.RetrieveRecipeInformationAPI200ResponseNutrition();
      //expect(instance).to.be.a(ApileagueJs.RetrieveRecipeInformationAPI200ResponseNutrition);
    });
