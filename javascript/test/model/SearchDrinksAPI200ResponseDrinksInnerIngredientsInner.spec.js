...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApileagueJs.SearchDrinksAPI200ResponseDrinksInnerIngredientsInner();
  });
  ...
  describe('SearchDrinksAPI200ResponseDrinksInnerIngredientsInner', function() {
    it('should create an instance of SearchDrinksAPI200ResponseDrinksInnerIngredientsInner', function() {
      // uncomment below and update the code to test SearchDrinksAPI200ResponseDrinksInnerIngredientsInner
      //var instance = new ApileagueJs.SearchDrinksAPI200ResponseDrinksInnerIngredientsInner();
      //expect(instance).to.be.a(ApileagueJs.SearchDrinksAPI200ResponseDrinksInnerIngredientsInner);
    });
