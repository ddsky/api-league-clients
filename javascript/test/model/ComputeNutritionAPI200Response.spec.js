...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApileagueJs.ComputeNutritionAPI200Response();
  });
  ...
  describe('ComputeNutritionAPI200Response', function() {
    it('should create an instance of ComputeNutritionAPI200Response', function() {
      // uncomment below and update the code to test ComputeNutritionAPI200Response
      //var instance = new ApileagueJs.ComputeNutritionAPI200Response();
      //expect(instance).to.be.a(ApileagueJs.ComputeNutritionAPI200Response);
    });
