...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApileagueJs.ScoreTextAPI200ResponseSkimmabilitySubscores();
  });
  ...
  describe('ScoreTextAPI200ResponseSkimmabilitySubscores', function() {
    it('should create an instance of ScoreTextAPI200ResponseSkimmabilitySubscores', function() {
      // uncomment below and update the code to test ScoreTextAPI200ResponseSkimmabilitySubscores
      //var instance = new ApileagueJs.ScoreTextAPI200ResponseSkimmabilitySubscores();
      //expect(instance).to.be.a(ApileagueJs.ScoreTextAPI200ResponseSkimmabilitySubscores);
    });
