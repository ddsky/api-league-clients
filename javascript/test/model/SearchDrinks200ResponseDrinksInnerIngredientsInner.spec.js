...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApileagueJs.SearchDrinks200ResponseDrinksInnerIngredientsInner();
  });
  ...
  describe('SearchDrinks200ResponseDrinksInnerIngredientsInner', function() {
    it('should create an instance of SearchDrinks200ResponseDrinksInnerIngredientsInner', function() {
      // uncomment below and update the code to test SearchDrinks200ResponseDrinksInnerIngredientsInner
      //var instance = new ApileagueJs.SearchDrinks200ResponseDrinksInnerIngredientsInner();
      //expect(instance).to.be.a(ApileagueJs.SearchDrinks200ResponseDrinksInnerIngredientsInner);
    });
