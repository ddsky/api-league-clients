...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApileagueJs.SearchDrinks200ResponseDrinksInner();
  });
  ...
  describe('SearchDrinks200ResponseDrinksInner', function() {
    it('should create an instance of SearchDrinks200ResponseDrinksInner', function() {
      // uncomment below and update the code to test SearchDrinks200ResponseDrinksInner
      //var instance = new ApileagueJs.SearchDrinks200ResponseDrinksInner();
      //expect(instance).to.be.a(ApileagueJs.SearchDrinks200ResponseDrinksInner);
    });
