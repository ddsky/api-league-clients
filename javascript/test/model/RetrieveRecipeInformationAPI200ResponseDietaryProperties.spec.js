...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApileagueJs.RetrieveRecipeInformationAPI200ResponseDietaryProperties();
  });
  ...
  describe('RetrieveRecipeInformationAPI200ResponseDietaryProperties', function() {
    it('should create an instance of RetrieveRecipeInformationAPI200ResponseDietaryProperties', function() {
      // uncomment below and update the code to test RetrieveRecipeInformationAPI200ResponseDietaryProperties
      //var instance = new ApileagueJs.RetrieveRecipeInformationAPI200ResponseDietaryProperties();
      //expect(instance).to.be.a(ApileagueJs.RetrieveRecipeInformationAPI200ResponseDietaryProperties);
    });
