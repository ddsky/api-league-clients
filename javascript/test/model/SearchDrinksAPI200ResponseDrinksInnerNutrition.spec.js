...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApileagueJs.SearchDrinksAPI200ResponseDrinksInnerNutrition();
  });
  ...
  describe('SearchDrinksAPI200ResponseDrinksInnerNutrition', function() {
    it('should create an instance of SearchDrinksAPI200ResponseDrinksInnerNutrition', function() {
      // uncomment below and update the code to test SearchDrinksAPI200ResponseDrinksInnerNutrition
      //var instance = new ApileagueJs.SearchDrinksAPI200ResponseDrinksInnerNutrition();
      //expect(instance).to.be.a(ApileagueJs.SearchDrinksAPI200ResponseDrinksInnerNutrition);
    });
