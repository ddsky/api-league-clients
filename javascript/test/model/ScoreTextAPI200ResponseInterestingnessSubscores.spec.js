...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApileagueJs.ScoreTextAPI200ResponseInterestingnessSubscores();
  });
  ...
  describe('ScoreTextAPI200ResponseInterestingnessSubscores', function() {
    it('should create an instance of ScoreTextAPI200ResponseInterestingnessSubscores', function() {
      // uncomment below and update the code to test ScoreTextAPI200ResponseInterestingnessSubscores
      //var instance = new ApileagueJs.ScoreTextAPI200ResponseInterestingnessSubscores();
      //expect(instance).to.be.a(ApileagueJs.ScoreTextAPI200ResponseInterestingnessSubscores);
    });
