...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApileagueJs.ScoreTextAPI200ResponseStyleSubscores();
  });
  ...
  describe('ScoreTextAPI200ResponseStyleSubscores', function() {
    it('should create an instance of ScoreTextAPI200ResponseStyleSubscores', function() {
      // uncomment below and update the code to test ScoreTextAPI200ResponseStyleSubscores
      //var instance = new ApileagueJs.ScoreTextAPI200ResponseStyleSubscores();
      //expect(instance).to.be.a(ApileagueJs.ScoreTextAPI200ResponseStyleSubscores);
    });
