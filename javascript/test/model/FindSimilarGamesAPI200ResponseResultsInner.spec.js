...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApileagueJs.FindSimilarGamesAPI200ResponseResultsInner();
  });
  ...
  describe('FindSimilarGamesAPI200ResponseResultsInner', function() {
    it('should create an instance of FindSimilarGamesAPI200ResponseResultsInner', function() {
      // uncomment below and update the code to test FindSimilarGamesAPI200ResponseResultsInner
      //var instance = new ApileagueJs.FindSimilarGamesAPI200ResponseResultsInner();
      //expect(instance).to.be.a(ApileagueJs.FindSimilarGamesAPI200ResponseResultsInner);
    });
