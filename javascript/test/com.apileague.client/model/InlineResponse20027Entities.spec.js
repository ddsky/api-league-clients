...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiLeague.InlineResponse20027Entities();
  });
  ...
  describe('InlineResponse20027Entities', function() {
    it('should create an instance of InlineResponse20027Entities', function() {
      // uncomment below and update the code to test InlineResponse20027Entities
      //var instance = new ApiLeague.InlineResponse20027Entities();
      //expect(instance).to.be.a(ApiLeague.InlineResponse20027Entities);
    });
