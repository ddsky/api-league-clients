...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiLeague.InlineResponse20018Interestingness();
  });
  ...
  describe('InlineResponse20018Interestingness', function() {
    it('should create an instance of InlineResponse20018Interestingness', function() {
      // uncomment below and update the code to test InlineResponse20018Interestingness
      //var instance = new ApiLeague.InlineResponse20018Interestingness();
      //expect(instance).to.be.a(ApiLeague.InlineResponse20018Interestingness);
    });
