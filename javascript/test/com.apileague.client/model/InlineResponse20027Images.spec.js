...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiLeague.InlineResponse20027Images();
  });
  ...
  describe('InlineResponse20027Images', function() {
    it('should create an instance of InlineResponse20027Images', function() {
      // uncomment below and update the code to test InlineResponse20027Images
      //var instance = new ApiLeague.InlineResponse20027Images();
      //expect(instance).to.be.a(ApiLeague.InlineResponse20027Images);
    });
