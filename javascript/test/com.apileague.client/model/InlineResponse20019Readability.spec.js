...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiLeague.InlineResponse20019Readability();
  });
  ...
  describe('InlineResponse20019Readability', function() {
    it('should create an instance of InlineResponse20019Readability', function() {
      // uncomment below and update the code to test InlineResponse20019Readability
      //var instance = new ApiLeague.InlineResponse20019Readability();
      //expect(instance).to.be.a(ApiLeague.InlineResponse20019Readability);
    });
