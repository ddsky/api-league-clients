...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiLeague.InlineResponse20026Entities();
  });
  ...
  describe('InlineResponse20026Entities', function() {
    it('should create an instance of InlineResponse20026Entities', function() {
      // uncomment below and update the code to test InlineResponse20026Entities
      //var instance = new ApiLeague.InlineResponse20026Entities();
      //expect(instance).to.be.a(ApiLeague.InlineResponse20026Entities);
    });
