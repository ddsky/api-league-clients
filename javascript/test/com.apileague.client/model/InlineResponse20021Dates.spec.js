...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiLeague.InlineResponse20021Dates();
  });
  ...
  describe('InlineResponse20021Dates', function() {
    it('should create an instance of InlineResponse20021Dates', function() {
      // uncomment below and update the code to test InlineResponse20021Dates
      //var instance = new ApiLeague.InlineResponse20021Dates();
      //expect(instance).to.be.a(ApiLeague.InlineResponse20021Dates);
    });
