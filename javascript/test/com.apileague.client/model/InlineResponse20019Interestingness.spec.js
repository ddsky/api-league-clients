...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiLeague.InlineResponse20019Interestingness();
  });
  ...
  describe('InlineResponse20019Interestingness', function() {
    it('should create an instance of InlineResponse20019Interestingness', function() {
      // uncomment below and update the code to test InlineResponse20019Interestingness
      //var instance = new ApiLeague.InlineResponse20019Interestingness();
      //expect(instance).to.be.a(ApiLeague.InlineResponse20019Interestingness);
    });
