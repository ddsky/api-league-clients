...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiLeague.InlineResponse20018Style();
  });
  ...
  describe('InlineResponse20018Style', function() {
    it('should create an instance of InlineResponse20018Style', function() {
      // uncomment below and update the code to test InlineResponse20018Style
      //var instance = new ApiLeague.InlineResponse20018Style();
      //expect(instance).to.be.a(ApiLeague.InlineResponse20018Style);
    });
