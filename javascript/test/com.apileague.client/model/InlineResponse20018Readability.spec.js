...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiLeague.InlineResponse20018Readability();
  });
  ...
  describe('InlineResponse20018Readability', function() {
    it('should create an instance of InlineResponse20018Readability', function() {
      // uncomment below and update the code to test InlineResponse20018Readability
      //var instance = new ApiLeague.InlineResponse20018Readability();
      //expect(instance).to.be.a(ApiLeague.InlineResponse20018Readability);
    });
