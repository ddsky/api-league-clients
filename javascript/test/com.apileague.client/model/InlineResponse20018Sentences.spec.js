...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiLeague.InlineResponse20018Sentences();
  });
  ...
  describe('InlineResponse20018Sentences', function() {
    it('should create an instance of InlineResponse20018Sentences', function() {
      // uncomment below and update the code to test InlineResponse20018Sentences
      //var instance = new ApiLeague.InlineResponse20018Sentences();
      //expect(instance).to.be.a(ApiLeague.InlineResponse20018Sentences);
    });
