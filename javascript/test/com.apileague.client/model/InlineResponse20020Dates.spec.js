...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiLeague.InlineResponse20020Dates();
  });
  ...
  describe('InlineResponse20020Dates', function() {
    it('should create an instance of InlineResponse20020Dates', function() {
      // uncomment below and update the code to test InlineResponse20020Dates
      //var instance = new ApiLeague.InlineResponse20020Dates();
      //expect(instance).to.be.a(ApiLeague.InlineResponse20020Dates);
    });
