...
export class RetrieveRecipeInformationAPI200ResponseIngredientsInner {
    'image'?: string | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "measures",
            "baseName": "measures",
            "type": "RetrieveRecipeInformationAPI200ResponseIngredientsInnerMeasures",
            "format": ""
        },
        {
            "name": "original",
    ...
    static getAttributeTypeMap() {
        return RetrieveRecipeInformationAPI200ResponseIngredientsInner.attributeTypeMap;
    }
