...
export class ExtractNewsAPI200Response {
    'title'?: string | null;
    'text'?: string | null;
    'url'?: string | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "images",
            "baseName": "images",
            "type": "Array<ExtractNewsAPI200ResponseImagesInner>",
            "format": ""
        },
        {
            "name": "videos",
            "baseName": "videos",
            "type": "Array<ExtractNewsAPI200ResponseVideosInner>",
            "format": ""
        },
        {
            "name": "publishDate",
    ...
    static getAttributeTypeMap() {
        return ExtractNewsAPI200Response.attributeTypeMap;
    }
