...
export class SearchDrinksAPI200ResponseDrinksInnerInstructionsInnerStepsInner {
    'number'?: number;
    ...
    static getAttributeTypeMap() {
        return SearchDrinksAPI200ResponseDrinksInnerInstructionsInnerStepsInner.attributeTypeMap;
    }
