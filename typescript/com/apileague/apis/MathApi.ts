...
import { InlineResponse20030 } from '..com/apileague/client/model/models/InlineResponse20030';
...
export class MathApiResponseProcessor {
     ...
     */
     public async convertUnits(response: ResponseContext): Promise<InlineResponse20030 > {
