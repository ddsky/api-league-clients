...
import { InlineResponse2002 } from '..com/apileague/client/model/models/InlineResponse2002';
import { InlineResponse2003 } from '..com/apileague/client/model/models/InlineResponse2003';
...
export class NewsApiResponseProcessor {
     ...
     */
     public async extractNews(response: ResponseContext): Promise<InlineResponse2003 > {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async searchNews(response: ResponseContext): Promise<InlineResponse2002 > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
