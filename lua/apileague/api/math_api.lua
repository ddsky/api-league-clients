...
function math_api:convert_units_api(source_amount, source_unit, target_unit, food_name)
	...
	if http_status:sub(1,1) == "2" then
		...
		return apileague_convert_units_api_200_response.cast(result), headers
	else
		local body, err, errno2 = stream:get_body_as_string()
		if not body then
			return nil, err, errno2
