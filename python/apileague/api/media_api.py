...
class MediaApi:
    ...
    def search_icons(
        ...
        _param = self._search_icons_serialize(
            query=query,
    ...
    @validate_call
    def search_icons_with_http_info(
        self,
        query: Annotated[str, Field(strict=True, max_length=300, description="The search query.")],
        only_public_domain: Annotated[Optional[StrictBool], Field(description="If true, only public domain icons will be returned.")] = None,
        number: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The number of icons to return in range [1,100]")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SearchIcons200Response]:
        """Search Icons
    ...
    @validate_call
    def search_icons_without_preload_content(
        self,
        query: Annotated[str, Field(strict=True, max_length=300, description="The search query.")],
        only_public_domain: Annotated[Optional[StrictBool], Field(description="If true, only public domain icons will be returned.")] = None,
        number: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The number of icons to return in range [1,100]")] = None,
