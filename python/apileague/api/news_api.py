...
class NewsApi:
    ...
    def extract_news_api(
        ...
        _param = self._extract_news_api_serialize(
            url=url,
            analyze=analyze,
    ...
    @validate_call
    def extract_news_api_with_http_info(
        self,
        url: Annotated[str, Field(strict=True, max_length=1000, description="The url of the news.")],
        analyze: Annotated[StrictBool, Field(description="Whether to analyze the news (extract entities etc.)")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExtractNewsAPI200Response]:
        """Extract News API
    ...
    @validate_call
    def extract_news_api_without_preload_content(
        self,
        url: Annotated[str, Field(strict=True, max_length=1000, description="The url of the news.")],
        analyze: Annotated[StrictBool, Field(description="Whether to analyze the news (extract entities etc.)")],
        _request_timeout: Union[
    ...
    def _extract_news_api_serialize(
        self,
        url,
        analyze,
        _request_auth,
    ...
    def search_news_api(
        self,
        text: Annotated[Optional[Annotated[str, Field(strict=True, max_length=100)]], Field(description="The text to match in the news content (at least 3 characters, maximum 100 characters). By default all query terms are expected, you can use an uppercase OR to search for any terms, e.g. tesla OR ford. You can also exclude terms by putting a minus sign (-) in front of the term, e.g. tesla -ford.")] = None,
        ...
        categories: Annotated[Optional[Annotated[str, Field(strict=True, max_length=300)]], Field(description="A comma-separated list of categories. Only news from any of the given categories will be returned. Possible categories are politics, sports, business, technology, entertainment, health, science, lifestyle, travel, culture, education, environment, other.")] = None,
        ...
        sort: Annotated[Optional[Annotated[str, Field(strict=True, max_length=100)]], Field(description="The sorting criteria (publish-time).")] = None,
        ...
        _param = self._search_news_api_serialize(
            text=text,
    ...
    @validate_call
    def search_news_api_with_http_info(
        self,
        text: Annotated[Optional[Annotated[str, Field(strict=True, max_length=100)]], Field(description="The text to match in the news content (at least 3 characters, maximum 100 characters). By default all query terms are expected, you can use an uppercase OR to search for any terms, e.g. tesla OR ford. You can also exclude terms by putting a minus sign (-) in front of the term, e.g. tesla -ford.")] = None,
        source_countries: Annotated[Optional[Annotated[str, Field(strict=True, max_length=100)]], Field(description="A comma-separated list of ISO 3166 country codes from which the news should originate.")] = None,
        language: Annotated[Optional[Annotated[str, Field(strict=True, max_length=2)]], Field(description="The ISO 6391 language code of the news.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SearchNewsAPI200Response]:
        """Search News API
    ...
    @validate_call
    def search_news_api_without_preload_content(
        self,
        text: Annotated[Optional[Annotated[str, Field(strict=True, max_length=100)]], Field(description="The text to match in the news content (at least 3 characters, maximum 100 characters). By default all query terms are expected, you can use an uppercase OR to search for any terms, e.g. tesla OR ford. You can also exclude terms by putting a minus sign (-) in front of the term, e.g. tesla -ford.")] = None,
        source_countries: Annotated[Optional[Annotated[str, Field(strict=True, max_length=100)]], Field(description="A comma-separated list of ISO 3166 country codes from which the news should originate.")] = None,
        language: Annotated[Optional[Annotated[str, Field(strict=True, max_length=2)]], Field(description="The ISO 6391 language code of the news.")] = None,
    ...
    def _search_news_api_serialize(
        self,
        text,
        source_countries,
        language,
    ...
    def top_news_api(
        self,
        source_country: Annotated[str, Field(strict=True, max_length=2, description="The ISO 3166 country code of the country for which top news should be retrieved.")],
        language: Annotated[str, Field(strict=True, max_length=2, description="The ISO 6391 language code of the top news. The language must be one spoken in the source-country.")],
        var_date: Annotated[Optional[Annotated[str, Field(strict=True, max_length=10)]], Field(description="The date for which the top news should be retrieved. If no date is given, the current day is assumed.")] = None,
        headlines_only: Annotated[Optional[StrictBool], Field(description="Whether to only return basic information such as id, title, and url of the news.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._top_news_api_serialize(
    ...
    @validate_call
    def top_news_api_with_http_info(
        self,
        source_country: Annotated[str, Field(strict=True, max_length=2, description="The ISO 3166 country code of the country for which top news should be retrieved.")],
        language: Annotated[str, Field(strict=True, max_length=2, description="The ISO 6391 language code of the top news. The language must be one spoken in the source-country.")],
        var_date: Annotated[Optional[Annotated[str, Field(strict=True, max_length=10)]], Field(description="The date for which the top news should be retrieved. If no date is given, the current day is assumed.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TopNewsAPI200Response]:
        """Top News API
    ...
    @validate_call
    def top_news_api_without_preload_content(
        self,
        source_country: Annotated[str, Field(strict=True, max_length=2, description="The ISO 3166 country code of the country for which top news should be retrieved.")],
        language: Annotated[str, Field(strict=True, max_length=2, description="The ISO 6391 language code of the top news. The language must be one spoken in the source-country.")],
        var_date: Annotated[Optional[Annotated[str, Field(strict=True, max_length=10)]], Field(description="The date for which the top news should be retrieved. If no date is given, the current day is assumed.")] = None,
    ...
    def _top_news_api_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/retrieve-top-news',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
