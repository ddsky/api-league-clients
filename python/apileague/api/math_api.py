...
class MathApi:
    ...
    def convert_units_api(
        ...
        _param = self._convert_units_api_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ConvertUnitsAPI200Response",
            '401': None,
            '402': None,
            '403': None,
            '404': None,
    ...
    @validate_call
    def convert_units_api_with_http_info(
        self,
        source_amount: Annotated[Union[Annotated[float, Field(le=99999999, strict=True, ge=0)], Annotated[int, Field(le=99999999, strict=True, ge=0)]], Field(description="The source amount.")],
        source_unit: Annotated[str, Field(strict=True, max_length=100, description="The source unit.")],
        target_unit: Annotated[str, Field(strict=True, max_length=100, description="The unit to which should be converted.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ConvertUnitsAPI200Response]:
        """Convert Units API
    ...
    @validate_call
    def convert_units_api_without_preload_content(
        self,
        source_amount: Annotated[Union[Annotated[float, Field(le=99999999, strict=True, ge=0)], Annotated[int, Field(le=99999999, strict=True, ge=0)]], Field(description="The source amount.")],
        source_unit: Annotated[str, Field(strict=True, max_length=100, description="The source unit.")],
        target_unit: Annotated[str, Field(strict=True, max_length=100, description="The unit to which should be converted.")],
    ...
    def _convert_units_api_serialize(
        self,
        source_amount,
        source_unit,
        target_unit,
