...
class FoodApi:
    ...
    def search_recipes(
        ...
        sort: Annotated[Optional[Annotated[str, Field(strict=True, max_length=100)]], Field(description="The strategy to sort recipes by. See a full list of supported sorting options.")] = None,
