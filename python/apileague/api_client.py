...
from apileague.api_response import ApiResponse, T as ApiResponseT
import apileague.models
from apileague import rest
from apileague.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(apileague.models, klass)
