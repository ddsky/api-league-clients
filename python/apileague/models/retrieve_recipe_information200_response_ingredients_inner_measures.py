...
class RetrieveRecipeInformation200ResponseIngredientsInnerMeasures(BaseModel):
    ...
    """ # noqa: E501
    metric: Optional[SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasuresMetric] = None
    us: Optional[SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasuresMetric] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metric": SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasuresMetric.from_dict(obj["metric"]) if obj.get("metric") is not None else None,
            "us": SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasuresMetric.from_dict(obj["us"]) if obj.get("us") is not None else None
        })
        return _obj
