...
class RetrieveRecipeInformation200ResponseIngredientsInnerMeasures(BaseModel):
    """
    RetrieveRecipeInformation200ResponseIngredientsInnerMeasures
    """ # noqa: E501
    metric: Optional[RetrieveRecipeInformation200ResponseIngredientsInnerMeasuresMetric] = None
    us: Optional[RetrieveRecipeInformation200ResponseIngredientsInnerMeasuresMetric] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metric": RetrieveRecipeInformation200ResponseIngredientsInnerMeasuresMetric.from_dict(obj["metric"]) if obj.get("metric") is not None else None,
            "us": RetrieveRecipeInformation200ResponseIngredientsInnerMeasuresMetric.from_dict(obj["us"]) if obj.get("us") is not None else None
        })
        return _obj
