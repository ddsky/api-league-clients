...
class TopNewsAPI200Response(BaseModel):
    """
    TopNewsAPI200Response
    """ # noqa: E501
    top_news: Optional[List[TopNewsAPI200ResponseTopNewsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "top_news": [TopNewsAPI200ResponseTopNewsInner.from_dict(_item) for _item in obj["top_news"]] if obj.get("top_news") is not None else None,
