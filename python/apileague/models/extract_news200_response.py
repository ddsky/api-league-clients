...
class ExtractNews200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "text": obj.get("text"),
            "url": obj.get("url"),
            "images": [ExtractNews200ResponseImagesInner.from_dict(_item) for _item in obj["images"]] if obj.get("images") is not None else None,
            "videos": [ExtractNews200ResponseVideosInner.from_dict(_item) for _item in obj["videos"]] if obj.get("videos") is not None else None,
