...
class SearchJokesAPI200Response(BaseModel):
    """
    SearchJokesAPI200Response
    """ # noqa: E501
    jokes: Optional[List[SearchJokesAPI200ResponseJokesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jokes": [SearchJokesAPI200ResponseJokesInner.from_dict(_item) for _item in obj["jokes"]] if obj.get("jokes") is not None else None,
