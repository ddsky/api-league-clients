...
class SearchNewsAPI200Response(BaseModel):
    """
    ...
    news: Optional[List[SearchNewsAPI200ResponseNewsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "news": [SearchNewsAPI200ResponseNewsInner.from_dict(_item) for _item in obj["news"]] if obj.get("news") is not None else None
        })
        return _obj
