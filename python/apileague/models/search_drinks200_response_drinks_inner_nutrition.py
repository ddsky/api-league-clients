...
class SearchDrinks200ResponseDrinksInnerNutrition(BaseModel):
    """
    ...
    ingredient_breakdown: Optional[List[SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ingredient_breakdown": [SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner.from_dict(_item) for _item in obj["ingredient_breakdown"]] if obj.get("ingredient_breakdown") is not None else None,
