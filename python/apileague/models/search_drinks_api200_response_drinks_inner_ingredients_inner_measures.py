...
class SearchDrinksAPI200ResponseDrinksInnerIngredientsInnerMeasures(BaseModel):
    """
    ...
    us: Optional[SearchDrinksAPI200ResponseDrinksInnerIngredientsInnerMeasuresUs] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "us": SearchDrinksAPI200ResponseDrinksInnerIngredientsInnerMeasuresUs.from_dict(obj["us"]) if obj.get("us") is not None else None
        })
        return _obj
