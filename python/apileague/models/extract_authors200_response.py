...
class ExtractAuthors200Response(BaseModel):
    """
    ExtractAuthors200Response
    """ # noqa: E501
    authors: Optional[List[ExtractAuthors200ResponseAuthorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "authors": [ExtractAuthors200ResponseAuthorsInner.from_dict(_item) for _item in obj["authors"]] if obj.get("authors") is not None else None
        })
        return _obj
