...
class RetrieveRecipeInformation200ResponseNutrition(BaseModel):
    ...
    flavonoids: Optional[List[SearchDrinks200ResponseDrinksInnerNutritionFlavonoidsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "flavonoids": [SearchDrinks200ResponseDrinksInnerNutritionFlavonoidsInner.from_dict(_item) for _item in obj["flavonoids"]] if obj.get("flavonoids") is not None else None,
