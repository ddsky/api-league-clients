...
class SearchIcons200Response(BaseModel):
    """
    SearchIcons200Response
    """ # noqa: E501
    icons: Optional[List[SearchRoyaltyFreeImages200ResponseImagesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "icons": [SearchRoyaltyFreeImages200ResponseImagesInner.from_dict(_item) for _item in obj["icons"]] if obj.get("icons") is not None else None
        })
        return _obj
