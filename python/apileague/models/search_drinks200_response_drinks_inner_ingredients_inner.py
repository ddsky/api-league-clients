...
class SearchDrinks200ResponseDrinksInnerIngredientsInner(BaseModel):
    """
    ...
    measures: Optional[SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasures] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unit": obj.get("unit"),
            "measures": SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasures.from_dict(obj["measures"]) if obj.get("measures") is not None else None,
