...
class ScoreText200ResponseStyle(BaseModel):
    """
    ScoreText200ResponseStyle
    """ # noqa: E501
    mainscores: Optional[ScoreText200ResponseReadabilityMainscores] = None
    subscores: Optional[ScoreText200ResponseStyleSubscores] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscores": ScoreText200ResponseStyleSubscores.from_dict(obj["subscores"]) if obj.get("subscores") is not None else None
        })
        return _obj
