...
class RetrieveRecipeInformation200ResponseInstructionsInnerStepsInner(BaseModel):
    ...
    ingredients: Optional[List[RetrieveRecipeInformation200ResponseInstructionsInnerStepsInnerIngredientsInner]] = None
    equipment: Optional[List[RetrieveRecipeInformation200ResponseInstructionsInnerStepsInnerIngredientsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ingredients": [RetrieveRecipeInformation200ResponseInstructionsInnerStepsInnerIngredientsInner.from_dict(_item) for _item in obj["ingredients"]] if obj.get("ingredients") is not None else None,
            "equipment": [RetrieveRecipeInformation200ResponseInstructionsInnerStepsInnerIngredientsInner.from_dict(_item) for _item in obj["equipment"]] if obj.get("equipment") is not None else None,
            "step": obj.get("step")
        })
        return _obj
