...
class ScoreTextAPI200ResponseSkimmability(BaseModel):
    """
    ScoreTextAPI200ResponseSkimmability
    """ # noqa: E501
    mainscores: Optional[ScoreTextAPI200ResponseSkimmabilityMainscores] = None
    subscores: Optional[ScoreTextAPI200ResponseSkimmabilitySubscores] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscores": ScoreTextAPI200ResponseSkimmabilitySubscores.from_dict(obj["subscores"]) if obj.get("subscores") is not None else None
        })
        return _obj
