...
class SearchMemesAPI200Response(BaseModel):
    """
    SearchMemesAPI200Response
    """ # noqa: E501
    memes: Optional[List[SearchMemesAPI200ResponseMemesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "memes": [SearchMemesAPI200ResponseMemesInner.from_dict(_item) for _item in obj["memes"]] if obj.get("memes") is not None else None,
