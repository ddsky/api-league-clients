...
class ScoreTextAPI200ResponseInterestingness(BaseModel):
    """
    ScoreTextAPI200ResponseInterestingness
    """ # noqa: E501
    mainscores: Optional[ScoreTextAPI200ResponseSkimmabilityMainscores] = None
    subscores: Optional[ScoreTextAPI200ResponseInterestingnessSubscores] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mainscores": ScoreTextAPI200ResponseSkimmabilityMainscores.from_dict(obj["mainscores"]) if obj.get("mainscores") is not None else None,
            "subscores": ScoreTextAPI200ResponseInterestingnessSubscores.from_dict(obj["subscores"]) if obj.get("subscores") is not None else None
        })
        return _obj
