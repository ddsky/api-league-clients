...
class ComputeNutritionAPI200ResponseIngredientBreakdownInner(BaseModel):
    """
    ...
    nutrients: Optional[List[ComputeNutritionAPI200ResponseIngredientBreakdownInnerNutrientsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unit": obj.get("unit"),
            "id": obj.get("id"),
            "nutrients": [ComputeNutritionAPI200ResponseIngredientBreakdownInnerNutrientsInner.from_dict(_item) for _item in obj["nutrients"]] if obj.get("nutrients") is not None else None
        })
        return _obj
