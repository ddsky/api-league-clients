...
class SearchRestaurantsAPI200ResponseRestaurantsInner(BaseModel):
    """
    SearchRestaurantsAPI200ResponseRestaurantsInner
    """ # noqa: E501
    offers_third_party_delivery: Optional[StrictBool] = None
    address: Optional[SearchRestaurantsAPI200ResponseRestaurantsInnerAddress] = None
    ...
    local_hours: Optional[SearchRestaurantsAPI200ResponseRestaurantsInnerLocalHours] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": SearchRestaurantsAPI200ResponseRestaurantsInnerAddress.from_dict(obj["address"]) if obj.get("address") is not None else None,
            ...
            "_id": obj.get("_id"),
            "local_hours": SearchRestaurantsAPI200ResponseRestaurantsInnerLocalHours.from_dict(obj["local_hours"]) if obj.get("local_hours") is not None else None
        })
        return _obj
