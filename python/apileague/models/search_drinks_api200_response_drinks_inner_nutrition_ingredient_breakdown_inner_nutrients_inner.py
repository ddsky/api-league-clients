...
class SearchDrinksAPI200ResponseDrinksInnerNutritionIngredientBreakdownInnerNutrientsInner(BaseModel):
    """
    SearchDrinksAPI200ResponseDrinksInnerNutritionIngredientBreakdownInnerNutrientsInner
    """ # noqa: E501
    name: Optional[StrictStr] = None
    percent_of_daily_needs: Optional[Union[StrictFloat, StrictInt]] = None
    amount: Optional[StrictInt] = None
    unit: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "percent_of_daily_needs", "amount", "unit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "percent_of_daily_needs": obj.get("percent_of_daily_needs"),
