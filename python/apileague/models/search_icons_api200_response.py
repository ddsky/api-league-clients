...
class SearchIconsAPI200Response(BaseModel):
    """
    SearchIconsAPI200Response
    """ # noqa: E501
    icons: Optional[List[SearchRoyaltyFreeImagesAPI200ResponseImagesInner]] = None
    __properties: ClassVar[List[str]] = ["icons"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "icons": [SearchRoyaltyFreeImagesAPI200ResponseImagesInner.from_dict(_item) for _item in obj["icons"]] if obj.get("icons") is not None else None
        })
        return _obj
