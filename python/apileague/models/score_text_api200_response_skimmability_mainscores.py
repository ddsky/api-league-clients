...
class ScoreTextAPI200ResponseSkimmabilityMainscores(BaseModel):
    """
    ScoreTextAPI200ResponseSkimmabilityMainscores
    """ # noqa: E501
    total_possible: Optional[StrictInt] = None
    total: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["total_possible", "total"]
