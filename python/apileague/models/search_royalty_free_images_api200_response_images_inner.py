...
class SearchRoyaltyFreeImagesAPI200ResponseImagesInner(BaseModel):
    """
    SearchRoyaltyFreeImagesAPI200ResponseImagesInner
    """ # noqa: E501
    width: Optional[StrictInt] = None
    license: Optional[SearchRoyaltyFreeImagesAPI200ResponseImagesInnerLicense] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "width": obj.get("width"),
            "license": SearchRoyaltyFreeImagesAPI200ResponseImagesInnerLicense.from_dict(obj["license"]) if obj.get("license") is not None else None,
