...
class SearchRecipes200ResponseRecipesInner(BaseModel):
    """
    SearchRecipes200ResponseRecipesInner
    """ # noqa: E501
    images: Optional[List[Optional[StrictStr]]] = None
    nutrition: Optional[SearchRecipes200ResponseRecipesInnerNutrition] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nutrition": SearchRecipes200ResponseRecipesInnerNutrition.from_dict(obj["nutrition"]) if obj.get("nutrition") is not None else None,
            "id": obj.get("id"),
            "title": obj.get("title")
        })
        return _obj
