...
class ExtractEntitiesAPI200Response(BaseModel):
    """
    ExtractEntitiesAPI200Response
    """ # noqa: E501
    entities: Optional[List[ExtractEntitiesAPI200ResponseEntitiesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entities": [ExtractEntitiesAPI200ResponseEntitiesInner.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None
        })
        return _obj
