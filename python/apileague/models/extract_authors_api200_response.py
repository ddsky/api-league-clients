...
class ExtractAuthorsAPI200Response(BaseModel):
    """
    ExtractAuthorsAPI200Response
    """ # noqa: E501
    authors: Optional[List[ExtractAuthorsAPI200ResponseAuthorsInner]] = None
    __properties: ClassVar[List[str]] = ["authors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "authors": [ExtractAuthorsAPI200ResponseAuthorsInner.from_dict(_item) for _item in obj["authors"]] if obj.get("authors") is not None else None
        })
        return _obj
