...
class RetrievePageRankAPI200Response(BaseModel):
    """
    RetrievePageRankAPI200Response
    """ # noqa: E501
    page_rank: Optional[Union[StrictFloat, StrictInt]] = None
    position: Optional[StrictInt] = None
    percentile: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["page_rank", "position", "percentile"]
