...
class ScoreText200ResponseInterestingness(BaseModel):
    """
    ScoreText200ResponseInterestingness
    """ # noqa: E501
    mainscores: Optional[ScoreText200ResponseSkimmabilityMainscores] = None
    subscores: Optional[ScoreText200ResponseInterestingnessSubscores] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscores": ScoreText200ResponseInterestingnessSubscores.from_dict(obj["subscores"]) if obj.get("subscores") is not None else None
        })
        return _obj
