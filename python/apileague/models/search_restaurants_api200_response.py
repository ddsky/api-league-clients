...
class SearchRestaurantsAPI200Response(BaseModel):
    """
    SearchRestaurantsAPI200Response
    """ # noqa: E501
    restaurants: Optional[List[SearchRestaurantsAPI200ResponseRestaurantsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "restaurants": [SearchRestaurantsAPI200ResponseRestaurantsInner.from_dict(_item) for _item in obj["restaurants"]] if obj.get("restaurants") is not None else None
        })
        return _obj
