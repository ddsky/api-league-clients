...
class ScoreTextAPI200Response(BaseModel):
    """
    ScoreTextAPI200Response
    """ # noqa: E501
    number_of_words: Optional[StrictInt] = None
    number_of_sentences: Optional[StrictInt] = None
    readability: Optional[ScoreTextAPI200ResponseReadability] = None
    skimmability: Optional[ScoreTextAPI200ResponseSkimmability] = None
    interestingness: Optional[ScoreTextAPI200ResponseInterestingness] = None
    style: Optional[ScoreTextAPI200ResponseStyle] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "readability": ScoreTextAPI200ResponseReadability.from_dict(obj["readability"]) if obj.get("readability") is not None else None,
            "skimmability": ScoreTextAPI200ResponseSkimmability.from_dict(obj["skimmability"]) if obj.get("skimmability") is not None else None,
            "interestingness": ScoreTextAPI200ResponseInterestingness.from_dict(obj["interestingness"]) if obj.get("interestingness") is not None else None,
            "style": ScoreTextAPI200ResponseStyle.from_dict(obj["style"]) if obj.get("style") is not None else None,
