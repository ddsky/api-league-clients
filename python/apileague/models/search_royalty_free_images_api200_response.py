...
class SearchRoyaltyFreeImagesAPI200Response(BaseModel):
    """
    SearchRoyaltyFreeImagesAPI200Response
    """ # noqa: E501
    images: Optional[List[SearchRoyaltyFreeImagesAPI200ResponseImagesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "images": [SearchRoyaltyFreeImagesAPI200ResponseImagesInner.from_dict(_item) for _item in obj["images"]] if obj.get("images") is not None else None
        })
        return _obj
