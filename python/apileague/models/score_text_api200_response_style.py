...
class ScoreTextAPI200ResponseStyle(BaseModel):
    """
    ScoreTextAPI200ResponseStyle
    """ # noqa: E501
    mainscores: Optional[ScoreTextAPI200ResponseReadabilityMainscores] = None
    subscores: Optional[ScoreTextAPI200ResponseStyleSubscores] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscores": ScoreTextAPI200ResponseStyleSubscores.from_dict(obj["subscores"]) if obj.get("subscores") is not None else None
        })
        return _obj
