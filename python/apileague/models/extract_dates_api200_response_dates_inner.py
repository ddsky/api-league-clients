...
class ExtractDatesAPI200ResponseDatesInner(BaseModel):
    """
    ExtractDatesAPI200ResponseDatesInner
    """ # noqa: E501
    start_position: Optional[StrictInt] = None
    var_date: Optional[StrictStr] = Field(default=None, alias="date")
    normalized_date: Optional[Union[StrictFloat, StrictInt]] = None
    tag: Optional[StrictStr] = None
    end_position: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["start_position", "date", "normalized_date", "tag", "end_position"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "date": obj.get("date"),
            "normalized_date": obj.get("normalized_date"),
            "tag": obj.get("tag"),
