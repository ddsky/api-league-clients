...
class RetrieveGameById200ResponsePlaytime(BaseModel):
    """
    RetrieveGameById200ResponsePlaytime
    """ # noqa: E501
    percentiles: Optional[List[StrictInt]] = None
    ...
    __properties: ClassVar[List[str]] = ["percentiles", "min", "median", "max", "mean", "mentions"]
