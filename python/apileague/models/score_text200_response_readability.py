...
class ScoreText200ResponseReadability(BaseModel):
    """
    ScoreText200ResponseReadability
    """ # noqa: E501
    mainscores: Optional[ScoreText200ResponseReadabilityMainscores] = None
    subscores: Optional[ScoreText200ResponseReadabilitySubscores] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mainscores": ScoreText200ResponseReadabilityMainscores.from_dict(obj["mainscores"]) if obj.get("mainscores") is not None else None,
            "subscores": ScoreText200ResponseReadabilitySubscores.from_dict(obj["subscores"]) if obj.get("subscores") is not None else None
        })
        return _obj
