...
class RetrieveRecipeInformation200ResponseInstructionsInner(BaseModel):
    """
    RetrieveRecipeInformation200ResponseInstructionsInner
    """ # noqa: E501
    name: Optional[StrictStr] = None
    steps: Optional[List[RetrieveRecipeInformation200ResponseInstructionsInnerStepsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "steps": [RetrieveRecipeInformation200ResponseInstructionsInnerStepsInner.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None
        })
        return _obj
