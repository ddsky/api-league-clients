...
class RetrieveRecipeInformationAPI200ResponseIngredientsInner(BaseModel):
    """
    ...
    measures: Optional[RetrieveRecipeInformationAPI200ResponseIngredientsInnerMeasures] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unit": obj.get("unit"),
            "measures": RetrieveRecipeInformationAPI200ResponseIngredientsInnerMeasures.from_dict(obj["measures"]) if obj.get("measures") is not None else None,
