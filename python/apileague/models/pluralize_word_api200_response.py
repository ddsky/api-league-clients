...
class PluralizeWordAPI200Response(BaseModel):
    """
    PluralizeWordAPI200Response
    """ # noqa: E501
    original: Optional[StrictStr] = None
    plural: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["original", "plural"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if plural (nullable) is None
        # and model_fields_set contains the field
        if self.plural is None and "plural" in self.model_fields_set:
            _dict['plural'] = None
