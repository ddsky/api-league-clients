...
class SearchBooks200Response(BaseModel):
    ...
    books: Optional[List[SearchBooks200ResponseBooksInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "books": [SearchBooks200ResponseBooksInner.from_dict(_item) for _item in obj["books"]] if obj.get("books") is not None else None
        })
        return _obj
