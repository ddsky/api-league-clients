...
class ExtractDates200Response(BaseModel):
    """
    ExtractDates200Response
    """ # noqa: E501
    dates: Optional[List[ExtractDates200ResponseDatesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dates": [ExtractDates200ResponseDatesInner.from_dict(_item) for _item in obj["dates"]] if obj.get("dates") is not None else None
        })
        return _obj
