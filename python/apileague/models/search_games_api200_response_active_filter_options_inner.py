...
class SearchGamesAPI200ResponseActiveFilterOptionsInner(BaseModel):
    """
    SearchGamesAPI200ResponseActiveFilterOptionsInner
    """ # noqa: E501
    key: Optional[StrictStr] = None
    connection: Optional[StrictStr] = None
    values: Optional[List[SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner]] = None
    __properties: ClassVar[List[str]] = ["key", "connection", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "values": [SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
