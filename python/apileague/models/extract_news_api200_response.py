...
class ExtractNewsAPI200Response(BaseModel):
    """
    ...
    images: Optional[List[ExtractNewsAPI200ResponseImagesInner]] = None
    videos: Optional[List[ExtractNewsAPI200ResponseVideosInner]] = None
    publish_date: Optional[StrictStr] = None
    authors: Optional[List[Optional[StrictStr]]] = None
    language: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["title", "text", "url", "images", "videos", "publish_date", "authors", "language"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "text": obj.get("text"),
            "url": obj.get("url"),
            "images": [ExtractNewsAPI200ResponseImagesInner.from_dict(_item) for _item in obj["images"]] if obj.get("images") is not None else None,
            "videos": [ExtractNewsAPI200ResponseVideosInner.from_dict(_item) for _item in obj["videos"]] if obj.get("videos") is not None else None,
