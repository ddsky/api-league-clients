...
class SearchDrinksAPI200ResponseDrinksInnerNutritionIngredientBreakdownInner(BaseModel):
    """
    ...
    nutrients: Optional[List[SearchDrinksAPI200ResponseDrinksInnerNutritionIngredientBreakdownInnerNutrientsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unit": obj.get("unit"),
            "id": obj.get("id"),
            "nutrients": [SearchDrinksAPI200ResponseDrinksInnerNutritionIngredientBreakdownInnerNutrientsInner.from_dict(_item) for _item in obj["nutrients"]] if obj.get("nutrients") is not None else None
        })
        return _obj
