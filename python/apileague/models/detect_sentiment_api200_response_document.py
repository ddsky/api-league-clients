...
class DetectSentimentAPI200ResponseDocument(BaseModel):
    """
    DetectSentimentAPI200ResponseDocument
    """ # noqa: E501
    sentiment: Optional[StrictStr] = None
    confidence: Optional[StrictInt] = None
    average_confidence: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["sentiment", "confidence", "average_confidence"]
