...
class TextStemming200Response(BaseModel):
    """
    TextStemming200Response
    """ # noqa: E501
    original: Optional[StrictStr] = None
    stemmed: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["original", "stemmed"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if stemmed (nullable) is None
        # and model_fields_set contains the field
        if self.stemmed is None and "stemmed" in self.model_fields_set:
            _dict['stemmed'] = None
