...
class VectorSearchAPI200Response(BaseModel):
    """
    VectorSearchAPI200Response
    """ # noqa: E501
    vectors: Optional[List[VectorSearchAPI200ResponseVectorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vectors": [VectorSearchAPI200ResponseVectorsInner.from_dict(_item) for _item in obj["vectors"]] if obj.get("vectors") is not None else None
        })
        return _obj
