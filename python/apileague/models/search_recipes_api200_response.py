...
class SearchRecipesAPI200Response(BaseModel):
    """
    SearchRecipesAPI200Response
    """ # noqa: E501
    offset: Optional[StrictInt] = None
    number: Optional[StrictInt] = None
    recipes: Optional[List[SearchRecipesAPI200ResponseRecipesInner]] = None
    total_results: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["offset", "number", "recipes", "total_results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recipes": [SearchRecipesAPI200ResponseRecipesInner.from_dict(_item) for _item in obj["recipes"]] if obj.get("recipes") is not None else None,
