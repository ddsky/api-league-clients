...
class RetrieveRecipeInformationAPI200ResponseIngredientsInnerMeasures(BaseModel):
    """
    RetrieveRecipeInformationAPI200ResponseIngredientsInnerMeasures
    """ # noqa: E501
    metric: Optional[SearchDrinksAPI200ResponseDrinksInnerIngredientsInnerMeasuresMetric] = None
    us: Optional[SearchDrinksAPI200ResponseDrinksInnerIngredientsInnerMeasuresMetric] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metric": SearchDrinksAPI200ResponseDrinksInnerIngredientsInnerMeasuresMetric.from_dict(obj["metric"]) if obj.get("metric") is not None else None,
            "us": SearchDrinksAPI200ResponseDrinksInnerIngredientsInnerMeasuresMetric.from_dict(obj["us"]) if obj.get("us") is not None else None
        })
        return _obj
