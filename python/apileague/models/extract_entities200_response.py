...
class ExtractEntities200Response(BaseModel):
    """
    ExtractEntities200Response
    """ # noqa: E501
    entities: Optional[List[ExtractEntities200ResponseEntitiesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entities": [ExtractEntities200ResponseEntitiesInner.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None
        })
        return _obj
