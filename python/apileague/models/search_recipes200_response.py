...
class SearchRecipes200Response(BaseModel):
    ...
    recipes: Optional[List[SearchRecipes200ResponseRecipesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recipes": [SearchRecipes200ResponseRecipesInner.from_dict(_item) for _item in obj["recipes"]] if obj.get("recipes") is not None else None,
