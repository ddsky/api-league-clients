...
class ScoreTextAPI200ResponseReadability(BaseModel):
    """
    ScoreTextAPI200ResponseReadability
    """ # noqa: E501
    mainscores: Optional[ScoreTextAPI200ResponseReadabilityMainscores] = None
    subscores: Optional[ScoreTextAPI200ResponseReadabilitySubscores] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mainscores": ScoreTextAPI200ResponseReadabilityMainscores.from_dict(obj["mainscores"]) if obj.get("mainscores") is not None else None,
            "subscores": ScoreTextAPI200ResponseReadabilitySubscores.from_dict(obj["subscores"]) if obj.get("subscores") is not None else None
        })
        return _obj
