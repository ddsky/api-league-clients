...
class TopNewsAPI200ResponseTopNewsInner(BaseModel):
    """
    TopNewsAPI200ResponseTopNewsInner
    """ # noqa: E501
    news: Optional[List[TopNewsAPI200ResponseTopNewsInnerNewsInner]] = None
    __properties: ClassVar[List[str]] = ["news"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "news": [TopNewsAPI200ResponseTopNewsInnerNewsInner.from_dict(_item) for _item in obj["news"]] if obj.get("news") is not None else None
        })
        return _obj
