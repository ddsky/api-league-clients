...
class TopNews200ResponseTopNewsInner(BaseModel):
    """
    TopNews200ResponseTopNewsInner
    """ # noqa: E501
    news: Optional[List[TopNews200ResponseTopNewsInnerNewsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "news": [TopNews200ResponseTopNewsInnerNewsInner.from_dict(_item) for _item in obj["news"]] if obj.get("news") is not None else None
        })
        return _obj
