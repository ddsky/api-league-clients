...
class RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner(BaseModel):
    """
    RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner
    """ # noqa: E501
    number: Optional[StrictInt] = None
    ingredients: Optional[List[SearchDrinksAPI200ResponseDrinksInnerInstructionsInnerStepsInnerIngredientsInner]] = None
    equipment: Optional[List[SearchDrinksAPI200ResponseDrinksInnerInstructionsInnerStepsInnerIngredientsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ingredients": [SearchDrinksAPI200ResponseDrinksInnerInstructionsInnerStepsInnerIngredientsInner.from_dict(_item) for _item in obj["ingredients"]] if obj.get("ingredients") is not None else None,
            "equipment": [SearchDrinksAPI200ResponseDrinksInnerInstructionsInnerStepsInnerIngredientsInner.from_dict(_item) for _item in obj["equipment"]] if obj.get("equipment") is not None else None,
            "step": obj.get("step")
        })
        return _obj
