...
retrieve_recipe_information200_response_dietary_properties_from_dict = RetrieveRecipeInformation200ResponseDietaryProperties.from_dict(retrieve_recipe_information200_response_dietary_properties_dict)
```
