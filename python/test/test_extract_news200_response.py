    ...
    def make_instance(self, include_optional) -> ExtractNews200Response:
        ...
        if include_optional:
            return ExtractNews200Response(
                ...
                url = '',
                images = [
                    apileague.models.extract_news_200_response_images_inner.extractNews_200_response_images_inner(
                        width = 56, 
                        title = '', 
                        url = '', 
                        height = 56, )
                ...
                videos = [
                    apileague.models.extract_news_200_response_videos_inner.extractNews_200_response_videos_inner(
                        summary = '', 
                        duration = 56, 
                        thumbnail = '', 
                        title = '', 
