...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ArtApi()
        api_instance.image_to_ascii_art_by_url  # this is an instance of the class Endpoint
        api_instance.image_to_ascii_art_by_url()  # this invokes api_instance.image_to_ascii_art_by_url.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.image_to_ascii_art_by_url.callable or self.callable in this class
