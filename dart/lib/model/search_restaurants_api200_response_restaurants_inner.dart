...
class SearchRestaurantsAPI200ResponseRestaurantsInner {
  /// Returns a new [SearchRestaurantsAPI200ResponseRestaurantsInner] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SearchRestaurantsAPI200ResponseRestaurantsInner &&
  ...
  /// Returns a new [SearchRestaurantsAPI200ResponseRestaurantsInner] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SearchRestaurantsAPI200ResponseRestaurantsInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SearchRestaurantsAPI200ResponseRestaurantsInner[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SearchRestaurantsAPI200ResponseRestaurantsInner[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SearchRestaurantsAPI200ResponseRestaurantsInner(
        ...
        address: SearchRestaurantsAPI200ResponseRestaurantsInnerAddress.fromJson(json[r'address']),
        ...
        localHours: SearchRestaurantsAPI200ResponseRestaurantsInnerLocalHours.fromJson(json[r'local_hours']),
      );
    }
    return null;
  }

  static List<SearchRestaurantsAPI200ResponseRestaurantsInner> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SearchRestaurantsAPI200ResponseRestaurantsInner>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SearchRestaurantsAPI200ResponseRestaurantsInner.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SearchRestaurantsAPI200ResponseRestaurantsInner> mapFromJson(dynamic json) {
    final map = <String, SearchRestaurantsAPI200ResponseRestaurantsInner>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SearchRestaurantsAPI200ResponseRestaurantsInner.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SearchRestaurantsAPI200ResponseRestaurantsInner-objects as value to a dart map
  static Map<String, List<SearchRestaurantsAPI200ResponseRestaurantsInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SearchRestaurantsAPI200ResponseRestaurantsInner>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SearchRestaurantsAPI200ResponseRestaurantsInner.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
