...
class SearchRecipes200Response {
  ...
  @override
  String toString() => 'SearchRecipes200Response[offset=$offset, number=$number, recipes=$recipes, totalResults=$totalResults]';
  ...
  static SearchRecipes200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SearchRecipes200Response(
        ...
        recipes: SearchRecipes200ResponseRecipesInner.listFromJson(json[r'recipes']),
