...
part 'model/retrieve_recipe_information200_response_ingredients_inner_measures_metric.dart';
...
part 'model/retrieve_recipe_information200_response_instructions_inner_steps_inner_ingredients_inner.dart';
part 'model/retrieve_recipe_information200_response_nutrition.dart';
part 'model/retrieve_recipe_information200_response_nutrition_caloric_breakdown.dart';
part 'model/retrieve_recipe_information200_response_nutrition_flavonoids_inner.dart';
part 'model/retrieve_recipe_information200_response_nutrition_ingredient_breakdown_inner.dart';
part 'model/retrieve_recipe_information200_response_nutrition_ingredient_breakdown_inner_nutrients_inner.dart';
part 'model/retrieve_recipe_information200_response_nutrition_weight_per_serving.dart';
