...
class InlineResponse2002 {
  ...
  List<InlineResponse2002News> news;
  ...
  @override
  String toString() => 'InlineResponse2002[offset=$offset, number=$number, available=$available, news=$news]';
  ...
  static InlineResponse2002 fromJson(dynamic value) {
    if (value is Map) {
      ...
      return InlineResponse2002(
        ...
        news: InlineResponse2002News.listFromJson(json[r'news']),
      );
    }
    return null;
  }
