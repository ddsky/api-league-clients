...
class InlineResponse2001 {
  ...
  List<InlineResponse200Books> similarBooks;

  @override
  bool operator ==(Object other) => identical(this, other) || other is InlineResponse2001 &&
     other.similarBooks == similarBooks;

  @override
  int get hashCode =>
  // ignore: unnecessary_parenthesis
    (similarBooks == null ? 0 : similarBooks.hashCode);

  @override
  String toString() => 'InlineResponse2001[similarBooks=$similarBooks]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
    if (similarBooks != null) {
      json[r'similar_books'] = similarBooks;
    }
    return json;
  }
  ...
  static InlineResponse2001 fromJson(dynamic value) {
    if (value is Map) {
      ...
      return InlineResponse2001(
        similarBooks: InlineResponse200Books.listFromJson(json[r'similar_books']),
      );
    }
    return null;
  }
