...
class InlineResponse20019SkimmabilitySubscores {
  /// Returns a new [InlineResponse20019SkimmabilitySubscores] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InlineResponse20019SkimmabilitySubscores &&
  ...
  @override
  String toString() => 'InlineResponse20019SkimmabilitySubscores[bulletPointRatioScore=$bulletPointRatioScore, imageScore=$imageScore, highlightedWordRatioScore=$highlightedWordRatioScore, videoScore=$videoScore, paragraphScore=$paragraphScore, paragraphHeadlineRatioScore=$paragraphHeadlineRatioScore]';
  ...
  /// Returns a new [InlineResponse20019SkimmabilitySubscores] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InlineResponse20019SkimmabilitySubscores fromJson(dynamic value) {
    if (value is Map) {
      final json = value.cast<String, dynamic>();
      return InlineResponse20019SkimmabilitySubscores(
  ...
  static List<InlineResponse20019SkimmabilitySubscores> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(InlineResponse20019SkimmabilitySubscores.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <InlineResponse20019SkimmabilitySubscores>[];

  static Map<String, InlineResponse20019SkimmabilitySubscores> mapFromJson(dynamic json) {
    final map = <String, InlineResponse20019SkimmabilitySubscores>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = InlineResponse20019SkimmabilitySubscores.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of InlineResponse20019SkimmabilitySubscores-objects as value to a dart map
  static Map<String, List<InlineResponse20019SkimmabilitySubscores>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<InlineResponse20019SkimmabilitySubscores>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = InlineResponse20019SkimmabilitySubscores.listFromJson(
            value,
