...
// tests for RetrieveRecipeInformation200ResponseIngredientsInner
void main() {
  // final instance = RetrieveRecipeInformation200ResponseIngredientsInner();

  group('test RetrieveRecipeInformation200ResponseIngredientsInner', () {
    // String image
