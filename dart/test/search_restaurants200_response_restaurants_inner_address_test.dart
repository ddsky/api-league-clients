...
// tests for SearchRestaurants200ResponseRestaurantsInnerAddress
void main() {
  // final instance = SearchRestaurants200ResponseRestaurantsInnerAddress();

  group('test SearchRestaurants200ResponseRestaurantsInnerAddress', () {
    // String zipcode
