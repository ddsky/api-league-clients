...
// tests for SearchRestaurants200ResponseRestaurantsInner
void main() {
  // final instance = SearchRestaurants200ResponseRestaurantsInner();

  group('test SearchRestaurants200ResponseRestaurantsInner', () {
