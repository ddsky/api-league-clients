...
// tests for SearchDrinksAPI200ResponseDrinksInnerIngredientsInner
void main() {
  // final instance = SearchDrinksAPI200ResponseDrinksInnerIngredientsInner();

  group('test SearchDrinksAPI200ResponseDrinksInnerIngredientsInner', () {
    // String image
