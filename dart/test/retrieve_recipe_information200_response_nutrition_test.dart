...
// tests for RetrieveRecipeInformation200ResponseNutrition
void main() {
  // final instance = RetrieveRecipeInformation200ResponseNutrition();

  group('test RetrieveRecipeInformation200ResponseNutrition', () {
    ...
    // List<RetrieveRecipeInformation200ResponseNutritionFlavonoidsInner> flavonoids (default value: const [])
    test('to test the property `flavonoids`', () async {
      // TODO
    });

    // List<RetrieveRecipeInformation200ResponseNutritionIngredientBreakdownInner> ingredientBreakdown (default value: const [])
    test('to test the property `ingredientBreakdown`', () async {
      // TODO
    });

    // List<SearchRecipes200ResponseRecipesInnerNutritionNutrientsInner> properties (default value: const [])
