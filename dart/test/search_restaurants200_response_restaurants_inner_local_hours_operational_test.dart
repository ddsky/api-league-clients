...
// tests for SearchRestaurants200ResponseRestaurantsInnerLocalHoursOperational
void main() {
  // final instance = SearchRestaurants200ResponseRestaurantsInnerLocalHoursOperational();

  group('test SearchRestaurants200ResponseRestaurantsInnerLocalHoursOperational', () {
    // String sunday
