...
// tests for DetectSentiment200ResponseSentencesInner
void main() {
  // final instance = DetectSentiment200ResponseSentencesInner();

  group('test DetectSentiment200ResponseSentencesInner', () {
    // int length
