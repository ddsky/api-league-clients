(ns api-league.specs.search-drinks-200-response-drinks-inner-nutrition
...
(def search-drinks-200-response-drinks-inner-nutrition-data
  {
   ...
   (ds/opt :ingredient_breakdown) (s/coll-of search-drinks-200-response-drinks-inner-nutrition-ingredient-breakdown-inner-spec)
...
(def search-drinks-200-response-drinks-inner-nutrition-spec
  (ds/spec
    {:name ::search-drinks-200-response-drinks-inner-nutrition
     :spec search-drinks-200-response-drinks-inner-nutrition-data}))
