(ns api-league.specs.verify-email-address-200-response
...
(def verify-email-address-200-response-data
  {
   (ds/opt :email) string?
...
(def verify-email-address-200-response-spec
  (ds/spec
    {:name ::verify-email-address-200-response
     :spec verify-email-address-200-response-data}))
