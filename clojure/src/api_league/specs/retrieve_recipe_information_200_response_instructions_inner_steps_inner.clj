...
(def retrieve-recipe-information-200-response-instructions-inner-steps-inner-data
  {
   (ds/opt :number) int?
   (ds/opt :ingredients) (s/coll-of retrieve-recipe-information-200-response-instructions-inner-steps-inner-ingredients-inner-spec)
   (ds/opt :equipment) (s/coll-of retrieve-recipe-information-200-response-instructions-inner-steps-inner-ingredients-inner-spec)
   (ds/opt :step) string?
   })
