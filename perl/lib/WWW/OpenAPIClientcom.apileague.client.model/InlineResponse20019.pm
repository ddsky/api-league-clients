...
__PACKAGE__->method_documentation({
    ...
    'readability' => {
        datatype => 'InlineResponse20019Readability',
    ...
    'skimmability' => {
        datatype => 'InlineResponse20019Skimmability',
    ...
    'interestingness' => {
        datatype => 'InlineResponse20019Interestingness',
    ...
    'style' => {
        datatype => 'InlineResponse20019Style',
        base_name => 'style',
        description => '',
        format => '',
        read_only => '',
