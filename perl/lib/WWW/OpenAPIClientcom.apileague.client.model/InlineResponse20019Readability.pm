...
#
package WWW::OpenAPIClient::Object::InlineResponse20019Readability;
...
__PACKAGE__->method_documentation({
    'mainscores' => {
        datatype => 'InlineResponse20019ReadabilityMainscores',
    ...
    'subscores' => {
        datatype => 'InlineResponse20019ReadabilitySubscores',
        base_name => 'subscores',
        description => '',
        format => '',
        read_only => '',
