...
#
package WWW::OpenAPIClient::Object::RetrieveRecipeInformationAPI200ResponseInstructionsInner;
...
__PACKAGE__->method_documentation({
    ...
    'steps' => {
        datatype => 'ARRAY[RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner]',
        base_name => 'steps',
        description => '',
        format => '',
        read_only => '',
