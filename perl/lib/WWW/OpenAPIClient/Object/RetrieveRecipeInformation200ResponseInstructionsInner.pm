...
#
package WWW::OpenAPIClient::Object::RetrieveRecipeInformation200ResponseInstructionsInner;
...
__PACKAGE__->method_documentation({
    ...
    'steps' => {
        datatype => 'ARRAY[RetrieveRecipeInformation200ResponseInstructionsInnerStepsInner]',
        base_name => 'steps',
        description => '',
        format => '',
        read_only => '',
