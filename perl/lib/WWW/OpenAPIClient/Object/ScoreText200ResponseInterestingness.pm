...
#
package WWW::OpenAPIClient::Object::ScoreText200ResponseInterestingness;
...
__PACKAGE__->method_documentation({
    'mainscores' => {
        datatype => 'ScoreText200ResponseSkimmabilityMainscores',
    ...
    'subscores' => {
        datatype => 'ScoreText200ResponseInterestingnessSubscores',
        base_name => 'subscores',
        description => '',
        format => '',
        read_only => '',
