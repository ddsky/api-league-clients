...
#
package WWW::OpenAPIClient::Object::SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner;
...
__PACKAGE__->method_documentation({
    ...
    'nutrients' => {
        datatype => 'ARRAY[SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInnerNutrientsInner]',
        base_name => 'nutrients',
        description => '',
        format => '',
        read_only => '',
