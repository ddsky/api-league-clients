...
#
package WWW::OpenAPIClient::Object::SearchDrinks200ResponseDrinksInner;
...
__PACKAGE__->method_documentation({
    ...
    'instructions' => {
        datatype => 'ARRAY[SearchDrinks200ResponseDrinksInnerInstructionsInner]',
    ...
    'nutrition' => {
        datatype => 'SearchDrinks200ResponseDrinksInnerNutrition',
        base_name => 'nutrition',
        description => '',
        format => '',
        read_only => '',
    ...
    'credits' => {
        datatype => 'SearchDrinks200ResponseDrinksInnerCredits',
        base_name => 'credits',
        description => '',
        format => '',
        read_only => '',
    ...
    'ingredients' => {
        datatype => 'ARRAY[SearchDrinks200ResponseDrinksInnerIngredientsInner]',
