...
#
package WWW::OpenAPIClient::Object::RetrieveRecipeInformationAPI200ResponseScores;
...
__PACKAGE__->method_documentation({
    ...
    'weight_watcher_smart_points' => {
        datatype => 'int',
        base_name => 'weight_watcher_smart_points',
        description => '',
        format => '',
        read_only => '',
            },
