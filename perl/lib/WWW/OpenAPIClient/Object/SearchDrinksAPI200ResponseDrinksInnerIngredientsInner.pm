...
#
package WWW::OpenAPIClient::Object::SearchDrinksAPI200ResponseDrinksInnerIngredientsInner;
...
__PACKAGE__->method_documentation({
    ...
    'measures' => {
        datatype => 'SearchDrinksAPI200ResponseDrinksInnerIngredientsInnerMeasures',
        base_name => 'measures',
        description => '',
        format => '',
        read_only => '',
