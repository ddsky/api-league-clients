...
#
package WWW::OpenAPIClient::Object::ExtractNewsAPI200Response;
...
__PACKAGE__->method_documentation({
    ...
    'images' => {
        datatype => 'ARRAY[ExtractNewsAPI200ResponseImagesInner]',
        base_name => 'images',
        description => '',
        format => '',
        read_only => '',
    ...
    'videos' => {
        datatype => 'ARRAY[ExtractNewsAPI200ResponseVideosInner]',
        base_name => 'videos',
        description => '',
        format => '',
        read_only => '',
