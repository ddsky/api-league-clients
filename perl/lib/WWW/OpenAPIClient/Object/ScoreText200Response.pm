...
#
package WWW::OpenAPIClient::Object::ScoreText200Response;
...
__PACKAGE__->method_documentation({
    ...
    'readability' => {
        datatype => 'ScoreText200ResponseReadability',
    ...
    'skimmability' => {
        datatype => 'ScoreText200ResponseSkimmability',
    ...
    'interestingness' => {
        datatype => 'ScoreText200ResponseInterestingness',
    ...
    'style' => {
        datatype => 'ScoreText200ResponseStyle',
        base_name => 'style',
        description => '',
        format => '',
        read_only => '',
