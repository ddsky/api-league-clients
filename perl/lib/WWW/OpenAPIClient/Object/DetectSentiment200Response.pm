...
#
package WWW::OpenAPIClient::Object::DetectSentiment200Response;
...
__PACKAGE__->method_documentation({
    'document' => {
        datatype => 'DetectSentiment200ResponseDocument',
        base_name => 'document',
        description => '',
        format => '',
        read_only => '',
    ...
    'sentences' => {
        datatype => 'ARRAY[DetectSentiment200ResponseSentencesInner]',
        base_name => 'sentences',
        description => '',
        format => '',
        read_only => '',
