...
#
package WWW::OpenAPIClient::Object::RetrieveRecipeInformation200ResponseInstructionsInnerStepsInner;
...
__PACKAGE__->method_documentation({
    ...
    'ingredients' => {
        datatype => 'ARRAY[RetrieveRecipeInformation200ResponseInstructionsInnerStepsInnerIngredientsInner]',
