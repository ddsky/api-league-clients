...
__PACKAGE__->method_documentation({
    'weight_per_serving' => {
        datatype => 'SearchDrinks200ResponseDrinksInnerNutritionWeightPerServing',
    ...
    'caloric_breakdown' => {
        datatype => 'SearchDrinks200ResponseDrinksInnerNutritionCaloricBreakdown',
    ...
    'flavonoids' => {
        datatype => 'ARRAY[SearchDrinks200ResponseDrinksInnerNutritionFlavonoidsInner]',
    ...
    'nutrients' => {
        datatype => 'ARRAY[SearchDrinks200ResponseDrinksInnerNutritionNutrientsInner]',
        base_name => 'nutrients',
        description => '',
        format => '',
        read_only => '',
