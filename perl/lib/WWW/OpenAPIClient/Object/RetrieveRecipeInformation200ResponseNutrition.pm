...
#
package WWW::OpenAPIClient::Object::RetrieveRecipeInformation200ResponseNutrition;
...
__PACKAGE__->method_documentation({
    'weight_per_serving' => {
        datatype => 'RetrieveRecipeInformation200ResponseNutritionWeightPerServing',
    ...
    'caloric_breakdown' => {
        datatype => 'RetrieveRecipeInformation200ResponseNutritionCaloricBreakdown',
    ...
    'flavonoids' => {
        datatype => 'ARRAY[RetrieveRecipeInformation200ResponseNutritionFlavonoidsInner]',
    ...
    'ingredient_breakdown' => {
        datatype => 'ARRAY[RetrieveRecipeInformation200ResponseNutritionIngredientBreakdownInner]',
    ...
    'properties' => {
        datatype => 'ARRAY[SearchRecipes200ResponseRecipesInnerNutritionNutrientsInner]',
    ...
    'nutrients' => {
        datatype => 'ARRAY[RetrieveRecipeInformation200ResponseNutritionIngredientBreakdownInnerNutrientsInner]',
        base_name => 'nutrients',
        description => '',
        format => '',
        read_only => '',
