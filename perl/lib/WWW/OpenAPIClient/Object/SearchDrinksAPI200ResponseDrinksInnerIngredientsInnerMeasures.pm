...
#
package WWW::OpenAPIClient::Object::SearchDrinksAPI200ResponseDrinksInnerIngredientsInnerMeasures;
...
__PACKAGE__->method_documentation({
    'metric' => {
        datatype => 'SearchDrinksAPI200ResponseDrinksInnerIngredientsInnerMeasuresMetric',
        base_name => 'metric',
        description => '',
        format => '',
        read_only => '',
    ...
    'us' => {
        datatype => 'SearchDrinksAPI200ResponseDrinksInnerIngredientsInnerMeasuresUs',
        base_name => 'us',
        description => '',
        format => '',
        read_only => '',
