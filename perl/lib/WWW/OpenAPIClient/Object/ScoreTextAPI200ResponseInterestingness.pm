...
#
package WWW::OpenAPIClient::Object::ScoreTextAPI200ResponseInterestingness;
...
__PACKAGE__->method_documentation({
    'mainscores' => {
        datatype => 'ScoreTextAPI200ResponseSkimmabilityMainscores',
    ...
    'subscores' => {
        datatype => 'ScoreTextAPI200ResponseInterestingnessSubscores',
        base_name => 'subscores',
        description => '',
        format => '',
        read_only => '',
