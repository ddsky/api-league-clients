...
#
package WWW::OpenAPIClient::Object::SearchDrinksAPI200ResponseDrinksInner;
...
__PACKAGE__->method_documentation({
    ...
    'instructions' => {
        datatype => 'ARRAY[SearchDrinksAPI200ResponseDrinksInnerInstructionsInner]',
    ...
    'nutrition' => {
        datatype => 'SearchDrinksAPI200ResponseDrinksInnerNutrition',
        base_name => 'nutrition',
        description => '',
        format => '',
        read_only => '',
    ...
    'glass_type' => {
        datatype => 'string',
        base_name => 'glass_type',
        description => '',
        format => '',
        read_only => '',
            },
    'credits' => {
        datatype => 'SearchDrinksAPI200ResponseDrinksInnerCredits',
        base_name => 'credits',
        description => '',
        format => '',
        read_only => '',
    ...
    'ingredients' => {
        datatype => 'ARRAY[SearchDrinksAPI200ResponseDrinksInnerIngredientsInner]',
