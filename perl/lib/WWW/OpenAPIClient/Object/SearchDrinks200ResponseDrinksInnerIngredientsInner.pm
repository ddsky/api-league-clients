...
#
package WWW::OpenAPIClient::Object::SearchDrinks200ResponseDrinksInnerIngredientsInner;
...
__PACKAGE__->method_documentation({
    ...
    'measures' => {
        datatype => 'SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasures',
        base_name => 'measures',
        description => '',
        format => '',
        read_only => '',
