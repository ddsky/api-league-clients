...
#
package WWW::OpenAPIClient::Object::ComputeNutrition200ResponseIngredientBreakdownInner;
...
__PACKAGE__->method_documentation({
    ...
    'nutrients' => {
        datatype => 'ARRAY[ComputeNutrition200ResponseIngredientBreakdownInnerNutrientsInner]',
        base_name => 'nutrients',
        description => '',
        format => '',
        read_only => '',
