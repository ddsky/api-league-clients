...
#
package WWW::OpenAPIClient::Object::RetrieveRecipeInformation200Response;
...
__PACKAGE__->method_documentation({
    ...
    'dietary_properties' => {
        datatype => 'RetrieveRecipeInformation200ResponseDietaryProperties',
    ...
    'times' => {
        datatype => 'RetrieveRecipeInformation200ResponseTimes',
        base_name => 'times',
        description => '',
        format => '',
        read_only => '',
    ...
    'nutrition' => {
        datatype => 'RetrieveRecipeInformation200ResponseNutrition',
        base_name => 'nutrition',
        description => '',
        format => '',
        read_only => '',
    ...
    'taste' => {
        datatype => 'RetrieveRecipeInformation200ResponseTaste',
        base_name => 'taste',
        description => '',
        format => '',
        read_only => '',
    ...
    'ingredients' => {
        datatype => 'ARRAY[RetrieveRecipeInformation200ResponseIngredientsInner]',
    ...
    'instructions' => {
        datatype => 'ARRAY[RetrieveRecipeInformation200ResponseInstructionsInner]',
    ...
    'credits' => {
        datatype => 'RetrieveRecipeInformation200ResponseCredits',
        base_name => 'credits',
        description => '',
        format => '',
        read_only => '',
    ...
    'scores' => {
        datatype => 'RetrieveRecipeInformation200ResponseScores',
        base_name => 'scores',
        description => '',
        format => '',
        read_only => '',
