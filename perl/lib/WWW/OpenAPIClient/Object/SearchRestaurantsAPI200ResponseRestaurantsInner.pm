...
#
package WWW::OpenAPIClient::Object::SearchRestaurantsAPI200ResponseRestaurantsInner;
...
__PACKAGE__->method_documentation({
    ...
    'address' => {
        datatype => 'SearchRestaurantsAPI200ResponseRestaurantsInnerAddress',
        base_name => 'address',
        description => '',
        format => '',
        read_only => '',
    ...
    'local_hours' => {
        datatype => 'SearchRestaurantsAPI200ResponseRestaurantsInnerLocalHours',
