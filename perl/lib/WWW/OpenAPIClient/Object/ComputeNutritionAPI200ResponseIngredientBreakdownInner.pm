...
#
package WWW::OpenAPIClient::Object::ComputeNutritionAPI200ResponseIngredientBreakdownInner;
...
__PACKAGE__->method_documentation({
    ...
    'nutrients' => {
        datatype => 'ARRAY[ComputeNutritionAPI200ResponseIngredientBreakdownInnerNutrientsInner]',
        base_name => 'nutrients',
        description => '',
        format => '',
        read_only => '',
