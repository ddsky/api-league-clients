...
#
package WWW::OpenAPIClient::Object::RetrieveRecipeInformationAPI200ResponseNutrition;
...
__PACKAGE__->method_documentation({
    'weight_per_serving' => {
        datatype => 'SearchDrinksAPI200ResponseDrinksInnerNutritionWeightPerServing',
        base_name => 'weight_per_serving',
        description => '',
        format => '',
        read_only => '',
            },
    'caloric_breakdown' => {
        datatype => 'SearchDrinksAPI200ResponseDrinksInnerNutritionCaloricBreakdown',
        base_name => 'caloric_breakdown',
        description => '',
        format => '',
        read_only => '',
            },
    'flavonoids' => {
        datatype => 'ARRAY[SearchDrinksAPI200ResponseDrinksInnerNutritionFlavonoidsInner]',
        base_name => 'flavonoids',
        description => '',
        format => '',
        read_only => '',
            },
    'ingredient_breakdown' => {
        datatype => 'ARRAY[RetrieveRecipeInformationAPI200ResponseNutritionIngredientBreakdownInner]',
        base_name => 'ingredient_breakdown',
        description => '',
        format => '',
        read_only => '',
            },
    'properties' => {
        datatype => 'ARRAY[SearchRecipesAPI200ResponseRecipesInnerNutritionNutrientsInner]',
    ...
    'nutrients' => {
        datatype => 'ARRAY[SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner]',
        base_name => 'nutrients',
        description => '',
        format => '',
        read_only => '',
