...
#
package WWW::OpenAPIClient::Object::SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasures;
...
__PACKAGE__->method_documentation({
    ...
    'us' => {
        datatype => 'SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasuresUs',
        base_name => 'us',
        description => '',
        format => '',
        read_only => '',
