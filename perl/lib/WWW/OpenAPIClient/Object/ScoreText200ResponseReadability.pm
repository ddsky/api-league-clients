...
#
package WWW::OpenAPIClient::Object::ScoreText200ResponseReadability;
...
__PACKAGE__->method_documentation({
    'mainscores' => {
        datatype => 'ScoreText200ResponseReadabilityMainscores',
    ...
    'subscores' => {
        datatype => 'ScoreText200ResponseReadabilitySubscores',
        base_name => 'subscores',
        description => '',
        format => '',
        read_only => '',
