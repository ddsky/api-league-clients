...
#
package WWW::OpenAPIClient::Object::ScoreTextAPI200Response;
...
__PACKAGE__->method_documentation({
    ...
    'number_of_sentences' => {
        datatype => 'int',
        base_name => 'number_of_sentences',
        description => '',
        format => '',
        read_only => '',
            },
    'readability' => {
        datatype => 'ScoreTextAPI200ResponseReadability',
        base_name => 'readability',
        description => '',
        format => '',
        read_only => '',
            },
    'skimmability' => {
        datatype => 'ScoreTextAPI200ResponseSkimmability',
        base_name => 'skimmability',
        description => '',
        format => '',
        read_only => '',
            },
    'interestingness' => {
        datatype => 'ScoreTextAPI200ResponseInterestingness',
        base_name => 'interestingness',
        description => '',
        format => '',
        read_only => '',
            },
    'style' => {
        datatype => 'ScoreTextAPI200ResponseStyle',
        base_name => 'style',
        description => '',
        format => '',
        read_only => '',
