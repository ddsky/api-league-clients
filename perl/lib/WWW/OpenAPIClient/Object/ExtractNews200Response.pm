...
#
package WWW::OpenAPIClient::Object::ExtractNews200Response;
...
__PACKAGE__->method_documentation({
    ...
    'images' => {
        datatype => 'ARRAY[ExtractNews200ResponseImagesInner]',
        base_name => 'images',
        description => '',
        format => '',
        read_only => '',
    ...
    'videos' => {
        datatype => 'ARRAY[ExtractNews200ResponseVideosInner]',
        base_name => 'videos',
        description => '',
        format => '',
        read_only => '',
