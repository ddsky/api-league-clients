...
#
package WWW::OpenAPIClient::Object::ScoreTextAPI200ResponseReadability;
...
__PACKAGE__->method_documentation({
    'mainscores' => {
        datatype => 'ScoreTextAPI200ResponseReadabilityMainscores',
    ...
    'subscores' => {
        datatype => 'ScoreTextAPI200ResponseReadabilitySubscores',
        base_name => 'subscores',
        description => '',
        format => '',
        read_only => '',
