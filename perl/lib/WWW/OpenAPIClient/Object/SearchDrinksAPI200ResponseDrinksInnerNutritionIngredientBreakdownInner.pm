...
#
package WWW::OpenAPIClient::Object::SearchDrinksAPI200ResponseDrinksInnerNutritionIngredientBreakdownInner;
...
__PACKAGE__->method_documentation({
    ...
    'nutrients' => {
        datatype => 'ARRAY[SearchDrinksAPI200ResponseDrinksInnerNutritionIngredientBreakdownInnerNutrientsInner]',
        base_name => 'nutrients',
        description => '',
        format => '',
        read_only => '',
