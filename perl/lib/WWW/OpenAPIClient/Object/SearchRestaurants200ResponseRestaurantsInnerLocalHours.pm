...
#
package WWW::OpenAPIClient::Object::SearchRestaurants200ResponseRestaurantsInnerLocalHours;
...
__PACKAGE__->method_documentation({
    'operational' => {
        datatype => 'SearchRestaurants200ResponseRestaurantsInnerLocalHoursOperational',
