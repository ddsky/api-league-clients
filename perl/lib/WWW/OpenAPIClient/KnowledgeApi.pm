...
# @param int $max_length The maximum length of the quote in letters. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'random_quote_api' } = {
        summary => 'Random Quote API',
        params => $params,
        returns => 'RandomQuoteAPI200Response',
        };
}
# @return RandomQuoteAPI200Response
#
sub random_quote_api {
    my ($self, %args) = @_;
    ...
    my $_response_object = $self->{api_client}->deserialize('RandomQuoteAPI200Response', $response);
...
# @param string $difficulty The difficulty of the riddle, either \&quot;easy\&quot;, \&quot;medium\&quot;, or \&quot;hard\&quot;. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'random_riddle_api' } = {
        summary => 'Random Riddle API',
        params => $params,
        returns => 'RandomRiddleAPI200Response',
        };
}
# @return RandomRiddleAPI200Response
#
sub random_riddle_api {
    my ($self, %args) = @_;
    ...
    my $_response_object = $self->{api_client}->deserialize('RandomRiddleAPI200Response', $response);
    return $_response_object;
}
...
# @param int $max_length The maximum length of the trivia in letters. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'random_trivia_api' } = {
        summary => 'Random Trivia API',
        params => $params,
        returns => 'RandomTriviaAPI200Response',
        };
}
# @return RandomTriviaAPI200Response
#
sub random_trivia_api {
    my ($self, %args) = @_;
    ...
    my $_response_object = $self->{api_client}->deserialize('RandomTriviaAPI200Response', $response);
    return $_response_object;
}
