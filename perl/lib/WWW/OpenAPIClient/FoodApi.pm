...
# @param int $number The number of drinks, between 1 and 10. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'search_drinks' } = {
        summary => 'Search Drinks',
        params => $params,
        returns => 'SearchDrinks200Response',
        };
}
...
sub search_drinks {
    ...
    my $_response_object = $self->{api_client}->deserialize('SearchDrinks200Response', $response);
    return $_response_object;
}
