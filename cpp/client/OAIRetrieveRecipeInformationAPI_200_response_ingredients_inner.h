...
/*
 * OAIRetrieveRecipeInformationAPI_200_response_ingredients_inner.h
 *
 * 
 */

#ifndef OAIRetrieveRecipeInformationAPI_200_response_ingredients_inner_H
#define OAIRetrieveRecipeInformationAPI_200_response_ingredients_inner_H
...
namespace OpenAPI {
class OAIRetrieveRecipeInformationAPI_200_response_ingredients_inner_measures;

class OAIRetrieveRecipeInformationAPI_200_response_ingredients_inner : public OAIObject {
public:
    OAIRetrieveRecipeInformationAPI_200_response_ingredients_inner();
    OAIRetrieveRecipeInformationAPI_200_response_ingredients_inner(QString json);
    ~OAIRetrieveRecipeInformationAPI_200_response_ingredients_inner() override;
    ...
    OAIRetrieveRecipeInformationAPI_200_response_ingredients_inner_measures getMeasures() const;
    void setMeasures(const OAIRetrieveRecipeInformationAPI_200_response_ingredients_inner_measures &measures);
...
private:
    ...
    OAIRetrieveRecipeInformationAPI_200_response_ingredients_inner_measures m_measures;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetrieveRecipeInformationAPI_200_response_ingredients_inner)

#endif // OAIRetrieveRecipeInformationAPI_200_response_ingredients_inner_H
