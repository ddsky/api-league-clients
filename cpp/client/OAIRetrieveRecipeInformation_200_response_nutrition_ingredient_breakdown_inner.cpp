...
QList<OAIRetrieveRecipeInformation_200_response_nutrition_ingredient_breakdown_inner_nutrients_inner> OAIRetrieveRecipeInformation_200_response_nutrition_ingredient_breakdown_inner::getNutrients() const {
    return m_nutrients;
}
void OAIRetrieveRecipeInformation_200_response_nutrition_ingredient_breakdown_inner::setNutrients(const QList<OAIRetrieveRecipeInformation_200_response_nutrition_ingredient_breakdown_inner_nutrients_inner> &nutrients) {
