...
#include "com.apileague.client.model\OAIInline_response_200.h"
#include "com.apileague.client.model\OAIInline_response_200_1.h"
#include <QString>
...
signals:
    ...
    void findSimilarBooksSignal(OAIInline_response_200_1 summary);
    void searchBooksSignal(OAIInline_response_200 summary);

    void findSimilarBooksSignalFull(OAIHttpRequestWorker *worker, OAIInline_response_200_1 summary);
    void searchBooksSignalFull(OAIHttpRequestWorker *worker, OAIInline_response_200 summary);

    void findSimilarBooksSignalE(OAIInline_response_200_1 summary, QNetworkReply::NetworkError error_type, QString error_str);
    void searchBooksSignalE(OAIInline_response_200 summary, QNetworkReply::NetworkError error_type, QString error_str);
