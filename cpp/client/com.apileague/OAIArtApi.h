...
#include "com.apileague.client.model\OAIInline_response_200_11.h"
#include <QString>
...
signals:
    ...
    void randomPoemSignal(OAIInline_response_200_11 summary);

    void imageToAsciiArtByURLSignalFull(OAIHttpRequestWorker *worker, QString summary);
    void randomPoemSignalFull(OAIHttpRequestWorker *worker, OAIInline_response_200_11 summary);

    void imageToAsciiArtByURLSignalE(QString summary, QNetworkReply::NetworkError error_type, QString error_str);
    void randomPoemSignalE(OAIInline_response_200_11 summary, QNetworkReply::NetworkError error_type, QString error_str);
