...
void OAIWebApi::extractAuthorsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        emit extractAuthorsSignal(output);
        emit extractAuthorsSignalFull(worker, output);
    } else {
        emit extractAuthorsSignalE(output, error_type, error_str);
        emit extractAuthorsSignalEFull(worker, error_type, error_str);
    }
}
...
void OAIWebApi::extractContentFromAWebPageCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        emit extractContentFromAWebPageSignal(output);
        emit extractContentFromAWebPageSignalFull(worker, output);
    } else {
        emit extractContentFromAWebPageSignalE(output, error_type, error_str);
        emit extractContentFromAWebPageSignalEFull(worker, error_type, error_str);
    }
}
...
void OAIWebApi::extractPublishDateCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        emit extractPublishDateSignal(output);
        emit extractPublishDateSignalFull(worker, output);
    } else {
        emit extractPublishDateSignalE(output, error_type, error_str);
        emit extractPublishDateSignalEFull(worker, error_type, error_str);
    }
}
...
void OAIWebApi::searchWebCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        emit searchWebSignal(output);
        emit searchWebSignalFull(worker, output);
    } else {
        emit searchWebSignalE(output, error_type, error_str);
        emit searchWebSignalEFull(worker, error_type, error_str);
    }
}
