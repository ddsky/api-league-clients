...
/*
 * OAIDetectMainImageColorAPI_200_response_inner.h
 *
 * 
 */

#ifndef OAIDetectMainImageColorAPI_200_response_inner_H
#define OAIDetectMainImageColorAPI_200_response_inner_H
...
class OAIDetectMainImageColorAPI_200_response_inner : public OAIObject {
public:
    OAIDetectMainImageColorAPI_200_response_inner();
    OAIDetectMainImageColorAPI_200_response_inner(QString json);
    ~OAIDetectMainImageColorAPI_200_response_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectMainImageColorAPI_200_response_inner)

#endif // OAIDetectMainImageColorAPI_200_response_inner_H
