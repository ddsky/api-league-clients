...
#ifndef OAIExtractDates_200_response_dates_inner_H
#define OAIExtractDates_200_response_dates_inner_H
...
class OAIExtractDates_200_response_dates_inner : public OAIObject {
public:
    OAIExtractDates_200_response_dates_inner();
    OAIExtractDates_200_response_dates_inner(QString json);
    ~OAIExtractDates_200_response_dates_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExtractDates_200_response_dates_inner)

#endif // OAIExtractDates_200_response_dates_inner_H
