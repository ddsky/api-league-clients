...
QList<OAISearchDrinks_200_response_drinks_inner_nutrition_nutrients_inner> OAIComputeNutrition_200_response::getNutrients() const {
    return m_nutrients;
}
void OAIComputeNutrition_200_response::setNutrients(const QList<OAISearchDrinks_200_response_drinks_inner_nutrition_nutrients_inner> &nutrients) {
...
QList<OAISearchDrinks_200_response_drinks_inner_nutrition_flavonoids_inner> OAIComputeNutrition_200_response::getProperties() const {
    return m_properties;
}
void OAIComputeNutrition_200_response::setProperties(const QList<OAISearchDrinks_200_response_drinks_inner_nutrition_flavonoids_inner> &properties) {
...
OAISearchDrinks_200_response_drinks_inner_nutrition_caloric_breakdown OAIComputeNutrition_200_response::getCaloricBreakdown() const {
    return m_caloric_breakdown;
}
void OAIComputeNutrition_200_response::setCaloricBreakdown(const OAISearchDrinks_200_response_drinks_inner_nutrition_caloric_breakdown &caloric_breakdown) {
...
OAISearchDrinks_200_response_drinks_inner_nutrition_weight_per_serving OAIComputeNutrition_200_response::getWeightPerServing() const {
    return m_weight_per_serving;
}
void OAIComputeNutrition_200_response::setWeightPerServing(const OAISearchDrinks_200_response_drinks_inner_nutrition_weight_per_serving &weight_per_serving) {
