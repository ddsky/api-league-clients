...
/*
 * OAIRetrieveRecipeInformationAPI_200_response_nutrition.h
 *
 * 
 */

#ifndef OAIRetrieveRecipeInformationAPI_200_response_nutrition_H
#define OAIRetrieveRecipeInformationAPI_200_response_nutrition_H
...
class OAIRetrieveRecipeInformationAPI_200_response_nutrition_ingredient_breakdown_inner;
...
class OAIRetrieveRecipeInformationAPI_200_response_nutrition : public OAIObject {
public:
    OAIRetrieveRecipeInformationAPI_200_response_nutrition();
    OAIRetrieveRecipeInformationAPI_200_response_nutrition(QString json);
    ~OAIRetrieveRecipeInformationAPI_200_response_nutrition() override;
    ...
    QList<OAISearchDrinksAPI_200_response_drinks_inner_nutrition_flavonoids_inner> getFlavonoids() const;
    void setFlavonoids(const QList<OAISearchDrinksAPI_200_response_drinks_inner_nutrition_flavonoids_inner> &flavonoids);
    bool is_flavonoids_Set() const;
    bool is_flavonoids_Valid() const;

    QList<OAIRetrieveRecipeInformationAPI_200_response_nutrition_ingredient_breakdown_inner> getIngredientBreakdown() const;
    void setIngredientBreakdown(const QList<OAIRetrieveRecipeInformationAPI_200_response_nutrition_ingredient_breakdown_inner> &ingredient_breakdown);
    bool is_ingredient_breakdown_Set() const;
    bool is_ingredient_breakdown_Valid() const;

    QList<OAISearchRecipesAPI_200_response_recipes_inner_nutrition_nutrients_inner> getProperties() const;
    void setProperties(const QList<OAISearchRecipesAPI_200_response_recipes_inner_nutrition_nutrients_inner> &properties);
...
private:
    ...
    QList<OAISearchDrinksAPI_200_response_drinks_inner_nutrition_flavonoids_inner> m_flavonoids;
    bool m_flavonoids_isSet;
    bool m_flavonoids_isValid;

    QList<OAIRetrieveRecipeInformationAPI_200_response_nutrition_ingredient_breakdown_inner> m_ingredient_breakdown;
    bool m_ingredient_breakdown_isSet;
    bool m_ingredient_breakdown_isValid;

    QList<OAISearchRecipesAPI_200_response_recipes_inner_nutrition_nutrients_inner> m_properties;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetrieveRecipeInformationAPI_200_response_nutrition)

#endif // OAIRetrieveRecipeInformationAPI_200_response_nutrition_H
