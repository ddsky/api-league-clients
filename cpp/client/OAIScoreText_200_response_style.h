...
#ifndef OAIScoreText_200_response_style_H
#define OAIScoreText_200_response_style_H
...
class OAIScoreText_200_response_style_subscores;

class OAIScoreText_200_response_style : public OAIObject {
public:
    OAIScoreText_200_response_style();
    OAIScoreText_200_response_style(QString json);
    ~OAIScoreText_200_response_style() override;
    ...
    OAIScoreText_200_response_style_subscores getSubscores() const;
    void setSubscores(const OAIScoreText_200_response_style_subscores &subscores);
...
private:
    ...
    OAIScoreText_200_response_style_subscores m_subscores;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScoreText_200_response_style)

#endif // OAIScoreText_200_response_style_H
