...
qint32 OAISearchBooks_200_response::getTotalResults() const {
    return m_total_results;
}
void OAISearchBooks_200_response::setTotalResults(const qint32 &total_results) {
    m_total_results = total_results;
    m_total_results_isSet = true;
}

bool OAISearchBooks_200_response::is_total_results_Set() const{
    return m_total_results_isSet;
}

bool OAISearchBooks_200_response::is_total_results_Valid() const{
