...
QList<OAISearchBooks_200_response_books_inner> OAISearchBooks_200_response::getBooks() const {
    return m_books;
}
void OAISearchBooks_200_response::setBooks(const QList<OAISearchBooks_200_response_books_inner> &books) {
    m_books = books;
    m_books_isSet = true;
}
