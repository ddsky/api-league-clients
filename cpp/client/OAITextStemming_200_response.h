...
#ifndef OAITextStemming_200_response_H
#define OAITextStemming_200_response_H
...
class OAITextStemming_200_response : public OAIObject {
public:
    OAITextStemming_200_response();
    OAITextStemming_200_response(QString json);
    ~OAITextStemming_200_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITextStemming_200_response)

#endif // OAITextStemming_200_response_H
