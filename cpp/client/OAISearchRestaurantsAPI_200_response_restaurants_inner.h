...
/*
 * OAISearchRestaurantsAPI_200_response_restaurants_inner.h
 *
 * 
 */

#ifndef OAISearchRestaurantsAPI_200_response_restaurants_inner_H
#define OAISearchRestaurantsAPI_200_response_restaurants_inner_H
...
namespace OpenAPI {
class OAISearchRestaurantsAPI_200_response_restaurants_inner_address;
class OAISearchRestaurantsAPI_200_response_restaurants_inner_local_hours;

class OAISearchRestaurantsAPI_200_response_restaurants_inner : public OAIObject {
public:
    OAISearchRestaurantsAPI_200_response_restaurants_inner();
    OAISearchRestaurantsAPI_200_response_restaurants_inner(QString json);
    ~OAISearchRestaurantsAPI_200_response_restaurants_inner() override;
    ...
    OAISearchRestaurantsAPI_200_response_restaurants_inner_address getAddress() const;
    void setAddress(const OAISearchRestaurantsAPI_200_response_restaurants_inner_address &address);
    ...
    OAISearchRestaurantsAPI_200_response_restaurants_inner_local_hours getLocalHours() const;
    void setLocalHours(const OAISearchRestaurantsAPI_200_response_restaurants_inner_local_hours &local_hours);
...
private:
    ...
    OAISearchRestaurantsAPI_200_response_restaurants_inner_address m_address;
    ...
    OAISearchRestaurantsAPI_200_response_restaurants_inner_local_hours m_local_hours;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchRestaurantsAPI_200_response_restaurants_inner)

#endif // OAISearchRestaurantsAPI_200_response_restaurants_inner_H
