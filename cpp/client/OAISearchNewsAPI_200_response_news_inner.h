...
/*
 * OAISearchNewsAPI_200_response_news_inner.h
 *
 * 
 */

#ifndef OAISearchNewsAPI_200_response_news_inner_H
#define OAISearchNewsAPI_200_response_news_inner_H
...
class OAISearchNewsAPI_200_response_news_inner : public OAIObject {
public:
    OAISearchNewsAPI_200_response_news_inner();
    OAISearchNewsAPI_200_response_news_inner(QString json);
    ~OAISearchNewsAPI_200_response_news_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchNewsAPI_200_response_news_inner)

#endif // OAISearchNewsAPI_200_response_news_inner_H
