...
public:
    ...
    QList<OAISearchBooks_200_response_books_inner> getBooks() const;
    void setBooks(const QList<OAISearchBooks_200_response_books_inner> &books);
...
private:
    ...
    QList<OAISearchBooks_200_response_books_inner> m_books;
    bool m_books_isSet;
