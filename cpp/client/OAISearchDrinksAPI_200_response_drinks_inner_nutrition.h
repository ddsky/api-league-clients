...
/*
 * OAISearchDrinksAPI_200_response_drinks_inner_nutrition.h
 *
 * 
 */

#ifndef OAISearchDrinksAPI_200_response_drinks_inner_nutrition_H
#define OAISearchDrinksAPI_200_response_drinks_inner_nutrition_H
...
class OAISearchDrinksAPI_200_response_drinks_inner_nutrition_ingredient_breakdown_inner;
class OAISearchDrinksAPI_200_response_drinks_inner_nutrition_nutrients_inner;

class OAISearchDrinksAPI_200_response_drinks_inner_nutrition : public OAIObject {
public:
    OAISearchDrinksAPI_200_response_drinks_inner_nutrition();
    OAISearchDrinksAPI_200_response_drinks_inner_nutrition(QString json);
    ~OAISearchDrinksAPI_200_response_drinks_inner_nutrition() override;
    ...
    QList<OAISearchDrinksAPI_200_response_drinks_inner_nutrition_ingredient_breakdown_inner> getIngredientBreakdown() const;
    void setIngredientBreakdown(const QList<OAISearchDrinksAPI_200_response_drinks_inner_nutrition_ingredient_breakdown_inner> &ingredient_breakdown);
...
private:
    ...
    QList<OAISearchDrinksAPI_200_response_drinks_inner_nutrition_ingredient_breakdown_inner> m_ingredient_breakdown;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchDrinksAPI_200_response_drinks_inner_nutrition)

#endif // OAISearchDrinksAPI_200_response_drinks_inner_nutrition_H
