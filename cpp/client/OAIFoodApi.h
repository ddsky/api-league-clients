...
private:
    ...
    void searchDrinksCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void searchDrinksSignal(OAISearchDrinks_200_response summary);
    ...
    void searchDrinksSignalFull(OAIHttpRequestWorker *worker, OAISearchDrinks_200_response summary);
    ...
    Q_DECL_DEPRECATED_X("Use searchDrinksSignalError() instead")
    void searchDrinksSignalE(OAISearchDrinks_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void searchDrinksSignalError(OAISearchDrinks_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use searchDrinksSignalErrorFull() instead")
    void searchDrinksSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void searchDrinksSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
