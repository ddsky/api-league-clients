...
/*
 * OAIScoreTextAPI_200_response_interestingness_subscores.h
 *
 * 
 */

#ifndef OAIScoreTextAPI_200_response_interestingness_subscores_H
#define OAIScoreTextAPI_200_response_interestingness_subscores_H
...
class OAIScoreTextAPI_200_response_interestingness_subscores : public OAIObject {
public:
    OAIScoreTextAPI_200_response_interestingness_subscores();
    OAIScoreTextAPI_200_response_interestingness_subscores(QString json);
    ~OAIScoreTextAPI_200_response_interestingness_subscores() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScoreTextAPI_200_response_interestingness_subscores)

#endif // OAIScoreTextAPI_200_response_interestingness_subscores_H
