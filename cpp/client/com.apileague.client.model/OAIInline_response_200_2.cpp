...
qint32 OAIInline_response_200_2::getOffset() const {
    return offset;
}
void OAIInline_response_200_2::setOffset(const qint32 &offset) {
    this->offset = offset;
    this->m_offset_isSet = true;
}

bool OAIInline_response_200_2::is_offset_Set() const{
    return m_offset_isSet;
}

bool OAIInline_response_200_2::is_offset_Valid() const{
    return m_offset_isValid;
}

qint32 OAIInline_response_200_2::getNumber() const {
    return number;
}
void OAIInline_response_200_2::setNumber(const qint32 &number) {
    this->number = number;
    this->m_number_isSet = true;
}

bool OAIInline_response_200_2::is_number_Set() const{
    return m_number_isSet;
}

bool OAIInline_response_200_2::is_number_Valid() const{
    return m_number_isValid;
}

qint32 OAIInline_response_200_2::getAvailable() const {
    return available;
}
void OAIInline_response_200_2::setAvailable(const qint32 &available) {
    this->available = available;
    this->m_available_isSet = true;
}

bool OAIInline_response_200_2::is_available_Set() const{
    return m_available_isSet;
}

bool OAIInline_response_200_2::is_available_Valid() const{
    return m_available_isValid;
}

QList<OAIInline_response_200_2_news> OAIInline_response_200_2::getNews() const {
    return news;
}
void OAIInline_response_200_2::setNews(const QList<OAIInline_response_200_2_news> &news) {
    this->news = news;
    this->m_news_isSet = true;
}

bool OAIInline_response_200_2::is_news_Set() const{
    return m_news_isSet;
}

bool OAIInline_response_200_2::is_news_Valid() const{
