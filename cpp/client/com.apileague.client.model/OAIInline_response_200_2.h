...
#include "com.apileague.client.model\OAIInline_response_200_2_news.h"
#include <QList>
...
public:
    ...
    QList<OAIInline_response_200_2_news> getNews() const;
    void setNews(const QList<OAIInline_response_200_2_news> &news);
...
private:
    ...
    QList<OAIInline_response_200_2_news> news;
    bool m_news_isSet;
    bool m_news_isValid;
};
