...
#include "com.apileague.client.model\OAIInline_response_200_28_images.h"
#include <QList>
...
public:
    ...
    QList<OAIInline_response_200_28_images> getImages() const;
    void setImages(const QList<OAIInline_response_200_28_images> &images);
...
private:
    ...
    QList<OAIInline_response_200_28_images> images;
    bool m_images_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInline_response_200_28)
