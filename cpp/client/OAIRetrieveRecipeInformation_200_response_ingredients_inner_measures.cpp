...
OAISearchDrinks_200_response_drinks_inner_ingredients_inner_measures_metric OAIRetrieveRecipeInformation_200_response_ingredients_inner_measures::getMetric() const {
    return m_metric;
}
void OAIRetrieveRecipeInformation_200_response_ingredients_inner_measures::setMetric(const OAISearchDrinks_200_response_drinks_inner_ingredients_inner_measures_metric &metric) {
    m_metric = metric;
    m_metric_isSet = true;
}
...
OAISearchDrinks_200_response_drinks_inner_ingredients_inner_measures_metric OAIRetrieveRecipeInformation_200_response_ingredients_inner_measures::getUs() const {
    return m_us;
}
void OAIRetrieveRecipeInformation_200_response_ingredients_inner_measures::setUs(const OAISearchDrinks_200_response_drinks_inner_ingredients_inner_measures_metric &us) {
    m_us = us;
    m_us_isSet = true;
}
