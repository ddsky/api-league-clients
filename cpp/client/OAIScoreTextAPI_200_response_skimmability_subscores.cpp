...
OAIScoreTextAPI_200_response_skimmability_subscores::OAIScoreTextAPI_200_response_skimmability_subscores(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScoreTextAPI_200_response_skimmability_subscores::OAIScoreTextAPI_200_response_skimmability_subscores() {
    this->initializeModel();
}

OAIScoreTextAPI_200_response_skimmability_subscores::~OAIScoreTextAPI_200_response_skimmability_subscores() {}

void OAIScoreTextAPI_200_response_skimmability_subscores::initializeModel() {
...
void OAIScoreTextAPI_200_response_skimmability_subscores::fromJson(QString jsonString) {
...
void OAIScoreTextAPI_200_response_skimmability_subscores::fromJsonObject(QJsonObject json) {
...
QString OAIScoreTextAPI_200_response_skimmability_subscores::asJson() const {
...
QJsonObject OAIScoreTextAPI_200_response_skimmability_subscores::asJsonObject() const {
    QJsonObject obj;
...
QList<qint32> OAIScoreTextAPI_200_response_skimmability_subscores::getBulletPointRatioScore() const {
    return m_bullet_point_ratio_score;
}
void OAIScoreTextAPI_200_response_skimmability_subscores::setBulletPointRatioScore(const QList<qint32> &bullet_point_ratio_score) {
    m_bullet_point_ratio_score = bullet_point_ratio_score;
    m_bullet_point_ratio_score_isSet = true;
}

bool OAIScoreTextAPI_200_response_skimmability_subscores::is_bullet_point_ratio_score_Set() const{
    return m_bullet_point_ratio_score_isSet;
}

bool OAIScoreTextAPI_200_response_skimmability_subscores::is_bullet_point_ratio_score_Valid() const{
    return m_bullet_point_ratio_score_isValid;
}

QList<qint32> OAIScoreTextAPI_200_response_skimmability_subscores::getImageScore() const {
    return m_image_score;
}
void OAIScoreTextAPI_200_response_skimmability_subscores::setImageScore(const QList<qint32> &image_score) {
    m_image_score = image_score;
    m_image_score_isSet = true;
}

bool OAIScoreTextAPI_200_response_skimmability_subscores::is_image_score_Set() const{
    return m_image_score_isSet;
}

bool OAIScoreTextAPI_200_response_skimmability_subscores::is_image_score_Valid() const{
    return m_image_score_isValid;
}

QList<qint32> OAIScoreTextAPI_200_response_skimmability_subscores::getHighlightedWordRatioScore() const {
    return m_highlighted_word_ratio_score;
}
void OAIScoreTextAPI_200_response_skimmability_subscores::setHighlightedWordRatioScore(const QList<qint32> &highlighted_word_ratio_score) {
    m_highlighted_word_ratio_score = highlighted_word_ratio_score;
    m_highlighted_word_ratio_score_isSet = true;
}

bool OAIScoreTextAPI_200_response_skimmability_subscores::is_highlighted_word_ratio_score_Set() const{
    return m_highlighted_word_ratio_score_isSet;
}

bool OAIScoreTextAPI_200_response_skimmability_subscores::is_highlighted_word_ratio_score_Valid() const{
    return m_highlighted_word_ratio_score_isValid;
}

QList<qint32> OAIScoreTextAPI_200_response_skimmability_subscores::getVideoScore() const {
    return m_video_score;
}
void OAIScoreTextAPI_200_response_skimmability_subscores::setVideoScore(const QList<qint32> &video_score) {
    m_video_score = video_score;
    m_video_score_isSet = true;
}

bool OAIScoreTextAPI_200_response_skimmability_subscores::is_video_score_Set() const{
    return m_video_score_isSet;
}

bool OAIScoreTextAPI_200_response_skimmability_subscores::is_video_score_Valid() const{
    return m_video_score_isValid;
}

QList<qint32> OAIScoreTextAPI_200_response_skimmability_subscores::getParagraphScore() const {
    return m_paragraph_score;
}
void OAIScoreTextAPI_200_response_skimmability_subscores::setParagraphScore(const QList<qint32> &paragraph_score) {
    m_paragraph_score = paragraph_score;
    m_paragraph_score_isSet = true;
}

bool OAIScoreTextAPI_200_response_skimmability_subscores::is_paragraph_score_Set() const{
    return m_paragraph_score_isSet;
}

bool OAIScoreTextAPI_200_response_skimmability_subscores::is_paragraph_score_Valid() const{
    return m_paragraph_score_isValid;
}

QList<qint32> OAIScoreTextAPI_200_response_skimmability_subscores::getParagraphHeadlineRatioScore() const {
    return m_paragraph_headline_ratio_score;
}
void OAIScoreTextAPI_200_response_skimmability_subscores::setParagraphHeadlineRatioScore(const QList<qint32> &paragraph_headline_ratio_score) {
    m_paragraph_headline_ratio_score = paragraph_headline_ratio_score;
    m_paragraph_headline_ratio_score_isSet = true;
}

bool OAIScoreTextAPI_200_response_skimmability_subscores::is_paragraph_headline_ratio_score_Set() const{
    return m_paragraph_headline_ratio_score_isSet;
}

bool OAIScoreTextAPI_200_response_skimmability_subscores::is_paragraph_headline_ratio_score_Valid() const{
    return m_paragraph_headline_ratio_score_isValid;
}

bool OAIScoreTextAPI_200_response_skimmability_subscores::isSet() const {
...
bool OAIScoreTextAPI_200_response_skimmability_subscores::isValid() const {
