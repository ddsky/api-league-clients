...
void OAIMathApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("convertUnitsAPI", defaultConf);
    _serverIndices.insert("convertUnitsAPI", 0);
}
...
void OAIMathApi::convertUnitsAPI(const double &source_amount, const QString &source_unit, const QString &target_unit, const ::OpenAPI::OptionalParam<QString> &food_name) {
    QString fullPath = QString(_serverConfigs["convertUnitsAPI"][_serverIndices.value("convertUnitsAPI")].URL()+"/convert-units");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMathApi::convertUnitsAPICallback);
...
void OAIMathApi::convertUnitsAPICallback(OAIHttpRequestWorker *worker) {
    ...
    OAIConvertUnitsAPI_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT convertUnitsAPISignal(output);
        Q_EMIT convertUnitsAPISignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT convertUnitsAPISignalE(output, error_type, error_str);
        Q_EMIT convertUnitsAPISignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT convertUnitsAPISignalError(output, error_type, error_str);
        Q_EMIT convertUnitsAPISignalErrorFull(worker, error_type, error_str);
    }
}
