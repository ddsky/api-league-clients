...
void OAIMathApi::convertUnits(const double &source_amount, const QString &source_unit, const QString &target_unit, const ::OpenAPI::OptionalParam<QString> &food_name) {
    ...
    
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("source-amount")).append(querySuffix).append(QUrl::toPercentEncoding(::OpenAPI::toStringValue(source_amount)));
    }
    
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("source-unit")).append(querySuffix).append(QUrl::toPercentEncoding(::OpenAPI::toStringValue(source_unit)));
    }
    
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("target-unit")).append(querySuffix).append(QUrl::toPercentEncoding(::OpenAPI::toStringValue(target_unit)));
    }
    if (food_name.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("food-name")).append(querySuffix).append(QUrl::toPercentEncoding(::OpenAPI::toStringValue(food_name.value())));
    }
