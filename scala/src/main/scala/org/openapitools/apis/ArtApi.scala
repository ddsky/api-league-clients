...
import org.openapitools.models.RandomPoem200Response
    ...
    implicit class StringOps(s: String) {
      ...
      def toZonedDateTime: ZonedDateTime = ZonedDateTime.parse(s, datetimeformatter)
        ...
        */
        ...
        /**
        * 
        * @return An endpoint representing a RandomPoem200Response
        */
        private def randomPoem(da: DataAccessor): Endpoint[RandomPoem200Response] =
