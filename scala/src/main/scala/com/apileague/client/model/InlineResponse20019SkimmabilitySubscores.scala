 ...
 */
case class InlineResponse20019SkimmabilitySubscores(bulletUnderscorepointUnderscoreratioUnderscorescore: Option[Seq[Int]],
...
object InlineResponse20019SkimmabilitySubscores {
    /**
     * Creates the codec for converting InlineResponse20019SkimmabilitySubscores from and to JSON.
     */
    implicit val decoder: Decoder[InlineResponse20019SkimmabilitySubscores] = deriveDecoder
    implicit val encoder: ObjectEncoder[InlineResponse20019SkimmabilitySubscores] = deriveEncoder
}
