...
main =
  hspec $ modifyMaxSize (const 10) $ do
    describe "JSON instances" $ do
      ...
      propMimeEq MimeJSON (Proxy :: Proxy RetrieveRecipeInformation200ResponseIngredientsInnerMeasuresMetric)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy RetrieveRecipeInformation200ResponseInstructionsInnerStepsInnerIngredientsInner)
      propMimeEq MimeJSON (Proxy :: Proxy RetrieveRecipeInformation200ResponseNutrition)
      propMimeEq MimeJSON (Proxy :: Proxy RetrieveRecipeInformation200ResponseNutritionCaloricBreakdown)
      propMimeEq MimeJSON (Proxy :: Proxy RetrieveRecipeInformation200ResponseNutritionFlavonoidsInner)
      propMimeEq MimeJSON (Proxy :: Proxy RetrieveRecipeInformation200ResponseNutritionIngredientBreakdownInner)
      propMimeEq MimeJSON (Proxy :: Proxy RetrieveRecipeInformation200ResponseNutritionIngredientBreakdownInnerNutrientsInner)
      propMimeEq MimeJSON (Proxy :: Proxy RetrieveRecipeInformation200ResponseNutritionWeightPerServing)
