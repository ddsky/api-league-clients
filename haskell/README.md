## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `API League`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the API League API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | APILeague                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | api-league                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | APILeagueConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | APILeagueRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| APILeague.Client    | use the "dispatch" functions to send requests       |
| APILeague.Core      | core functions, config and request types            |
| APILeague.API       | construct api requests                              |
| APILeague.Model     | describes api models                                |
| APILeague.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| APILeague.ModelLens | lenses for model fields                             |
| APILeague.Logging   | logging functions and utils                         |
