...
rescaleImage
  ...
  -> APILeagueRequest RescaleImage MimeNoContent FilePath MimeOctetStream
...
searchIcons
  ...
  -> APILeagueRequest SearchIcons MimeNoContent SearchIcons200Response MimeJSON
searchIcons (Query query) =
...
instance HasOptionalParam SearchIcons OnlyPublicDomain where
...
instance HasOptionalParam SearchIcons Number where
  applyOptionalParam req (Number xs) =
    req `addQuery` toQuery ("number", Just xs)
-- | @application/json@
instance Produces SearchIcons MimeJSON
