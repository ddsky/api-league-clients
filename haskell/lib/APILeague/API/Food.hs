...
computeNutritionAPI
  ...
  -> APILeagueRequest ComputeNutritionAPI MimeNoContent ComputeNutritionAPI200Response MimeJSON
computeNutritionAPI (Ingredients ingredients) =
...
instance HasOptionalParam ComputeNutritionAPI ReduceOils where
  applyOptionalParam req (ReduceOils xs) =
    req `addQuery` toQuery ("reduce-oils", Just xs)
-- | @application/json@
instance Produces ComputeNutritionAPI MimeJSON
...
retrieveRecipeInformationAPI
  ...
  -> APILeagueRequest RetrieveRecipeInformationAPI MimeNoContent RetrieveRecipeInformationAPI200Response MimeJSON
retrieveRecipeInformationAPI (Id id) =
  _mkRequest "GET" ["/retrieve-recipe"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKey)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyHeaderApiKey)
    `addQuery` toQuery ("id", Just id)

data RetrieveRecipeInformationAPI  

-- | /Optional Param/ "add-wine-pairing" - Whether to pair a wine to the recipe.
instance HasOptionalParam RetrieveRecipeInformationAPI AddWinePairing where
  applyOptionalParam req (AddWinePairing xs) =
    req `addQuery` toQuery ("add-wine-pairing", Just xs)
-- | @application/json@
instance Produces RetrieveRecipeInformationAPI MimeJSON
...
-- 
searchDrinksAPI
  :: APILeagueRequest SearchDrinksAPI MimeNoContent SearchDrinksAPI200Response MimeJSON
searchDrinksAPI =
  _mkRequest "GET" ["/search-drinks"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKey)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyHeaderApiKey)

data SearchDrinksAPI  

-- | /Optional Param/ "query" - The search query.
instance HasOptionalParam SearchDrinksAPI Query where
  applyOptionalParam req (Query xs) =
    req `addQuery` toQuery ("query", Just xs)

-- | /Optional Param/ "glass-types" - A comma-separated list (interpreted as OR) of glass types that the drink should be served in.
instance HasOptionalParam SearchDrinksAPI GlassTypes where
  applyOptionalParam req (GlassTypes xs) =
    req `addQuery` toQuery ("glass-types", Just xs)

-- | /Optional Param/ "flavors" - A comma-separated list (interpreted as AND) of dominant flavors in the drink.
instance HasOptionalParam SearchDrinksAPI Flavors where
  applyOptionalParam req (Flavors xs) =
    req `addQuery` toQuery ("flavors", Just xs)

-- | /Optional Param/ "diet" - The diet the drink must adhere to. One of the following: paleo,primal,grain-free,vegan,vegetarian.
instance HasOptionalParam SearchDrinksAPI Diet where
  applyOptionalParam req (Diet xs) =
    req `addQuery` toQuery ("diet", Just xs)

-- | /Optional Param/ "include-ingredients" - A comma-separated list of ingredients that should/must be used in the drinks.
instance HasOptionalParam SearchDrinksAPI IncludeIngredients where
  applyOptionalParam req (IncludeIngredients xs) =
    req `addQuery` toQuery ("include-ingredients", Just xs)

-- | /Optional Param/ "exclude-ingredients" - A comma-separated list of ingredients or ingredient types that the drinks must not contain.
instance HasOptionalParam SearchDrinksAPI ExcludeIngredients where
  applyOptionalParam req (ExcludeIngredients xs) =
    req `addQuery` toQuery ("exclude-ingredients", Just xs)

-- | /Optional Param/ "min-calories" - The minimum amount of calories the drink must have per serving.
instance HasOptionalParam SearchDrinksAPI MinCalories where
  applyOptionalParam req (MinCalories xs) =
    req `addQuery` toQuery ("min-calories", Just xs)

-- | /Optional Param/ "max-calories" - The maximum amount of calories the drink can have per serving.
instance HasOptionalParam SearchDrinksAPI MaxCalories where
  applyOptionalParam req (MaxCalories xs) =
    req `addQuery` toQuery ("max-calories", Just xs)

-- | /Optional Param/ "min-carbs" - The minimum amount of carbohydrates in grams the drink must have per serving.
instance HasOptionalParam SearchDrinksAPI MinCarbs where
  applyOptionalParam req (MinCarbs xs) =
    req `addQuery` toQuery ("min-carbs", Just xs)

-- | /Optional Param/ "max-carbs" - The maximum amount of carbohydrates in grams the drink can have per serving.
instance HasOptionalParam SearchDrinksAPI MaxCarbs where
  applyOptionalParam req (MaxCarbs xs) =
    req `addQuery` toQuery ("max-carbs", Just xs)

-- | /Optional Param/ "min-protein" - The minimum amount of protein in grams the drink must have per serving.
instance HasOptionalParam SearchDrinksAPI MinProtein where
  applyOptionalParam req (MinProtein xs) =
    req `addQuery` toQuery ("min-protein", Just xs)

-- | /Optional Param/ "max-protein" - The maximum amount of protein in grams the drink can have per serving.
instance HasOptionalParam SearchDrinksAPI MaxProtein where
  applyOptionalParam req (MaxProtein xs) =
    req `addQuery` toQuery ("max-protein", Just xs)

-- | /Optional Param/ "min-fat" - The minimum amount of fat in grams the drink must have per serving.
instance HasOptionalParam SearchDrinksAPI MinFat where
  applyOptionalParam req (MinFat xs) =
    req `addQuery` toQuery ("min-fat", Just xs)

-- | /Optional Param/ "max-fat" - The maximum amount of fat in grams the drink can have per serving.
instance HasOptionalParam SearchDrinksAPI MaxFat where
  applyOptionalParam req (MaxFat xs) =
    req `addQuery` toQuery ("max-fat", Just xs)

-- | /Optional Param/ "min-alcohol-percent" - The minimum alcohol percentage the drink must have.
instance HasOptionalParam SearchDrinksAPI MinAlcoholPercent where
  applyOptionalParam req (MinAlcoholPercent xs) =
    req `addQuery` toQuery ("min-alcohol-percent", Just xs)

-- | /Optional Param/ "max-alcohol-percent" - The maximum alcohol percentage the drink can have.
instance HasOptionalParam SearchDrinksAPI MaxAlcoholPercent where
  applyOptionalParam req (MaxAlcoholPercent xs) =
    req `addQuery` toQuery ("max-alcohol-percent", Just xs)

-- | /Optional Param/ "min-caffeine" - The minimum amount of caffeine in milligrams the drink must have per serving.
instance HasOptionalParam SearchDrinksAPI MinCaffeine where
  applyOptionalParam req (MinCaffeine xs) =
    req `addQuery` toQuery ("min-caffeine", Just xs)

-- | /Optional Param/ "max-caffeine" - The maximum amount of caffeine in milligrams the drink can have per serving.
instance HasOptionalParam SearchDrinksAPI MaxCaffeine where
  applyOptionalParam req (MaxCaffeine xs) =
    req `addQuery` toQuery ("max-caffeine", Just xs)

-- | /Optional Param/ "sort" - The attribute by which to sort the drinks.
instance HasOptionalParam SearchDrinksAPI Sort where
...
instance HasOptionalParam SearchDrinksAPI SortDirection where
  applyOptionalParam req (SortDirection xs) =
    req `addQuery` toQuery ("sort-direction", Just xs)

-- | /Optional Param/ "offset" - The number of drinks to skip, between 0 and 90.
instance HasOptionalParam SearchDrinksAPI Offset where
  applyOptionalParam req (Offset xs) =
    req `addQuery` toQuery ("offset", Just xs)

-- | /Optional Param/ "number" - The number of drinks, between 1 and 10.
instance HasOptionalParam SearchDrinksAPI Number where
  applyOptionalParam req (Number xs) =
    req `addQuery` toQuery ("number", Just xs)
-- | @application/json@
instance Produces SearchDrinksAPI MimeJSON
...
-- 
searchRecipesAPI
  :: APILeagueRequest SearchRecipesAPI MimeNoContent SearchRecipesAPI200Response MimeJSON
searchRecipesAPI =
  _mkRequest "GET" ["/search-recipes"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKey)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyHeaderApiKey)

data SearchRecipesAPI  

-- | /Optional Param/ "query" - The search query.
instance HasOptionalParam SearchRecipesAPI Query where
  applyOptionalParam req (Query xs) =
    req `addQuery` toQuery ("query", Just xs)

-- | /Optional Param/ "cuisines" - The cuisine(s) of the recipes. One or more, comma-separated (will be interpreted as 'OR').
instance HasOptionalParam SearchRecipesAPI Cuisines where
...
instance HasOptionalParam SearchRecipesAPI ExcludeCuisines where
...
instance HasOptionalParam SearchRecipesAPI MealType where
...
instance HasOptionalParam SearchRecipesAPI Diet where
  applyOptionalParam req (Diet xs) =
    req `addQuery` toQuery ("diet", Just xs)
...
instance HasOptionalParam SearchRecipesAPI Intolerances where
...
instance HasOptionalParam SearchRecipesAPI Equipment where
...
instance HasOptionalParam SearchRecipesAPI IncludeIngredients where
  applyOptionalParam req (IncludeIngredients xs) =
    req `addQuery` toQuery ("include-ingredients", Just xs)
...
instance HasOptionalParam SearchRecipesAPI ExcludeIngredients where
  applyOptionalParam req (ExcludeIngredients xs) =
    req `addQuery` toQuery ("exclude-ingredients", Just xs)
...
instance HasOptionalParam SearchRecipesAPI FillIngredients where
...
instance HasOptionalParam SearchRecipesAPI AddRecipeInformation where
...
instance HasOptionalParam SearchRecipesAPI MaxTime where
...
instance HasOptionalParam SearchRecipesAPI MinServings where
...
instance HasOptionalParam SearchRecipesAPI MaxServings where
...
instance HasOptionalParam SearchRecipesAPI MaxSugar where
...
instance HasOptionalParam SearchRecipesAPI MinFiber where
...
instance HasOptionalParam SearchRecipesAPI MaxFiber where
...
instance HasOptionalParam SearchRecipesAPI MinFolate where
...
instance HasOptionalParam SearchRecipesAPI MaxFolate where
...
instance HasOptionalParam SearchRecipesAPI MinFolicAcid where
...
instance HasOptionalParam SearchRecipesAPI MaxFolicAcid where
...
instance HasOptionalParam SearchRecipesAPI MinIodine where
...
instance HasOptionalParam SearchRecipesAPI MaxIodine where
...
instance HasOptionalParam SearchRecipesAPI MinIron where
...
instance HasOptionalParam SearchRecipesAPI MaxIron where
...
instance HasOptionalParam SearchRecipesAPI MinZinc where
...
instance HasOptionalParam SearchRecipesAPI MaxZinc where
...
instance HasOptionalParam SearchRecipesAPI MinMagnesium where
...
instance HasOptionalParam SearchRecipesAPI MaxMagnesium where
...
instance HasOptionalParam SearchRecipesAPI MinManganese where
...
instance HasOptionalParam SearchRecipesAPI MaxManganese where
...
instance HasOptionalParam SearchRecipesAPI MinPhosphorus where
...
instance HasOptionalParam SearchRecipesAPI MaxPhosphorus where
...
instance HasOptionalParam SearchRecipesAPI MinPotassium where
...
instance HasOptionalParam SearchRecipesAPI MaxPotassium where
...
instance HasOptionalParam SearchRecipesAPI MinSodium where
...
instance HasOptionalParam SearchRecipesAPI MaxSodium where
...
instance HasOptionalParam SearchRecipesAPI MinSelenium where
...
instance HasOptionalParam SearchRecipesAPI MaxSelenium where
...
instance HasOptionalParam SearchRecipesAPI MinCopper where
...
instance HasOptionalParam SearchRecipesAPI MaxCopper where
...
instance HasOptionalParam SearchRecipesAPI MinCalcium where
...
instance HasOptionalParam SearchRecipesAPI MaxCalcium where
...
instance HasOptionalParam SearchRecipesAPI MinCholine where
...
instance HasOptionalParam SearchRecipesAPI MaxCholine where
...
instance HasOptionalParam SearchRecipesAPI MinCholesterol where
...
instance HasOptionalParam SearchRecipesAPI MaxCholesterol where
...
instance HasOptionalParam SearchRecipesAPI MinFluoride where
...
instance HasOptionalParam SearchRecipesAPI MaxFluoride where
...
instance HasOptionalParam SearchRecipesAPI MinAlcohol where
...
instance HasOptionalParam SearchRecipesAPI MaxAlcohol where
...
instance HasOptionalParam SearchRecipesAPI MaxSaturatedFat where
...
instance HasOptionalParam SearchRecipesAPI MinVitaminA where
...
instance HasOptionalParam SearchRecipesAPI MaxVitaminA where
...
instance HasOptionalParam SearchRecipesAPI MinVitaminC where
...
instance HasOptionalParam SearchRecipesAPI MaxVitaminC where
...
instance HasOptionalParam SearchRecipesAPI MinVitaminD where
...
instance HasOptionalParam SearchRecipesAPI MaxVitaminD where
...
instance HasOptionalParam SearchRecipesAPI MinVitaminE where
...
instance HasOptionalParam SearchRecipesAPI MaxVitaminE where
...
instance HasOptionalParam SearchRecipesAPI MinVitaminK where
...
instance HasOptionalParam SearchRecipesAPI MaxVitaminK where
...
instance HasOptionalParam SearchRecipesAPI MinVitaminB1 where
...
instance HasOptionalParam SearchRecipesAPI MaxVitaminB1 where
...
instance HasOptionalParam SearchRecipesAPI MinVitaminB2 where
...
instance HasOptionalParam SearchRecipesAPI MaxVitaminB2 where
...
instance HasOptionalParam SearchRecipesAPI MinVitaminB3 where
...
instance HasOptionalParam SearchRecipesAPI MaxVitaminB3 where
...
instance HasOptionalParam SearchRecipesAPI MinVitaminB5 where
...
instance HasOptionalParam SearchRecipesAPI MaxVitaminB5 where
...
instance HasOptionalParam SearchRecipesAPI MinVitaminB6 where
...
instance HasOptionalParam SearchRecipesAPI MaxVitaminB6 where
...
instance HasOptionalParam SearchRecipesAPI MinVitaminB12 where
...
instance HasOptionalParam SearchRecipesAPI MaxVitaminB12 where
  applyOptionalParam req (MaxVitaminB12 xs) =
    req `addQuery` toQuery ("max-vitamin-b12", Just xs)

-- | /Optional Param/ "sort" - The strategy to sort recipes by.
instance HasOptionalParam SearchRecipesAPI Sort where
  applyOptionalParam req (Sort xs) =
    req `addQuery` toQuery ("sort", Just xs)

-- | /Optional Param/ "sort-direction" - Whether to sort ascending or descending (ASC or DESC).
instance HasOptionalParam SearchRecipesAPI SortDirection where
  applyOptionalParam req (SortDirection xs) =
    req `addQuery` toQuery ("sort-direction", Just xs)

-- | /Optional Param/ "offset" - The number of recipes to skip, between 0 and 900.
instance HasOptionalParam SearchRecipesAPI Offset where
  applyOptionalParam req (Offset xs) =
    req `addQuery` toQuery ("offset", Just xs)

-- | /Optional Param/ "number" - The number of recipes, between 1 and 100.
instance HasOptionalParam SearchRecipesAPI Number where
  applyOptionalParam req (Number xs) =
    req `addQuery` toQuery ("number", Just xs)
-- | @application/json@
instance Produces SearchRecipesAPI MimeJSON
...
searchRestaurantsAPI
  ...
  -> APILeagueRequest SearchRestaurantsAPI MimeNoContent SearchRestaurantsAPI200Response MimeJSON
searchRestaurantsAPI (Lat lat) (Lon lon) =
...
data SearchRestaurantsAPI  

-- | /Optional Param/ "query" - The search query.
instance HasOptionalParam SearchRestaurantsAPI Query where
  applyOptionalParam req (Query xs) =
    req `addQuery` toQuery ("query", Just xs)

-- | /Optional Param/ "distance" - The maximum distance of the restaurant in miles around the given location.
instance HasOptionalParam SearchRestaurantsAPI Distance where
...
instance HasOptionalParam SearchRestaurantsAPI Budget where
...
instance HasOptionalParam SearchRestaurantsAPI MinRating where
...
instance HasOptionalParam SearchRestaurantsAPI Cuisine where
...
instance HasOptionalParam SearchRestaurantsAPI IsOpen where
  applyOptionalParam req (IsOpen xs) =
    req `addQuery` toQuery ("is-open", Just xs)

-- | /Optional Param/ "page" - The page of the results.
instance HasOptionalParam SearchRestaurantsAPI Page where
...
instance HasOptionalParam SearchRestaurantsAPI Sort where
  applyOptionalParam req (Sort xs) =
    req `addQuery` toQuery ("sort", Just xs)
-- | @application/json@
instance Produces SearchRestaurantsAPI MimeJSON
