...
-- 
randomQuoteAPI
  :: APILeagueRequest RandomQuoteAPI MimeNoContent RandomQuoteAPI200Response MimeJSON
randomQuoteAPI =
...
instance HasOptionalParam RandomQuoteAPI MinLength where
...
instance HasOptionalParam RandomQuoteAPI MaxLengthInt where
  applyOptionalParam req (MaxLengthInt xs) =
    req `addQuery` toQuery ("max-length", Just xs)
-- | @application/json@
instance Produces RandomQuoteAPI MimeJSON
...
-- 
randomRiddleAPI
  :: APILeagueRequest RandomRiddleAPI MimeNoContent RandomRiddleAPI200Response MimeJSON
randomRiddleAPI =
  _mkRequest "GET" ["/retrieve-random-riddle"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKey)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyHeaderApiKey)

data RandomRiddleAPI  

-- | /Optional Param/ "difficulty" - The difficulty of the riddle, either \"easy\", \"medium\", or \"hard\".
instance HasOptionalParam RandomRiddleAPI Difficulty where
  applyOptionalParam req (Difficulty xs) =
    req `addQuery` toQuery ("difficulty", Just xs)
-- | @application/json@
instance Produces RandomRiddleAPI MimeJSON
...
-- 
randomTriviaAPI
  :: APILeagueRequest RandomTriviaAPI MimeNoContent RandomTriviaAPI200Response MimeJSON
randomTriviaAPI =
  _mkRequest "GET" ["/retrieve-random-trivia"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKey)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyHeaderApiKey)

data RandomTriviaAPI  

-- | /Optional Param/ "max-length" - The maximum length of the trivia in letters.
instance HasOptionalParam RandomTriviaAPI MaxLengthInt where
  applyOptionalParam req (MaxLengthInt xs) =
    req `addQuery` toQuery ("max-length", Just xs)
-- | @application/json@
instance Produces RandomTriviaAPI MimeJSON
