...
-- | /Optional Param/ "text" - The text to match in the news content. By default all query terms are expected, you can use an uppercase OR to search for any terms, e.g. tesla OR ford
...
topNews
  ...
  -> APILeagueRequest TopNews MimeNoContent TopNews200Response MimeJSON
