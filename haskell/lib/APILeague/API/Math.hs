...
convertUnitsAPI
  ...
  -> APILeagueRequest ConvertUnitsAPI MimeNoContent ConvertUnitsAPI200Response MimeJSON
convertUnitsAPI (SourceAmount sourceAmount) (SourceUnit sourceUnit) (TargetUnit targetUnit) =
...
instance HasOptionalParam ConvertUnitsAPI FoodName where
  applyOptionalParam req (FoodName xs) =
    req `addQuery` toQuery ("food-name", Just xs)
-- | @application/json@
instance Produces ConvertUnitsAPI MimeJSON
