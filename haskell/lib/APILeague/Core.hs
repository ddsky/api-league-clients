...
-- |
data APILeagueConfig = APILeagueConfig
...
-- | display the config
instance P.Show APILeagueConfig where
  show c =
    T.printf
...
-- | constructs a default APILeagueConfig
--
-- configHost:
--
...
-- @"api-league/0.1.0.0"@
--
newConfig :: IO APILeagueConfig
newConfig = do
    logCxt <- initLogContext
    return $ APILeagueConfig
        { configHost = "https://api.apileague.com"
        , configUserAgent = "api-league/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => APILeagueConfig -> auth -> APILeagueConfig
addAuthMethod config@APILeagueConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: APILeagueConfig -> IO APILeagueConfig
...
withStderrLogging :: APILeagueConfig -> IO APILeagueConfig
...
withNoLogging :: APILeagueConfig -> APILeagueConfig
...
data APILeagueRequest req contentType res accept = APILeagueRequest
  { rMethod  :: NH.Method   -- ^ Method of APILeagueRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of APILeagueRequest
  , rParams   :: Params -- ^ params of APILeagueRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (APILeagueRequest req contentType res accept) NH.Method
rMethodL f APILeagueRequest{..} = (\rMethod -> APILeagueRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (APILeagueRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f APILeagueRequest{..} = (\rUrlPath -> APILeagueRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (APILeagueRequest req contentType res accept) Params
rParamsL f APILeagueRequest{..} = (\rParams -> APILeagueRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (APILeagueRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f APILeagueRequest{..} = (\rAuthTypes -> APILeagueRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => APILeagueRequest req contentType res accept -> param -> APILeagueRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: APILeagueRequest req contentType res accept -> param -> APILeagueRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: APILeagueRequest req contentType res accept -> param -> APILeagueRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** APILeagueRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> APILeagueRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = APILeagueRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     APILeagueRequest req contentType res accept
  -> [NH.Header]
  -> APILeagueRequest req contentType res accept
...
removeHeader :: APILeagueRequest req contentType res accept -> [NH.HeaderName] -> APILeagueRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => APILeagueRequest req contentType res accept -> APILeagueRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => APILeagueRequest req contentType res accept -> APILeagueRequest req contentType res accept
...
addForm :: APILeagueRequest req contentType res accept -> WH.Form -> APILeagueRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: APILeagueRequest req contentType res accept -> NH.Part -> APILeagueRequest req contentType res accept
...
_setBodyBS :: APILeagueRequest req contentType res accept -> B.ByteString -> APILeagueRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: APILeagueRequest req contentType res accept -> BL.ByteString -> APILeagueRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => APILeagueRequest req contentType res accept -> P.Proxy authMethod -> APILeagueRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> APILeagueRequest req contentType res accept
    -> IO (APILeagueRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> APILeagueConfig
  -> IO (APILeagueRequest req contentType res accept)
_applyAuthMethods req config@(APILeagueConfig {configAuthMethods = as}) =
  foldlM go req as
  where
