...
-- | FindSimilarGamesAPI200Response
data FindSimilarGamesAPI200Response = FindSimilarGamesAPI200Response
  { findSimilarGamesAPI200ResponseResults :: !(Maybe [FindSimilarGamesAPI200ResponseResultsInner]) -- ^ "results"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON FindSimilarGamesAPI200Response
instance A.FromJSON FindSimilarGamesAPI200Response where
  parseJSON = A.withObject "FindSimilarGamesAPI200Response" $ \o ->
    FindSimilarGamesAPI200Response
      <$> (o .:? "results")

-- | ToJSON FindSimilarGamesAPI200Response
instance A.ToJSON FindSimilarGamesAPI200Response where
  toJSON FindSimilarGamesAPI200Response {..} =
   _omitNulls
      [ "results" .= findSimilarGamesAPI200ResponseResults
      ]


-- | Construct a value of type 'FindSimilarGamesAPI200Response' (by applying it's required fields, if any)
mkFindSimilarGamesAPI200Response
  :: FindSimilarGamesAPI200Response
mkFindSimilarGamesAPI200Response =
  FindSimilarGamesAPI200Response
  { findSimilarGamesAPI200ResponseResults = Nothing
  }

-- ** FindSimilarGamesAPI200ResponseResultsInner
-- | FindSimilarGamesAPI200ResponseResultsInner
data FindSimilarGamesAPI200ResponseResultsInner = FindSimilarGamesAPI200ResponseResultsInner
  { findSimilarGamesAPI200ResponseResultsInnerImage :: !(Maybe Text) -- ^ "image"
  , findSimilarGamesAPI200ResponseResultsInnerShortDescription :: !(Maybe Text) -- ^ "short_description"
  , findSimilarGamesAPI200ResponseResultsInnerMicroTrailer :: !(Maybe Text) -- ^ "micro_trailer"
  , findSimilarGamesAPI200ResponseResultsInnerYear :: !(Maybe Int) -- ^ "year"
  , findSimilarGamesAPI200ResponseResultsInnerName :: !(Maybe Text) -- ^ "name"
  , findSimilarGamesAPI200ResponseResultsInnerGenre :: !(Maybe Text) -- ^ "genre"
  , findSimilarGamesAPI200ResponseResultsInnerLink :: !(Maybe Text) -- ^ "link"
  , findSimilarGamesAPI200ResponseResultsInnerRating :: !(Maybe SearchGamesAPI200ResponseResultsInnerRating) -- ^ "rating"
  , findSimilarGamesAPI200ResponseResultsInnerId :: !(Maybe Int) -- ^ "id"
  , findSimilarGamesAPI200ResponseResultsInnerAdultOnly :: !(Maybe Bool) -- ^ "adult_only"
  , findSimilarGamesAPI200ResponseResultsInnerScreenshots :: !(Maybe [Text]) -- ^ "screenshots"
  , findSimilarGamesAPI200ResponseResultsInnerGameplay :: !(Maybe Text) -- ^ "gameplay"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON FindSimilarGamesAPI200ResponseResultsInner
instance A.FromJSON FindSimilarGamesAPI200ResponseResultsInner where
  parseJSON = A.withObject "FindSimilarGamesAPI200ResponseResultsInner" $ \o ->
    FindSimilarGamesAPI200ResponseResultsInner
      <$> (o .:? "image")
      <*> (o .:? "short_description")
      <*> (o .:? "micro_trailer")
...
-- | ToJSON FindSimilarGamesAPI200ResponseResultsInner
instance A.ToJSON FindSimilarGamesAPI200ResponseResultsInner where
  toJSON FindSimilarGamesAPI200ResponseResultsInner {..} =
   _omitNulls
      [ "image" .= findSimilarGamesAPI200ResponseResultsInnerImage
      , "short_description" .= findSimilarGamesAPI200ResponseResultsInnerShortDescription
      , "micro_trailer" .= findSimilarGamesAPI200ResponseResultsInnerMicroTrailer
      , "year" .= findSimilarGamesAPI200ResponseResultsInnerYear
      , "name" .= findSimilarGamesAPI200ResponseResultsInnerName
      , "genre" .= findSimilarGamesAPI200ResponseResultsInnerGenre
      , "link" .= findSimilarGamesAPI200ResponseResultsInnerLink
      , "rating" .= findSimilarGamesAPI200ResponseResultsInnerRating
      , "id" .= findSimilarGamesAPI200ResponseResultsInnerId
      , "adult_only" .= findSimilarGamesAPI200ResponseResultsInnerAdultOnly
      , "screenshots" .= findSimilarGamesAPI200ResponseResultsInnerScreenshots
      , "gameplay" .= findSimilarGamesAPI200ResponseResultsInnerGameplay
      ]


-- | Construct a value of type 'FindSimilarGamesAPI200ResponseResultsInner' (by applying it's required fields, if any)
mkFindSimilarGamesAPI200ResponseResultsInner
  :: FindSimilarGamesAPI200ResponseResultsInner
mkFindSimilarGamesAPI200ResponseResultsInner =
  FindSimilarGamesAPI200ResponseResultsInner
  { findSimilarGamesAPI200ResponseResultsInnerImage = Nothing
  , findSimilarGamesAPI200ResponseResultsInnerShortDescription = Nothing
  , findSimilarGamesAPI200ResponseResultsInnerMicroTrailer = Nothing
  , findSimilarGamesAPI200ResponseResultsInnerYear = Nothing
  , findSimilarGamesAPI200ResponseResultsInnerName = Nothing
  , findSimilarGamesAPI200ResponseResultsInnerGenre = Nothing
  , findSimilarGamesAPI200ResponseResultsInnerLink = Nothing
  , findSimilarGamesAPI200ResponseResultsInnerRating = Nothing
  , findSimilarGamesAPI200ResponseResultsInnerId = Nothing
  , findSimilarGamesAPI200ResponseResultsInnerAdultOnly = Nothing
  , findSimilarGamesAPI200ResponseResultsInnerScreenshots = Nothing
  , findSimilarGamesAPI200ResponseResultsInnerGameplay = Nothing
  }
...
-- | RetrieveGameById200Response
data RetrieveGameById200Response = RetrieveGameById200Response
  { retrieveGameById200ResponseId :: !(Maybe Int) -- ^ "id"
  , retrieveGameById200ResponseName :: !(Maybe Text) -- ^ "name"
  , retrieveGameById200ResponseImage :: !(Maybe Text) -- ^ "image"
  , retrieveGameById200ResponseGameplay :: !(Maybe Text) -- ^ "gameplay"
  , retrieveGameById200ResponseLink :: !(Maybe Text) -- ^ "link"
  , retrieveGameById200ResponseXUrl :: !(Maybe Text) -- ^ "x_url"
  , retrieveGameById200ResponseRating :: !(Maybe RetrieveGameById200ResponseRating) -- ^ "rating"
  , retrieveGameById200ResponseDescription :: !(Maybe Text) -- ^ "description"
  , retrieveGameById200ResponseShortDescription :: !(Maybe Text) -- ^ "short_description"
  , retrieveGameById200ResponseReleaseDate :: !(Maybe Text) -- ^ "release_date"
  , retrieveGameById200ResponseDeveloper :: !(Maybe Text) -- ^ "developer"
  , retrieveGameById200ResponsePlaytime :: !(Maybe RetrieveGameById200ResponsePlaytime) -- ^ "playtime"
  , retrieveGameById200ResponsePlatforms :: !(Maybe [SearchGamesAPI200ResponseResultsInnerPlatformsInner]) -- ^ "platforms"
  , retrieveGameById200ResponseTags :: !(Maybe [Text]) -- ^ "tags"
  , retrieveGameById200ResponseGenres :: !(Maybe [SearchGamesAPI200ResponseResultsInnerPlatformsInner]) -- ^ "genres"
  , retrieveGameById200ResponseGenre :: !(Maybe Text) -- ^ "genre"
  , retrieveGameById200ResponseThemes :: !(Maybe [SearchGamesAPI200ResponseResultsInnerPlatformsInner]) -- ^ "themes"
  , retrieveGameById200ResponseAdultOnly :: !(Maybe Bool) -- ^ "adult_only"
  , retrieveGameById200ResponsePlayModes :: !(Maybe [SearchGamesAPI200ResponseResultsInnerPlatformsInner]) -- ^ "play_modes"
  , retrieveGameById200ResponseScreenshots :: !(Maybe [Text]) -- ^ "screenshots"
  , retrieveGameById200ResponseVideos :: !(Maybe [Text]) -- ^ "videos"
  , retrieveGameById200ResponseOffers :: !(Maybe [RetrieveGameById200ResponseOffersInner]) -- ^ "offers"
  , retrieveGameById200ResponseOfficialStores :: !(Maybe [RetrieveGameById200ResponseOfficialStoresInner]) -- ^ "official_stores"
  , retrieveGameById200ResponseMicroTrailer :: !(Maybe Text) -- ^ "micro_trailer"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON RetrieveGameById200Response
instance A.FromJSON RetrieveGameById200Response where
  parseJSON = A.withObject "RetrieveGameById200Response" $ \o ->
    RetrieveGameById200Response
      <$> (o .:? "id")
      <*> (o .:? "name")
      <*> (o .:? "image")
...
-- | ToJSON RetrieveGameById200Response
instance A.ToJSON RetrieveGameById200Response where
  toJSON RetrieveGameById200Response {..} =
   _omitNulls
      [ "id" .= retrieveGameById200ResponseId
      , "name" .= retrieveGameById200ResponseName
      , "image" .= retrieveGameById200ResponseImage
      , "gameplay" .= retrieveGameById200ResponseGameplay
      , "link" .= retrieveGameById200ResponseLink
      , "x_url" .= retrieveGameById200ResponseXUrl
      , "rating" .= retrieveGameById200ResponseRating
      , "description" .= retrieveGameById200ResponseDescription
      , "short_description" .= retrieveGameById200ResponseShortDescription
      , "release_date" .= retrieveGameById200ResponseReleaseDate
      , "developer" .= retrieveGameById200ResponseDeveloper
      , "playtime" .= retrieveGameById200ResponsePlaytime
      , "platforms" .= retrieveGameById200ResponsePlatforms
      , "tags" .= retrieveGameById200ResponseTags
      , "genres" .= retrieveGameById200ResponseGenres
      , "genre" .= retrieveGameById200ResponseGenre
      , "themes" .= retrieveGameById200ResponseThemes
      , "adult_only" .= retrieveGameById200ResponseAdultOnly
      , "play_modes" .= retrieveGameById200ResponsePlayModes
      , "screenshots" .= retrieveGameById200ResponseScreenshots
      , "videos" .= retrieveGameById200ResponseVideos
      , "offers" .= retrieveGameById200ResponseOffers
      , "official_stores" .= retrieveGameById200ResponseOfficialStores
      , "micro_trailer" .= retrieveGameById200ResponseMicroTrailer
      ]


-- | Construct a value of type 'RetrieveGameById200Response' (by applying it's required fields, if any)
mkRetrieveGameById200Response
  :: RetrieveGameById200Response
mkRetrieveGameById200Response =
  RetrieveGameById200Response
  { retrieveGameById200ResponseId = Nothing
  , retrieveGameById200ResponseName = Nothing
  , retrieveGameById200ResponseImage = Nothing
  , retrieveGameById200ResponseGameplay = Nothing
  , retrieveGameById200ResponseLink = Nothing
  , retrieveGameById200ResponseXUrl = Nothing
  , retrieveGameById200ResponseRating = Nothing
  , retrieveGameById200ResponseDescription = Nothing
  , retrieveGameById200ResponseShortDescription = Nothing
  , retrieveGameById200ResponseReleaseDate = Nothing
  , retrieveGameById200ResponseDeveloper = Nothing
  , retrieveGameById200ResponsePlaytime = Nothing
  , retrieveGameById200ResponsePlatforms = Nothing
  , retrieveGameById200ResponseTags = Nothing
  , retrieveGameById200ResponseGenres = Nothing
  , retrieveGameById200ResponseGenre = Nothing
  , retrieveGameById200ResponseThemes = Nothing
  , retrieveGameById200ResponseAdultOnly = Nothing
  , retrieveGameById200ResponsePlayModes = Nothing
  , retrieveGameById200ResponseScreenshots = Nothing
  , retrieveGameById200ResponseVideos = Nothing
  , retrieveGameById200ResponseOffers = Nothing
  , retrieveGameById200ResponseOfficialStores = Nothing
  , retrieveGameById200ResponseMicroTrailer = Nothing
  }

-- ** RetrieveGameById200ResponseOffersInner
-- | RetrieveGameById200ResponseOffersInner
data RetrieveGameById200ResponseOffersInner = RetrieveGameById200ResponseOffersInner
  { retrieveGameById200ResponseOffersInnerStoreName :: !(Maybe Text) -- ^ "store_name"
  , retrieveGameById200ResponseOffersInnerTitle :: !(Maybe Text) -- ^ "title"
  , retrieveGameById200ResponseOffersInnerPrice :: !(Maybe RetrieveGameById200ResponseOffersInnerPrice) -- ^ "price"
  , retrieveGameById200ResponseOffersInnerPlatform :: !(Maybe Text) -- ^ "platform"
  , retrieveGameById200ResponseOffersInnerUrl :: !(Maybe Text) -- ^ "url"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON RetrieveGameById200ResponseOffersInner
instance A.FromJSON RetrieveGameById200ResponseOffersInner where
  parseJSON = A.withObject "RetrieveGameById200ResponseOffersInner" $ \o ->
    RetrieveGameById200ResponseOffersInner
      <$> (o .:? "store_name")
      <*> (o .:? "title")
      <*> (o .:? "price")
...
-- | ToJSON RetrieveGameById200ResponseOffersInner
instance A.ToJSON RetrieveGameById200ResponseOffersInner where
  toJSON RetrieveGameById200ResponseOffersInner {..} =
   _omitNulls
      [ "store_name" .= retrieveGameById200ResponseOffersInnerStoreName
      , "title" .= retrieveGameById200ResponseOffersInnerTitle
      , "price" .= retrieveGameById200ResponseOffersInnerPrice
      , "platform" .= retrieveGameById200ResponseOffersInnerPlatform
      , "url" .= retrieveGameById200ResponseOffersInnerUrl
      ]


-- | Construct a value of type 'RetrieveGameById200ResponseOffersInner' (by applying it's required fields, if any)
mkRetrieveGameById200ResponseOffersInner
  :: RetrieveGameById200ResponseOffersInner
mkRetrieveGameById200ResponseOffersInner =
  RetrieveGameById200ResponseOffersInner
  { retrieveGameById200ResponseOffersInnerStoreName = Nothing
  , retrieveGameById200ResponseOffersInnerTitle = Nothing
  , retrieveGameById200ResponseOffersInnerPrice = Nothing
  , retrieveGameById200ResponseOffersInnerPlatform = Nothing
  , retrieveGameById200ResponseOffersInnerUrl = Nothing
  }

-- ** RetrieveGameById200ResponseOffersInnerPrice
-- | RetrieveGameById200ResponseOffersInnerPrice
data RetrieveGameById200ResponseOffersInnerPrice = RetrieveGameById200ResponseOffersInnerPrice
  { retrieveGameById200ResponseOffersInnerPriceCurrency :: !(Maybe Text) -- ^ "currency"
  , retrieveGameById200ResponseOffersInnerPriceDiscountPercent :: !(Maybe Int) -- ^ "discount_percent"
  , retrieveGameById200ResponseOffersInnerPriceValue :: !(Maybe Double) -- ^ "value"
  , retrieveGameById200ResponseOffersInnerPriceInitial :: !(Maybe Double) -- ^ "initial"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON RetrieveGameById200ResponseOffersInnerPrice
instance A.FromJSON RetrieveGameById200ResponseOffersInnerPrice where
  parseJSON = A.withObject "RetrieveGameById200ResponseOffersInnerPrice" $ \o ->
    RetrieveGameById200ResponseOffersInnerPrice
      <$> (o .:? "currency")
      <*> (o .:? "discount_percent")
      <*> (o .:? "value")
...
-- | ToJSON RetrieveGameById200ResponseOffersInnerPrice
instance A.ToJSON RetrieveGameById200ResponseOffersInnerPrice where
  toJSON RetrieveGameById200ResponseOffersInnerPrice {..} =
   _omitNulls
      [ "currency" .= retrieveGameById200ResponseOffersInnerPriceCurrency
      , "discount_percent" .= retrieveGameById200ResponseOffersInnerPriceDiscountPercent
      , "value" .= retrieveGameById200ResponseOffersInnerPriceValue
      , "initial" .= retrieveGameById200ResponseOffersInnerPriceInitial
      ]


-- | Construct a value of type 'RetrieveGameById200ResponseOffersInnerPrice' (by applying it's required fields, if any)
mkRetrieveGameById200ResponseOffersInnerPrice
  :: RetrieveGameById200ResponseOffersInnerPrice
mkRetrieveGameById200ResponseOffersInnerPrice =
  RetrieveGameById200ResponseOffersInnerPrice
  { retrieveGameById200ResponseOffersInnerPriceCurrency = Nothing
  , retrieveGameById200ResponseOffersInnerPriceDiscountPercent = Nothing
  , retrieveGameById200ResponseOffersInnerPriceValue = Nothing
  , retrieveGameById200ResponseOffersInnerPriceInitial = Nothing
  }

-- ** RetrieveGameById200ResponseOfficialStoresInner
-- | RetrieveGameById200ResponseOfficialStoresInner
data RetrieveGameById200ResponseOfficialStoresInner = RetrieveGameById200ResponseOfficialStoresInner
  { retrieveGameById200ResponseOfficialStoresInnerUrl :: !(Maybe Text) -- ^ "url"
  , retrieveGameById200ResponseOfficialStoresInnerSource :: !(Maybe Text) -- ^ "source"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON RetrieveGameById200ResponseOfficialStoresInner
instance A.FromJSON RetrieveGameById200ResponseOfficialStoresInner where
  parseJSON = A.withObject "RetrieveGameById200ResponseOfficialStoresInner" $ \o ->
    RetrieveGameById200ResponseOfficialStoresInner
      <$> (o .:? "url")
      <*> (o .:? "source")

-- | ToJSON RetrieveGameById200ResponseOfficialStoresInner
instance A.ToJSON RetrieveGameById200ResponseOfficialStoresInner where
  toJSON RetrieveGameById200ResponseOfficialStoresInner {..} =
   _omitNulls
      [ "url" .= retrieveGameById200ResponseOfficialStoresInnerUrl
      , "source" .= retrieveGameById200ResponseOfficialStoresInnerSource
      ]


-- | Construct a value of type 'RetrieveGameById200ResponseOfficialStoresInner' (by applying it's required fields, if any)
mkRetrieveGameById200ResponseOfficialStoresInner
  :: RetrieveGameById200ResponseOfficialStoresInner
mkRetrieveGameById200ResponseOfficialStoresInner =
  RetrieveGameById200ResponseOfficialStoresInner
  { retrieveGameById200ResponseOfficialStoresInnerUrl = Nothing
  , retrieveGameById200ResponseOfficialStoresInnerSource = Nothing
  }

-- ** RetrieveGameById200ResponsePlaytime
-- | RetrieveGameById200ResponsePlaytime
data RetrieveGameById200ResponsePlaytime = RetrieveGameById200ResponsePlaytime
  { retrieveGameById200ResponsePlaytimePercentiles :: !(Maybe [Int]) -- ^ "percentiles"
  , retrieveGameById200ResponsePlaytimeMin :: !(Maybe Int) -- ^ "min"
  , retrieveGameById200ResponsePlaytimeMedian :: !(Maybe Int) -- ^ "median"
  , retrieveGameById200ResponsePlaytimeMax :: !(Maybe Int) -- ^ "max"
  , retrieveGameById200ResponsePlaytimeMean :: !(Maybe Double) -- ^ "mean"
  , retrieveGameById200ResponsePlaytimeMentions :: !(Maybe Int) -- ^ "mentions"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON RetrieveGameById200ResponsePlaytime
instance A.FromJSON RetrieveGameById200ResponsePlaytime where
  parseJSON = A.withObject "RetrieveGameById200ResponsePlaytime" $ \o ->
    RetrieveGameById200ResponsePlaytime
      <$> (o .:? "percentiles")
      <*> (o .:? "min")
      <*> (o .:? "median")
...
-- | ToJSON RetrieveGameById200ResponsePlaytime
instance A.ToJSON RetrieveGameById200ResponsePlaytime where
  toJSON RetrieveGameById200ResponsePlaytime {..} =
   _omitNulls
      [ "percentiles" .= retrieveGameById200ResponsePlaytimePercentiles
      , "min" .= retrieveGameById200ResponsePlaytimeMin
      , "median" .= retrieveGameById200ResponsePlaytimeMedian
      , "max" .= retrieveGameById200ResponsePlaytimeMax
      , "mean" .= retrieveGameById200ResponsePlaytimeMean
      , "mentions" .= retrieveGameById200ResponsePlaytimeMentions
      ]


-- | Construct a value of type 'RetrieveGameById200ResponsePlaytime' (by applying it's required fields, if any)
mkRetrieveGameById200ResponsePlaytime
  :: RetrieveGameById200ResponsePlaytime
mkRetrieveGameById200ResponsePlaytime =
  RetrieveGameById200ResponsePlaytime
  { retrieveGameById200ResponsePlaytimePercentiles = Nothing
  , retrieveGameById200ResponsePlaytimeMin = Nothing
  , retrieveGameById200ResponsePlaytimeMedian = Nothing
  , retrieveGameById200ResponsePlaytimeMax = Nothing
  , retrieveGameById200ResponsePlaytimeMean = Nothing
  , retrieveGameById200ResponsePlaytimeMentions = Nothing
  }

-- ** RetrieveGameById200ResponseRating
-- | RetrieveGameById200ResponseRating
data RetrieveGameById200ResponseRating = RetrieveGameById200ResponseRating
  { retrieveGameById200ResponseRatingCount :: !(Maybe Int) -- ^ "count"
  , retrieveGameById200ResponseRatingCountCritics :: !(Maybe Int) -- ^ "count_critics"
  , retrieveGameById200ResponseRatingMeanPlayers :: !(Maybe Double) -- ^ "mean_players"
  , retrieveGameById200ResponseRatingMeanCritics :: !(Maybe Double) -- ^ "mean_critics"
  , retrieveGameById200ResponseRatingMean :: !(Maybe Double) -- ^ "mean"
  , retrieveGameById200ResponseRatingCountPlayers :: !(Maybe Int) -- ^ "count_players"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON RetrieveGameById200ResponseRating
instance A.FromJSON RetrieveGameById200ResponseRating where
  parseJSON = A.withObject "RetrieveGameById200ResponseRating" $ \o ->
    RetrieveGameById200ResponseRating
      <$> (o .:? "count")
      <*> (o .:? "count_critics")
      <*> (o .:? "mean_players")
...
-- | ToJSON RetrieveGameById200ResponseRating
instance A.ToJSON RetrieveGameById200ResponseRating where
  toJSON RetrieveGameById200ResponseRating {..} =
   _omitNulls
      [ "count" .= retrieveGameById200ResponseRatingCount
      , "count_critics" .= retrieveGameById200ResponseRatingCountCritics
      , "mean_players" .= retrieveGameById200ResponseRatingMeanPlayers
      , "mean_critics" .= retrieveGameById200ResponseRatingMeanCritics
      , "mean" .= retrieveGameById200ResponseRatingMean
      , "count_players" .= retrieveGameById200ResponseRatingCountPlayers
      ]


-- | Construct a value of type 'RetrieveGameById200ResponseRating' (by applying it's required fields, if any)
mkRetrieveGameById200ResponseRating
  :: RetrieveGameById200ResponseRating
mkRetrieveGameById200ResponseRating =
  RetrieveGameById200ResponseRating
  { retrieveGameById200ResponseRatingCount = Nothing
  , retrieveGameById200ResponseRatingCountCritics = Nothing
  , retrieveGameById200ResponseRatingMeanPlayers = Nothing
  , retrieveGameById200ResponseRatingMeanCritics = Nothing
  , retrieveGameById200ResponseRatingMean = Nothing
  , retrieveGameById200ResponseRatingCountPlayers = Nothing
  }
...
-- | SearchGamesAPI200Response
data SearchGamesAPI200Response = SearchGamesAPI200Response
  { searchGamesAPI200ResponseSorting :: !(Maybe A.Value) -- ^ "sorting"
  , searchGamesAPI200ResponseActiveFilterOptions :: !(Maybe [SearchGamesAPI200ResponseActiveFilterOptionsInner]) -- ^ "active_filter_options"
  , searchGamesAPI200ResponseQuery :: !(Maybe Text) -- ^ "query"
  , searchGamesAPI200ResponseTotalResults :: !(Maybe Int) -- ^ "total_results"
  , searchGamesAPI200ResponseLimit :: !(Maybe Int) -- ^ "limit"
  , searchGamesAPI200ResponseOffset :: !(Maybe Int) -- ^ "offset"
  , searchGamesAPI200ResponseResults :: !(Maybe [SearchGamesAPI200ResponseResultsInner]) -- ^ "results"
  , searchGamesAPI200ResponseFilterOptions :: !(Maybe [SearchGamesAPI200ResponseFilterOptionsInner]) -- ^ "filter_options"
  , searchGamesAPI200ResponseSortingOptions :: !(Maybe [SearchGamesAPI200ResponseSortingOptionsInner]) -- ^ "sorting_options"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON SearchGamesAPI200Response
instance A.FromJSON SearchGamesAPI200Response where
  parseJSON = A.withObject "SearchGamesAPI200Response" $ \o ->
    SearchGamesAPI200Response
      <$> (o .:? "sorting")
...
-- | ToJSON SearchGamesAPI200Response
instance A.ToJSON SearchGamesAPI200Response where
  toJSON SearchGamesAPI200Response {..} =
   _omitNulls
      [ "sorting" .= searchGamesAPI200ResponseSorting
      , "active_filter_options" .= searchGamesAPI200ResponseActiveFilterOptions
      , "query" .= searchGamesAPI200ResponseQuery
      , "total_results" .= searchGamesAPI200ResponseTotalResults
      , "limit" .= searchGamesAPI200ResponseLimit
      , "offset" .= searchGamesAPI200ResponseOffset
      , "results" .= searchGamesAPI200ResponseResults
      , "filter_options" .= searchGamesAPI200ResponseFilterOptions
      , "sorting_options" .= searchGamesAPI200ResponseSortingOptions
      ]


-- | Construct a value of type 'SearchGamesAPI200Response' (by applying it's required fields, if any)
mkSearchGamesAPI200Response
  :: SearchGamesAPI200Response
mkSearchGamesAPI200Response =
  SearchGamesAPI200Response
  { searchGamesAPI200ResponseSorting = Nothing
  , searchGamesAPI200ResponseActiveFilterOptions = Nothing
  , searchGamesAPI200ResponseQuery = Nothing
  , searchGamesAPI200ResponseTotalResults = Nothing
  , searchGamesAPI200ResponseLimit = Nothing
  , searchGamesAPI200ResponseOffset = Nothing
  , searchGamesAPI200ResponseResults = Nothing
  , searchGamesAPI200ResponseFilterOptions = Nothing
  , searchGamesAPI200ResponseSortingOptions = Nothing
  }

-- ** SearchGamesAPI200ResponseActiveFilterOptionsInner
-- | SearchGamesAPI200ResponseActiveFilterOptionsInner
data SearchGamesAPI200ResponseActiveFilterOptionsInner = SearchGamesAPI200ResponseActiveFilterOptionsInner
  { searchGamesAPI200ResponseActiveFilterOptionsInnerKey :: !(Maybe Text) -- ^ "key"
  , searchGamesAPI200ResponseActiveFilterOptionsInnerConnection :: !(Maybe Text) -- ^ "connection"
  , searchGamesAPI200ResponseActiveFilterOptionsInnerValues :: !(Maybe [SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner]) -- ^ "values"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON SearchGamesAPI200ResponseActiveFilterOptionsInner
instance A.FromJSON SearchGamesAPI200ResponseActiveFilterOptionsInner where
  parseJSON = A.withObject "SearchGamesAPI200ResponseActiveFilterOptionsInner" $ \o ->
    SearchGamesAPI200ResponseActiveFilterOptionsInner
      <$> (o .:? "key")
      <*> (o .:? "connection")
      <*> (o .:? "values")

-- | ToJSON SearchGamesAPI200ResponseActiveFilterOptionsInner
instance A.ToJSON SearchGamesAPI200ResponseActiveFilterOptionsInner where
  toJSON SearchGamesAPI200ResponseActiveFilterOptionsInner {..} =
   _omitNulls
      [ "key" .= searchGamesAPI200ResponseActiveFilterOptionsInnerKey
      , "connection" .= searchGamesAPI200ResponseActiveFilterOptionsInnerConnection
      , "values" .= searchGamesAPI200ResponseActiveFilterOptionsInnerValues
      ]


-- | Construct a value of type 'SearchGamesAPI200ResponseActiveFilterOptionsInner' (by applying it's required fields, if any)
mkSearchGamesAPI200ResponseActiveFilterOptionsInner
  :: SearchGamesAPI200ResponseActiveFilterOptionsInner
mkSearchGamesAPI200ResponseActiveFilterOptionsInner =
  SearchGamesAPI200ResponseActiveFilterOptionsInner
  { searchGamesAPI200ResponseActiveFilterOptionsInnerKey = Nothing
  , searchGamesAPI200ResponseActiveFilterOptionsInnerConnection = Nothing
  , searchGamesAPI200ResponseActiveFilterOptionsInnerValues = Nothing
  }

-- ** SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner
-- | SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner
data SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner = SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner
  { searchGamesAPI200ResponseActiveFilterOptionsInnerValuesInnerMatch :: !(Maybe Text) -- ^ "match"
  , searchGamesAPI200ResponseActiveFilterOptionsInnerValuesInnerValue :: !(Maybe Text) -- ^ "value"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner
instance A.FromJSON SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner where
  parseJSON = A.withObject "SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner" $ \o ->
    SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner
      <$> (o .:? "match")
      <*> (o .:? "value")

-- | ToJSON SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner
instance A.ToJSON SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner where
  toJSON SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner {..} =
   _omitNulls
      [ "match" .= searchGamesAPI200ResponseActiveFilterOptionsInnerValuesInnerMatch
      , "value" .= searchGamesAPI200ResponseActiveFilterOptionsInnerValuesInnerValue
      ]


-- | Construct a value of type 'SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner' (by applying it's required fields, if any)
mkSearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner
  :: SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner
mkSearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner =
  SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner
  { searchGamesAPI200ResponseActiveFilterOptionsInnerValuesInnerMatch = Nothing
  , searchGamesAPI200ResponseActiveFilterOptionsInnerValuesInnerValue = Nothing
  }

-- ** SearchGamesAPI200ResponseFilterOptionsInner
-- | SearchGamesAPI200ResponseFilterOptionsInner
data SearchGamesAPI200ResponseFilterOptionsInner = SearchGamesAPI200ResponseFilterOptionsInner
  { searchGamesAPI200ResponseFilterOptionsInnerName :: !(Maybe Text) -- ^ "name"
  , searchGamesAPI200ResponseFilterOptionsInnerFilterType :: !(Maybe Text) -- ^ "filter_type"
  , searchGamesAPI200ResponseFilterOptionsInnerKey :: !(Maybe Text) -- ^ "key"
  , searchGamesAPI200ResponseFilterOptionsInnerValues :: !(Maybe [SearchGamesAPI200ResponseFilterOptionsInnerValuesInner]) -- ^ "values"
  , searchGamesAPI200ResponseFilterOptionsInnerFilterConnection :: !(Maybe Text) -- ^ "filter_connection"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON SearchGamesAPI200ResponseFilterOptionsInner
instance A.FromJSON SearchGamesAPI200ResponseFilterOptionsInner where
  parseJSON = A.withObject "SearchGamesAPI200ResponseFilterOptionsInner" $ \o ->
    SearchGamesAPI200ResponseFilterOptionsInner
      <$> (o .:? "name")
      <*> (o .:? "filter_type")
      <*> (o .:? "key")
...
-- | ToJSON SearchGamesAPI200ResponseFilterOptionsInner
instance A.ToJSON SearchGamesAPI200ResponseFilterOptionsInner where
  toJSON SearchGamesAPI200ResponseFilterOptionsInner {..} =
   _omitNulls
      [ "name" .= searchGamesAPI200ResponseFilterOptionsInnerName
      , "filter_type" .= searchGamesAPI200ResponseFilterOptionsInnerFilterType
      , "key" .= searchGamesAPI200ResponseFilterOptionsInnerKey
      , "values" .= searchGamesAPI200ResponseFilterOptionsInnerValues
      , "filter_connection" .= searchGamesAPI200ResponseFilterOptionsInnerFilterConnection
      ]


-- | Construct a value of type 'SearchGamesAPI200ResponseFilterOptionsInner' (by applying it's required fields, if any)
mkSearchGamesAPI200ResponseFilterOptionsInner
  :: SearchGamesAPI200ResponseFilterOptionsInner
mkSearchGamesAPI200ResponseFilterOptionsInner =
  SearchGamesAPI200ResponseFilterOptionsInner
  { searchGamesAPI200ResponseFilterOptionsInnerName = Nothing
  , searchGamesAPI200ResponseFilterOptionsInnerFilterType = Nothing
  , searchGamesAPI200ResponseFilterOptionsInnerKey = Nothing
  , searchGamesAPI200ResponseFilterOptionsInnerValues = Nothing
  , searchGamesAPI200ResponseFilterOptionsInnerFilterConnection = Nothing
  }

-- ** SearchGamesAPI200ResponseFilterOptionsInnerValuesInner
-- | SearchGamesAPI200ResponseFilterOptionsInnerValuesInner
data SearchGamesAPI200ResponseFilterOptionsInnerValuesInner = SearchGamesAPI200ResponseFilterOptionsInnerValuesInner
  { searchGamesAPI200ResponseFilterOptionsInnerValuesInnerName :: !(Maybe Text) -- ^ "name"
  , searchGamesAPI200ResponseFilterOptionsInnerValuesInnerCount :: !(Maybe Int) -- ^ "count"
  , searchGamesAPI200ResponseFilterOptionsInnerValuesInnerKey :: !(Maybe Text) -- ^ "key"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON SearchGamesAPI200ResponseFilterOptionsInnerValuesInner
instance A.FromJSON SearchGamesAPI200ResponseFilterOptionsInnerValuesInner where
  parseJSON = A.withObject "SearchGamesAPI200ResponseFilterOptionsInnerValuesInner" $ \o ->
    SearchGamesAPI200ResponseFilterOptionsInnerValuesInner
      <$> (o .:? "name")
      <*> (o .:? "count")
      <*> (o .:? "key")

-- | ToJSON SearchGamesAPI200ResponseFilterOptionsInnerValuesInner
instance A.ToJSON SearchGamesAPI200ResponseFilterOptionsInnerValuesInner where
  toJSON SearchGamesAPI200ResponseFilterOptionsInnerValuesInner {..} =
   _omitNulls
      [ "name" .= searchGamesAPI200ResponseFilterOptionsInnerValuesInnerName
      , "count" .= searchGamesAPI200ResponseFilterOptionsInnerValuesInnerCount
      , "key" .= searchGamesAPI200ResponseFilterOptionsInnerValuesInnerKey
      ]


-- | Construct a value of type 'SearchGamesAPI200ResponseFilterOptionsInnerValuesInner' (by applying it's required fields, if any)
mkSearchGamesAPI200ResponseFilterOptionsInnerValuesInner
  :: SearchGamesAPI200ResponseFilterOptionsInnerValuesInner
mkSearchGamesAPI200ResponseFilterOptionsInnerValuesInner =
  SearchGamesAPI200ResponseFilterOptionsInnerValuesInner
  { searchGamesAPI200ResponseFilterOptionsInnerValuesInnerName = Nothing
  , searchGamesAPI200ResponseFilterOptionsInnerValuesInnerCount = Nothing
  , searchGamesAPI200ResponseFilterOptionsInnerValuesInnerKey = Nothing
  }

-- ** SearchGamesAPI200ResponseResultsInner
-- | SearchGamesAPI200ResponseResultsInner
data SearchGamesAPI200ResponseResultsInner = SearchGamesAPI200ResponseResultsInner
  { searchGamesAPI200ResponseResultsInnerImage :: !(Maybe Text) -- ^ "image"
  , searchGamesAPI200ResponseResultsInnerShortDescription :: !(Maybe Text) -- ^ "short_description"
  , searchGamesAPI200ResponseResultsInnerYear :: !(Maybe Int) -- ^ "year"
  , searchGamesAPI200ResponseResultsInnerLink :: !(Maybe Text) -- ^ "link"
  , searchGamesAPI200ResponseResultsInnerRating :: !(Maybe SearchGamesAPI200ResponseResultsInnerRating) -- ^ "rating"
  , searchGamesAPI200ResponseResultsInnerAdultOnly :: !(Maybe Bool) -- ^ "adult_only"
  , searchGamesAPI200ResponseResultsInnerScreenshots :: !(Maybe [Text]) -- ^ "screenshots"
  , searchGamesAPI200ResponseResultsInnerPlatforms :: !(Maybe [SearchGamesAPI200ResponseResultsInnerPlatformsInner]) -- ^ "platforms"
  , searchGamesAPI200ResponseResultsInnerMicroTrailer :: !(Maybe Text) -- ^ "micro_trailer"
  , searchGamesAPI200ResponseResultsInnerName :: !(Maybe Text) -- ^ "name"
  , searchGamesAPI200ResponseResultsInnerGenre :: !(Maybe Text) -- ^ "genre"
  , searchGamesAPI200ResponseResultsInnerId :: !(Maybe Int) -- ^ "id"
  , searchGamesAPI200ResponseResultsInnerGameplay :: !(Maybe Text) -- ^ "gameplay"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON SearchGamesAPI200ResponseResultsInner
instance A.FromJSON SearchGamesAPI200ResponseResultsInner where
  parseJSON = A.withObject "SearchGamesAPI200ResponseResultsInner" $ \o ->
    SearchGamesAPI200ResponseResultsInner
      <$> (o .:? "image")
      <*> (o .:? "short_description")
      <*> (o .:? "year")
...
-- | ToJSON SearchGamesAPI200ResponseResultsInner
instance A.ToJSON SearchGamesAPI200ResponseResultsInner where
  toJSON SearchGamesAPI200ResponseResultsInner {..} =
   _omitNulls
      [ "image" .= searchGamesAPI200ResponseResultsInnerImage
      , "short_description" .= searchGamesAPI200ResponseResultsInnerShortDescription
      , "year" .= searchGamesAPI200ResponseResultsInnerYear
      , "link" .= searchGamesAPI200ResponseResultsInnerLink
      , "rating" .= searchGamesAPI200ResponseResultsInnerRating
      , "adult_only" .= searchGamesAPI200ResponseResultsInnerAdultOnly
      , "screenshots" .= searchGamesAPI200ResponseResultsInnerScreenshots
      , "platforms" .= searchGamesAPI200ResponseResultsInnerPlatforms
      , "micro_trailer" .= searchGamesAPI200ResponseResultsInnerMicroTrailer
      , "name" .= searchGamesAPI200ResponseResultsInnerName
      , "genre" .= searchGamesAPI200ResponseResultsInnerGenre
      , "id" .= searchGamesAPI200ResponseResultsInnerId
      , "gameplay" .= searchGamesAPI200ResponseResultsInnerGameplay
      ]


-- | Construct a value of type 'SearchGamesAPI200ResponseResultsInner' (by applying it's required fields, if any)
mkSearchGamesAPI200ResponseResultsInner
  :: SearchGamesAPI200ResponseResultsInner
mkSearchGamesAPI200ResponseResultsInner =
  SearchGamesAPI200ResponseResultsInner
  { searchGamesAPI200ResponseResultsInnerImage = Nothing
  , searchGamesAPI200ResponseResultsInnerShortDescription = Nothing
  , searchGamesAPI200ResponseResultsInnerYear = Nothing
  , searchGamesAPI200ResponseResultsInnerLink = Nothing
  , searchGamesAPI200ResponseResultsInnerRating = Nothing
  , searchGamesAPI200ResponseResultsInnerAdultOnly = Nothing
  , searchGamesAPI200ResponseResultsInnerScreenshots = Nothing
  , searchGamesAPI200ResponseResultsInnerPlatforms = Nothing
  , searchGamesAPI200ResponseResultsInnerMicroTrailer = Nothing
  , searchGamesAPI200ResponseResultsInnerName = Nothing
  , searchGamesAPI200ResponseResultsInnerGenre = Nothing
  , searchGamesAPI200ResponseResultsInnerId = Nothing
  , searchGamesAPI200ResponseResultsInnerGameplay = Nothing
  }

-- ** SearchGamesAPI200ResponseResultsInnerPlatformsInner
-- | SearchGamesAPI200ResponseResultsInnerPlatformsInner
data SearchGamesAPI200ResponseResultsInnerPlatformsInner = SearchGamesAPI200ResponseResultsInnerPlatformsInner
  { searchGamesAPI200ResponseResultsInnerPlatformsInnerName :: !(Maybe Text) -- ^ "name"
  , searchGamesAPI200ResponseResultsInnerPlatformsInnerValue :: !(Maybe Text) -- ^ "value"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON SearchGamesAPI200ResponseResultsInnerPlatformsInner
instance A.FromJSON SearchGamesAPI200ResponseResultsInnerPlatformsInner where
  parseJSON = A.withObject "SearchGamesAPI200ResponseResultsInnerPlatformsInner" $ \o ->
    SearchGamesAPI200ResponseResultsInnerPlatformsInner
      <$> (o .:? "name")
      <*> (o .:? "value")

-- | ToJSON SearchGamesAPI200ResponseResultsInnerPlatformsInner
instance A.ToJSON SearchGamesAPI200ResponseResultsInnerPlatformsInner where
  toJSON SearchGamesAPI200ResponseResultsInnerPlatformsInner {..} =
   _omitNulls
      [ "name" .= searchGamesAPI200ResponseResultsInnerPlatformsInnerName
      , "value" .= searchGamesAPI200ResponseResultsInnerPlatformsInnerValue
      ]


-- | Construct a value of type 'SearchGamesAPI200ResponseResultsInnerPlatformsInner' (by applying it's required fields, if any)
mkSearchGamesAPI200ResponseResultsInnerPlatformsInner
  :: SearchGamesAPI200ResponseResultsInnerPlatformsInner
mkSearchGamesAPI200ResponseResultsInnerPlatformsInner =
  SearchGamesAPI200ResponseResultsInnerPlatformsInner
  { searchGamesAPI200ResponseResultsInnerPlatformsInnerName = Nothing
  , searchGamesAPI200ResponseResultsInnerPlatformsInnerValue = Nothing
  }

-- ** SearchGamesAPI200ResponseResultsInnerRating
-- | SearchGamesAPI200ResponseResultsInnerRating
data SearchGamesAPI200ResponseResultsInnerRating = SearchGamesAPI200ResponseResultsInnerRating
  { searchGamesAPI200ResponseResultsInnerRatingCount :: !(Maybe Int) -- ^ "count"
  , searchGamesAPI200ResponseResultsInnerRatingMean :: !(Maybe Double) -- ^ "mean"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON SearchGamesAPI200ResponseResultsInnerRating
instance A.FromJSON SearchGamesAPI200ResponseResultsInnerRating where
  parseJSON = A.withObject "SearchGamesAPI200ResponseResultsInnerRating" $ \o ->
    SearchGamesAPI200ResponseResultsInnerRating
      <$> (o .:? "count")
      <*> (o .:? "mean")

-- | ToJSON SearchGamesAPI200ResponseResultsInnerRating
instance A.ToJSON SearchGamesAPI200ResponseResultsInnerRating where
  toJSON SearchGamesAPI200ResponseResultsInnerRating {..} =
   _omitNulls
      [ "count" .= searchGamesAPI200ResponseResultsInnerRatingCount
      , "mean" .= searchGamesAPI200ResponseResultsInnerRatingMean
      ]


-- | Construct a value of type 'SearchGamesAPI200ResponseResultsInnerRating' (by applying it's required fields, if any)
mkSearchGamesAPI200ResponseResultsInnerRating
  :: SearchGamesAPI200ResponseResultsInnerRating
mkSearchGamesAPI200ResponseResultsInnerRating =
  SearchGamesAPI200ResponseResultsInnerRating
  { searchGamesAPI200ResponseResultsInnerRatingCount = Nothing
  , searchGamesAPI200ResponseResultsInnerRatingMean = Nothing
  }

-- ** SearchGamesAPI200ResponseSortingOptionsInner
-- | SearchGamesAPI200ResponseSortingOptionsInner
data SearchGamesAPI200ResponseSortingOptionsInner = SearchGamesAPI200ResponseSortingOptionsInner
  { searchGamesAPI200ResponseSortingOptionsInnerName :: !(Maybe Text) -- ^ "name"
  , searchGamesAPI200ResponseSortingOptionsInnerKey :: !(Maybe Text) -- ^ "key"
  , searchGamesAPI200ResponseSortingOptionsInnerSort :: !(Maybe Text) -- ^ "sort"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON SearchGamesAPI200ResponseSortingOptionsInner
instance A.FromJSON SearchGamesAPI200ResponseSortingOptionsInner where
  parseJSON = A.withObject "SearchGamesAPI200ResponseSortingOptionsInner" $ \o ->
    SearchGamesAPI200ResponseSortingOptionsInner
      <$> (o .:? "name")
      <*> (o .:? "key")
      <*> (o .:? "sort")

-- | ToJSON SearchGamesAPI200ResponseSortingOptionsInner
instance A.ToJSON SearchGamesAPI200ResponseSortingOptionsInner where
  toJSON SearchGamesAPI200ResponseSortingOptionsInner {..} =
   _omitNulls
      [ "name" .= searchGamesAPI200ResponseSortingOptionsInnerName
      , "key" .= searchGamesAPI200ResponseSortingOptionsInnerKey
      , "sort" .= searchGamesAPI200ResponseSortingOptionsInnerSort
      ]


-- | Construct a value of type 'SearchGamesAPI200ResponseSortingOptionsInner' (by applying it's required fields, if any)
mkSearchGamesAPI200ResponseSortingOptionsInner
  :: SearchGamesAPI200ResponseSortingOptionsInner
mkSearchGamesAPI200ResponseSortingOptionsInner =
  SearchGamesAPI200ResponseSortingOptionsInner
  { searchGamesAPI200ResponseSortingOptionsInnerName = Nothing
  , searchGamesAPI200ResponseSortingOptionsInnerKey = Nothing
  , searchGamesAPI200ResponseSortingOptionsInnerSort = Nothing
  }
