...
pub async fn find_similar_books(configuration: &configuration::Configuration, id: i32, number: Option<i32>) -> Result<crate::models::FindSimilarBooks200Response, Error<FindSimilarBooksError>> {
