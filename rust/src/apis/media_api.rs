...
pub async fn rescale_image(configuration: &configuration::Configuration, url: &str, width: i32, height: i32, crop: bool) -> Result<serde_json::Value, Error<RescaleImageError>> {
    let local_var_configuration = configuration;
