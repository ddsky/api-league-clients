...
/// struct for typed errors of method [`search_drinks`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SearchDrinksError {
    Status401(),
    Status402(),
    Status403(),
    Status404(),
...
pub async fn search_drinks(configuration: &configuration::Configuration, query: Option<&str>, glass_types: Option<&str>, flavors: Option<&str>, diet: Option<&str>, include_ingredients: Option<&str>, exclude_ingredients: Option<&str>, min_calories: Option<f64>, max_calories: Option<f64>, min_carbs: Option<f64>, max_carbs: Option<f64>, min_protein: Option<f64>, max_protein: Option<f64>, min_fat: Option<f64>, max_fat: Option<f64>, min_alcohol_percent: Option<f64>, max_alcohol_percent: Option<f64>, min_caffeine: Option<f64>, max_caffeine: Option<f64>, sort: Option<&str>, sort_direction: Option<&str>, offset: Option<i32>, number: Option<i32>) -> Result<models::SearchDrinks200Response, Error<SearchDrinksError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchDrinksError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
