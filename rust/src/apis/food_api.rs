...
/// struct for typed errors of method [`compute_nutrition_api`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputeNutritionApiError {
    Status401(),
    Status402(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`retrieve_recipe_information_api`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RetrieveRecipeInformationApiError {
    Status401(),
    Status402(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`search_drinks_api`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SearchDrinksApiError {
    Status401(),
    Status402(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`search_recipes_api`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SearchRecipesApiError {
    Status401(),
    Status402(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`search_restaurants_api`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SearchRestaurantsApiError {
    Status401(),
    Status402(),
    Status403(),
    Status404(),
...
pub async fn compute_nutrition_api(configuration: &configuration::Configuration, ingredients: &str, servings: Option<i32>, reduce_oils: Option<bool>) -> Result<models::ComputeNutritionApi200Response, Error<ComputeNutritionApiError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputeNutritionApiError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn retrieve_recipe_information_api(configuration: &configuration::Configuration, id: i32, add_wine_pairing: Option<bool>) -> Result<models::RetrieveRecipeInformationApi200Response, Error<RetrieveRecipeInformationApiError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RetrieveRecipeInformationApiError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn search_drinks_api(configuration: &configuration::Configuration, query: Option<&str>, glass_types: Option<&str>, flavors: Option<&str>, diet: Option<&str>, include_ingredients: Option<&str>, exclude_ingredients: Option<&str>, min_calories: Option<f64>, max_calories: Option<f64>, min_carbs: Option<f64>, max_carbs: Option<f64>, min_protein: Option<f64>, max_protein: Option<f64>, min_fat: Option<f64>, max_fat: Option<f64>, min_alcohol_percent: Option<f64>, max_alcohol_percent: Option<f64>, min_caffeine: Option<f64>, max_caffeine: Option<f64>, sort: Option<&str>, sort_direction: Option<&str>, offset: Option<i32>, number: Option<i32>) -> Result<models::SearchDrinksApi200Response, Error<SearchDrinksApiError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/search-drinks", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

    if let Some(ref local_var_str) = query {
        local_var_req_builder = local_var_req_builder.query(&[("query", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = glass_types {
        local_var_req_builder = local_var_req_builder.query(&[("glass-types", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = flavors {
        local_var_req_builder = local_var_req_builder.query(&[("flavors", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = min_alcohol_percent {
        local_var_req_builder = local_var_req_builder.query(&[("min-alcohol-percent", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = max_alcohol_percent {
        local_var_req_builder = local_var_req_builder.query(&[("max-alcohol-percent", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchDrinksApiError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn search_recipes_api(configuration: &configuration::Configuration, query: Option<&str>, cuisines: Option<&str>, exclude_cuisines: Option<&str>, meal_type: Option<&str>, diet: Option<&str>, intolerances: Option<&str>, equipment: Option<&str>, include_ingredients: Option<&str>, exclude_ingredients: Option<&str>, fill_ingredients: Option<bool>, add_recipe_information: Option<bool>, max_time: Option<i32>, min_servings: Option<i32>, max_servings: Option<i32>, min_calories: Option<f64>, max_calories: Option<f64>, min_carbs: Option<f64>, max_carbs: Option<f64>, min_protein: Option<f64>, max_protein: Option<f64>, min_fat: Option<f64>, max_fat: Option<f64>, min_sugar: Option<f64>, max_sugar: Option<f64>, min_fiber: Option<f64>, max_fiber: Option<f64>, min_folate: Option<f64>, max_folate: Option<f64>, min_folic_acid: Option<f64>, max_folic_acid: Option<f64>, min_iodine: Option<f64>, max_iodine: Option<f64>, min_iron: Option<f64>, max_iron: Option<f64>, min_zinc: Option<f64>, max_zinc: Option<f64>, min_magnesium: Option<f64>, max_magnesium: Option<f64>, min_manganese: Option<f64>, max_manganese: Option<f64>, min_phosphorus: Option<f64>, max_phosphorus: Option<f64>, min_potassium: Option<f64>, max_potassium: Option<f64>, min_sodium: Option<f64>, max_sodium: Option<f64>, min_selenium: Option<f64>, max_selenium: Option<f64>, min_copper: Option<f64>, max_copper: Option<f64>, min_calcium: Option<f64>, max_calcium: Option<f64>, min_choline: Option<f64>, max_choline: Option<f64>, min_cholesterol: Option<f64>, max_cholesterol: Option<f64>, min_fluoride: Option<f64>, max_fluoride: Option<f64>, min_alcohol: Option<f64>, max_alcohol: Option<f64>, min_caffeine: Option<f64>, max_caffeine: Option<f64>, min_saturated_fat: Option<f64>, max_saturated_fat: Option<f64>, min_vitamin_a: Option<f64>, max_vitamin_a: Option<f64>, min_vitamin_c: Option<f64>, max_vitamin_c: Option<f64>, min_vitamin_d: Option<f64>, max_vitamin_d: Option<f64>, min_vitamin_e: Option<f64>, max_vitamin_e: Option<f64>, min_vitamin_k: Option<f64>, max_vitamin_k: Option<f64>, min_vitamin_b1: Option<f64>, max_vitamin_b1: Option<f64>, min_vitamin_b2: Option<f64>, max_vitamin_b2: Option<f64>, min_vitamin_b3: Option<f64>, max_vitamin_b3: Option<f64>, min_vitamin_b5: Option<f64>, max_vitamin_b5: Option<f64>, min_vitamin_b6: Option<f64>, max_vitamin_b6: Option<f64>, min_vitamin_b12: Option<f64>, max_vitamin_b12: Option<f64>, sort: Option<&str>, sort_direction: Option<&str>, offset: Option<i32>, number: Option<i32>) -> Result<models::SearchRecipesApi200Response, Error<SearchRecipesApiError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchRecipesApiError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn search_restaurants_api(configuration: &configuration::Configuration, lat: f64, lon: f64, query: Option<&str>, distance: Option<i32>, budget: Option<f64>, min_rating: Option<f64>, cuisine: Option<&str>, is_open: Option<bool>, page: Option<i32>, sort: Option<&str>) -> Result<models::SearchRestaurantsApi200Response, Error<SearchRestaurantsApiError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchRestaurantsApiError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
