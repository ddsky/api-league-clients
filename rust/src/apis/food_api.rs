...
pub async fn compute_nutrition(configuration: &configuration::Configuration, ingredients: &str, servings: Option<i32>, reduce_oils: Option<bool>) -> Result<crate::models::ComputeNutrition200Response, Error<ComputeNutritionError>> {
...
pub async fn retrieve_recipe_information(configuration: &configuration::Configuration, id: i32, add_wine_pairing: Option<bool>) -> Result<crate::models::RetrieveRecipeInformation200Response, Error<RetrieveRecipeInformationError>> {
    let local_var_configuration = configuration;
