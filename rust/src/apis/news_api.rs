...
pub async fn extract_news(configuration: &configuration::Configuration, url: &str, analyze: bool) -> Result<crate::models::InlineResponse2003, Error<ExtractNewsError>> {
...
pub async fn search_news(configuration: &configuration::Configuration, text: Option<&str>, source_countries: Option<&str>, language: Option<&str>, min_sentiment: Option<f64>, max_sentiment: Option<f64>, earliest_publish_date: Option<&str>, latest_publish_date: Option<&str>, news_sources: Option<&str>, authors: Option<&str>, entities: Option<&str>, location_filter: Option<&str>, sort: Option<&str>, sort_direction: Option<&str>, offset: Option<i32>, number: Option<i32>) -> Result<crate::models::InlineResponse2002, Error<SearchNewsError>> {
    let local_var_configuration = configuration;
