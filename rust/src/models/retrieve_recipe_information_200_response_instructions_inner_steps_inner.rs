...
pub struct RetrieveRecipeInformation200ResponseInstructionsInnerStepsInner {
    ...
    pub ingredients: Option<Vec<crate::models::RetrieveRecipeInformation200ResponseInstructionsInnerStepsInnerIngredientsInner>>,
    #[serde(rename = "equipment", skip_serializing_if = "Option::is_none")]
    pub equipment: Option<Vec<crate::models::RetrieveRecipeInformation200ResponseInstructionsInnerStepsInnerIngredientsInner>>,
