...
pub struct SearchRestaurantsApi200ResponseRestaurantsInner {
    ...
    pub address: Option<Box<models::SearchRestaurantsApi200ResponseRestaurantsInnerAddress>>,
    ...
    pub local_hours: Option<Box<models::SearchRestaurantsApi200ResponseRestaurantsInnerLocalHours>>,
}

impl SearchRestaurantsApi200ResponseRestaurantsInner {
    pub fn new() -> SearchRestaurantsApi200ResponseRestaurantsInner {
