...
pub struct SearchRestaurants200ResponseRestaurantsInner {
    ...
    pub address: Option<Box<models::SearchRestaurants200ResponseRestaurantsInnerAddress>>,
    ...
    pub local_hours: Option<Box<models::SearchRestaurants200ResponseRestaurantsInnerLocalHours>>,
}
