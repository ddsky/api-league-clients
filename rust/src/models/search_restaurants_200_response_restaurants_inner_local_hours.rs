...
pub struct SearchRestaurants200ResponseRestaurantsInnerLocalHours {
    ...
    pub operational: Option<Box<crate::models::SearchRestaurants200ResponseRestaurantsInnerLocalHoursOperational>>,
    #[serde(rename = "delivery", skip_serializing_if = "Option::is_none")]
    pub delivery: Option<Box<crate::models::SearchRestaurants200ResponseRestaurantsInnerLocalHoursOperational>>,
    #[serde(rename = "pickup", skip_serializing_if = "Option::is_none")]
    pub pickup: Option<Box<crate::models::SearchRestaurants200ResponseRestaurantsInnerLocalHoursOperational>>,
    #[serde(rename = "dine_in", skip_serializing_if = "Option::is_none")]
    pub dine_in: Option<Box<crate::models::SearchRestaurants200ResponseRestaurantsInnerLocalHoursOperational>>,
}
