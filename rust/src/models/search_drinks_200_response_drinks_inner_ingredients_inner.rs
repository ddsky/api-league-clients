...
pub struct SearchDrinks200ResponseDrinksInnerIngredientsInner {
    ...
    pub measures: Option<Box<models::SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasures>>,
...
impl SearchDrinks200ResponseDrinksInnerIngredientsInner {
    pub fn new() -> SearchDrinks200ResponseDrinksInnerIngredientsInner {
