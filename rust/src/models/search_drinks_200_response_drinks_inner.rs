...
pub struct SearchDrinks200ResponseDrinksInner {
    #[serde(rename = "flavors", skip_serializing_if = "Option::is_none")]
    pub flavors: Option<Vec<String>>,
    #[serde(rename = "instructions", skip_serializing_if = "Option::is_none")]
    pub instructions: Option<Vec<models::SearchDrinks200ResponseDrinksInnerInstructionsInner>>,
    #[serde(rename = "images", skip_serializing_if = "Option::is_none")]
    pub images: Option<Vec<String>>,
    #[serde(rename = "nutrition", skip_serializing_if = "Option::is_none")]
    pub nutrition: Option<Box<models::SearchDrinks200ResponseDrinksInnerNutrition>>,
    ...
    pub credits: Option<Box<models::SearchDrinks200ResponseDrinksInnerCredits>>,
    ...
    pub ingredients: Option<Vec<models::SearchDrinks200ResponseDrinksInnerIngredientsInner>>,
...
impl SearchDrinks200ResponseDrinksInner {
    pub fn new() -> SearchDrinks200ResponseDrinksInner {
