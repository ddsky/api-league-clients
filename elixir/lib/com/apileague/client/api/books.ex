...
defmodule com.apileague.client.Api.Books do
  @moduledoc """
  ...
  {:ok, com.apileague.client.Model.InlineResponse2001.t} on success
  {:error, Tesla.Env.t} on failure
  """
  @spec find_similar_books(Tesla.Env.client, integer(), keyword()) :: {:ok, nil} | {:ok, com.apileague.client.Model.InlineResponse2001.t} | {:error, Tesla.Env.t}
  def find_similar_books(connection, id, opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %com.apileague.client.Model.InlineResponse2001{}},
      { 401, false},
      { 402, false},
      { 403, false},
      { 404, false},
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :earliest_publish_year (integer()): The books must have been published after this year.
    - :latest_publish_year (integer()): The books must have been published before this year.
  ...
  {:ok, com.apileague.client.Model.InlineResponse200.t} on success
  {:error, Tesla.Env.t} on failure
  """
  @spec search_books(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, com.apileague.client.Model.InlineResponse200.t} | {:error, Tesla.Env.t}
  def search_books(connection, opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %com.apileague.client.Model.InlineResponse200{}},
      { 401, false},
      { 402, false},
      { 403, false},
      { 404, false},
