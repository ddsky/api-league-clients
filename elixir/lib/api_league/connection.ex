...
defmodule APILeague.Connection do
  @moduledoc """
  Handle Tesla connections for APILeague.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, APILeague.Connection,
        base_url: "https://api.apileague.com",
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:apileague, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - APILeague 1.5.0 - elixir"
        )
      )
