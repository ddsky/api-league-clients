...
data class InlineResponse20018Interestingness (

    @Json(name = "mainscores")
    val mainscores: InlineResponse20018SkimmabilityMainscores? = null,

    @Json(name = "subscores")
    val subscores: InlineResponse20018InterestingnessSubscores? = null
