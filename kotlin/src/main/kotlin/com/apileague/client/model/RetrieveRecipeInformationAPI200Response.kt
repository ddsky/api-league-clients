...
data class RetrieveRecipeInformationAPI200Response (
    ...
    val dietaryProperties: RetrieveRecipeInformationAPI200ResponseDietaryProperties? = null,

    @Json(name = "price_per_serving")
    val pricePerServing: java.math.BigDecimal? = null,

    @Json(name = "times")
    val times: RetrieveRecipeInformationAPI200ResponseTimes? = null,

    @Json(name = "nutrition")
    val nutrition: RetrieveRecipeInformationAPI200ResponseNutrition? = null,

    @Json(name = "taste")
    val taste: RetrieveRecipeInformationAPI200ResponseTaste? = null,
    ...
    val ingredients: kotlin.collections.List<RetrieveRecipeInformationAPI200ResponseIngredientsInner>? = null,

    @Json(name = "instructions")
    val instructions: kotlin.collections.List<RetrieveRecipeInformationAPI200ResponseInstructionsInner>? = null,

    @Json(name = "credits")
    val credits: RetrieveRecipeInformationAPI200ResponseCredits? = null,

    @Json(name = "scores")
    val scores: RetrieveRecipeInformationAPI200ResponseScores? = null
