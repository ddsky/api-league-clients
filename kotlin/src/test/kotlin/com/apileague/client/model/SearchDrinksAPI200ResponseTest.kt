...
class SearchDrinksAPI200ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of SearchDrinksAPI200Response
        //val modelInstance = SearchDrinksAPI200Response()
        ...
        // to test the property `drinks`
        should("test drinks") {
            // uncomment below to test the property
            //modelInstance.drinks shouldBe ("TODO")
        }
