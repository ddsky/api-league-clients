...
export const APIS = [ArtService, BooksService, FoodService, HumorService, KnowledgeService, MathService, MediaService, NewsService, StorageService, TextService, WebService];
