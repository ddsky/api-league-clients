-module(apileague_search_drinks_200_response_drinks_inner_nutrition).

-export([encode/1]).

-export_type([apileague_search_drinks_200_response_drinks_inner_nutrition/0]).

-type apileague_search_drinks_200_response_drinks_inner_nutrition() ::
