-module(openapi_inline_response_200_19_interestingness_subscores).

-export([encode/1]).

-export_type([openapi_inline_response_200_19_interestingness_subscores/0]).

-type openapi_inline_response_200_19_interestingness_subscores() ::
