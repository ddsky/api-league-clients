-module(openapi_inline_response_200_18_skimmability_subscores).

-export([encode/1]).

-export_type([openapi_inline_response_200_18_skimmability_subscores/0]).

-type openapi_inline_response_200_18_skimmability_subscores() ::
