...
namespace apileague.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.6.4/csharp");
        ...
        public Configuration(
            ...
            string basePath = "https://api.apileague.com") : this()
        {
        ...
        {
            string report = "C# SDK (apileague) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 1.6.4\n";
