...
namespace apileague.Model
{
    ...
    /// </summary>
    [DataContract(Name = "retrieveRecipeInformationAPI_200_response_ingredients_inner")]
    public partial class RetrieveRecipeInformationAPI200ResponseIngredientsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrieveRecipeInformationAPI200ResponseIngredientsInner" /> class.
        /// </summary>
        ...
        public RetrieveRecipeInformationAPI200ResponseIngredientsInner(string image = default(string), string nameClean = default(string), decimal amount = default(decimal), string unit = default(string), RetrieveRecipeInformationAPI200ResponseIngredientsInnerMeasures measures = default(RetrieveRecipeInformationAPI200ResponseIngredientsInnerMeasures), string original = default(string), List<string> meta = default(List<string>), string originalName = default(string), string name = default(string), int id = default(int), string aisle = default(string), string consistency = default(string))
        {
            this.Image = image;
        ...
        public RetrieveRecipeInformationAPI200ResponseIngredientsInnerMeasures Measures { get; set; }
