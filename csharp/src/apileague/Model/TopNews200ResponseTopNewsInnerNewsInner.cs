...
namespace apileague.Model
{
    ...
    public partial class TopNews200ResponseTopNewsInnerNewsInner : IValidatableObject
    {
        ...
        public TopNews200ResponseTopNewsInnerNewsInner(string summary = default(string), string image = default(string), int id = default(int), string text = default(string), string title = default(string), string publishDate = default(string), string url = default(string), List<string> authors = default(List<string>))
        {
