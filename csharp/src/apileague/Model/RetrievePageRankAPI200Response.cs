...
namespace apileague.Model
{
    ...
    /// </summary>
    [DataContract(Name = "retrievePageRankAPI_200_response")]
    public partial class RetrievePageRankAPI200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrievePageRankAPI200Response" /> class.
        /// </summary>
        /// <param name="pageRank">pageRank.</param>
        /// <param name="position">position.</param>
        /// <param name="percentile">percentile.</param>
        public RetrievePageRankAPI200Response(decimal pageRank = default(decimal), int position = default(int), decimal percentile = default(decimal))
        {
