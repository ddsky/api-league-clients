...
namespace apileague.Model
{
    ...
    /// </summary>
    [DataContract(Name = "searchRestaurantsAPI_200_response_restaurants_inner")]
    public partial class SearchRestaurantsAPI200ResponseRestaurantsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchRestaurantsAPI200ResponseRestaurantsInner" /> class.
        /// </summary>
        ...
        public SearchRestaurantsAPI200ResponseRestaurantsInner(bool offersThirdPartyDelivery = default(bool), SearchRestaurantsAPI200ResponseRestaurantsInnerAddress address = default(SearchRestaurantsAPI200ResponseRestaurantsInnerAddress), bool supportsUpcCodes = default(bool), bool isOpen = default(bool), string description = default(string), int weightedRatingValue = default(int), string type = default(string), bool offersFirstPartyDelivery = default(bool), int aggregatedRatingCount = default(int), bool pickupEnabled = default(bool), List<string> cuisines = default(List<string>), decimal miles = default(decimal), int dollarSigns = default(int), bool deliveryEnabled = default(bool), string name = default(string), decimal phoneNumber = default(decimal), string id = default(string), SearchRestaurantsAPI200ResponseRestaurantsInnerLocalHours localHours = default(SearchRestaurantsAPI200ResponseRestaurantsInnerLocalHours))
        {
        ...
        public SearchRestaurantsAPI200ResponseRestaurantsInnerAddress Address { get; set; }
        ...
        public SearchRestaurantsAPI200ResponseRestaurantsInnerLocalHours LocalHours { get; set; }
