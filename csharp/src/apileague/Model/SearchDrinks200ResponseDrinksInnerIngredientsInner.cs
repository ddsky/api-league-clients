...
namespace apileague.Model
{
    ...
    /// </summary>
    [DataContract(Name = "searchDrinks_200_response_drinks_inner_ingredients_inner")]
    public partial class SearchDrinks200ResponseDrinksInnerIngredientsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchDrinks200ResponseDrinksInnerIngredientsInner" /> class.
        /// </summary>
        ...
        public SearchDrinks200ResponseDrinksInnerIngredientsInner(string image = default(string), string nameClean = default(string), int amount = default(int), string unit = default(string), SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasures measures = default(SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasures), string original = default(string), List<string> meta = default(List<string>), string originalName = default(string), string name = default(string), int id = default(int), string aisle = default(string), string consistency = default(string))
        {
            this.Image = image;
        ...
        public SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasures Measures { get; set; }
