...
namespace apileague.Model
{
    ...
    public partial class ExtractNews200Response : IValidatableObject
    {
        ...
        public ExtractNews200Response(string title = default(string), string text = default(string), string url = default(string), string image = default(string), string publishDate = default(string), string author = default(string), string language = default(string), string sourceCountry = default(string), decimal sentiment = default(decimal))
        {
            this.Title = title;
            this.Text = text;
            this.Url = url;
