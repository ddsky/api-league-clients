...
namespace apileague.Model
{
    ...
    public partial class SearchNews200ResponseNewsInner : IValidatableObject
    {
        ...
        public SearchNews200ResponseNewsInner(string summary = default(string), string image = default(string), decimal sentiment = default(decimal), string sourceCountry = default(string), string language = default(string), int id = default(int), string text = default(string), string video = default(string), string title = default(string), string publishDate = default(string), string url = default(string), List<string> authors = default(List<string>))
        {
