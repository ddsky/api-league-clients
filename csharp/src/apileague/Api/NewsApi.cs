...
namespace apileague.Api
{
    ...
    public partial class NewsApi : INewsApi
    {
        ...
        {
            apileague.Client.ApiResponse<SearchNews200Response> localVarResponse = SearchNewsWithHttpInfo(text, sourceCountries, language, minSentiment, maxSentiment, earliestPublishDate, latestPublishDate, newsSources, authors, categories, entities, locationFilter, sort, sortDirection, offset, number);
            return localVarResponse.Data;
        }
        ...
        {
            apileague.Client.ApiResponse<TopNews200Response> localVarResponse = TopNewsWithHttpInfo(sourceCountry, language, date, headlinesOnly);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TopNews200Response</returns>
        public apileague.Client.ApiResponse<TopNews200Response> TopNewsWithHttpInfo(string sourceCountry, string language, string? date = default(string?), bool? headlinesOnly = default(bool?), int operationIndex = 0)
        {
            // verify the required parameter 'sourceCountry' is set
            if (sourceCountry == null)
            {
                throw new apileague.Client.ApiException(400, "Missing required parameter 'sourceCountry' when calling NewsApi->TopNews");
            }

            // verify the required parameter 'language' is set
            if (language == null)
            {
                throw new apileague.Client.ApiException(400, "Missing required parameter 'language' when calling NewsApi->TopNews");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<TopNews200Response>("/retrieve-top-news", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            apileague.Client.ApiResponse<TopNews200Response> localVarResponse = await TopNewsWithHttpInfoAsync(sourceCountry, language, date, headlinesOnly, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<apileague.Client.ApiResponse<TopNews200Response>> TopNewsWithHttpInfoAsync(string sourceCountry, string language, string? date = default(string?), bool? headlinesOnly = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<TopNews200Response>("/retrieve-top-news", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
