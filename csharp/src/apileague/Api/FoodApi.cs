...
namespace apileague.Api
{
    ...
    public interface IFoodApiSync : IApiAccessor
    {
        ...
        /// <returns>ComputeNutritionAPI200Response</returns>
        ComputeNutritionAPI200Response ComputeNutritionAPI(string ingredients, int? servings = default(int?), bool? reduceOils = default(bool?), int operationIndex = 0);
        ...
        /// <param name="reduceOils">If there is oil in the ingredients, e.g. 3 tablespoons olive oil but they are used for frying, not all of the oil is consumed and therefore should not be added to the computed nutrition. In this case set reduce-oils to true. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ComputeNutritionAPI200Response</returns>
        ApiResponse<ComputeNutritionAPI200Response> ComputeNutritionAPIWithHttpInfo(string ingredients, int? servings = default(int?), bool? reduceOils = default(bool?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RetrieveRecipeInformationAPI200Response</returns>
        RetrieveRecipeInformationAPI200Response RetrieveRecipeInformationAPI(int id, bool? addWinePairing = default(bool?), int operationIndex = 0);
        ...
        /// <param name="addWinePairing">Whether to pair a wine to the recipe. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RetrieveRecipeInformationAPI200Response</returns>
        ApiResponse<RetrieveRecipeInformationAPI200Response> RetrieveRecipeInformationAPIWithHttpInfo(int id, bool? addWinePairing = default(bool?), int operationIndex = 0);
        /// <summary>
        /// Search Drinks API
        /// </summary>
        /// <remarks>
        ...
        /// <param name="number">The number of drinks, between 1 and 10. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SearchDrinksAPI200Response</returns>
        ApiResponse<SearchDrinksAPI200Response> SearchDrinksAPIWithHttpInfo(string? query = default(string?), string? glassTypes = default(string?), string? flavors = default(string?), string? diet = default(string?), string? includeIngredients = default(string?), string? excludeIngredients = default(string?), double? minCalories = default(double?), double? maxCalories = default(double?), double? minCarbs = default(double?), double? maxCarbs = default(double?), double? minProtein = default(double?), double? maxProtein = default(double?), double? minFat = default(double?), double? maxFat = default(double?), double? minAlcoholPercent = default(double?), double? maxAlcoholPercent = default(double?), double? minCaffeine = default(double?), double? maxCaffeine = default(double?), string? sort = default(string?), string? sortDirection = default(string?), int? offset = default(int?), int? number = default(int?), int operationIndex = 0);
        /// <summary>
        /// Search Recipes API
        /// </summary>
        /// <remarks>
        ...
        /// <param name="number">The number of recipes, between 1 and 100. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SearchRecipesAPI200Response</returns>
        ApiResponse<SearchRecipesAPI200Response> SearchRecipesAPIWithHttpInfo(string? query = default(string?), string? cuisines = default(string?), string? excludeCuisines = default(string?), string? mealType = default(string?), string? diet = default(string?), string? intolerances = default(string?), string? equipment = default(string?), string? includeIngredients = default(string?), string? excludeIngredients = default(string?), bool? fillIngredients = default(bool?), bool? addRecipeInformation = default(bool?), int? maxTime = default(int?), int? minServings = default(int?), int? maxServings = default(int?), double? minCalories = default(double?), double? maxCalories = default(double?), double? minCarbs = default(double?), double? maxCarbs = default(double?), double? minProtein = default(double?), double? maxProtein = default(double?), double? minFat = default(double?), double? maxFat = default(double?), double? minSugar = default(double?), double? maxSugar = default(double?), double? minFiber = default(double?), double? maxFiber = default(double?), double? minFolate = default(double?), double? maxFolate = default(double?), double? minFolicAcid = default(double?), double? maxFolicAcid = default(double?), double? minIodine = default(double?), double? maxIodine = default(double?), double? minIron = default(double?), double? maxIron = default(double?), double? minZinc = default(double?), double? maxZinc = default(double?), double? minMagnesium = default(double?), double? maxMagnesium = default(double?), double? minManganese = default(double?), double? maxManganese = default(double?), double? minPhosphorus = default(double?), double? maxPhosphorus = default(double?), double? minPotassium = default(double?), double? maxPotassium = default(double?), double? minSodium = default(double?), double? maxSodium = default(double?), double? minSelenium = default(double?), double? maxSelenium = default(double?), double? minCopper = default(double?), double? maxCopper = default(double?), double? minCalcium = default(double?), double? maxCalcium = default(double?), double? minCholine = default(double?), double? maxCholine = default(double?), double? minCholesterol = default(double?), double? maxCholesterol = default(double?), double? minFluoride = default(double?), double? maxFluoride = default(double?), double? minAlcohol = default(double?), double? maxAlcohol = default(double?), double? minCaffeine = default(double?), double? maxCaffeine = default(double?), double? minSaturatedFat = default(double?), double? maxSaturatedFat = default(double?), double? minVitaminA = default(double?), double? maxVitaminA = default(double?), double? minVitaminC = default(double?), double? maxVitaminC = default(double?), double? minVitaminD = default(double?), double? maxVitaminD = default(double?), double? minVitaminE = default(double?), double? maxVitaminE = default(double?), double? minVitaminK = default(double?), double? maxVitaminK = default(double?), double? minVitaminB1 = default(double?), double? maxVitaminB1 = default(double?), double? minVitaminB2 = default(double?), double? maxVitaminB2 = default(double?), double? minVitaminB3 = default(double?), double? maxVitaminB3 = default(double?), double? minVitaminB5 = default(double?), double? maxVitaminB5 = default(double?), double? minVitaminB6 = default(double?), double? maxVitaminB6 = default(double?), double? minVitaminB12 = default(double?), double? maxVitaminB12 = default(double?), string? sort = default(string?), string? sortDirection = default(string?), int? offset = default(int?), int? number = default(int?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="sort">The sort parameter, one of: cheapest, fastest, rating, distance or relevance. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SearchRestaurantsAPI200Response</returns>
        ApiResponse<SearchRestaurantsAPI200Response> SearchRestaurantsAPIWithHttpInfo(double lat, double lon, string? query = default(string?), int? distance = default(int?), double? budget = default(double?), double? minRating = default(double?), string? cuisine = default(string?), bool? isOpen = default(bool?), int? page = default(int?), string? sort = default(string?), int operationIndex = 0);
    ...
    public interface IFoodApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of ComputeNutritionAPI200Response</returns>
        System.Threading.Tasks.Task<ComputeNutritionAPI200Response> ComputeNutritionAPIAsync(string ingredients, int? servings = default(int?), bool? reduceOils = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ComputeNutritionAPI200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<ComputeNutritionAPI200Response>> ComputeNutritionAPIWithHttpInfoAsync(string ingredients, int? servings = default(int?), bool? reduceOils = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve Recipe Information API
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RetrieveRecipeInformationAPI200Response</returns>
        System.Threading.Tasks.Task<RetrieveRecipeInformationAPI200Response> RetrieveRecipeInformationAPIAsync(int id, bool? addWinePairing = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RetrieveRecipeInformationAPI200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<RetrieveRecipeInformationAPI200Response>> RetrieveRecipeInformationAPIWithHttpInfoAsync(int id, bool? addWinePairing = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Search Drinks API
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SearchDrinksAPI200Response</returns>
        System.Threading.Tasks.Task<SearchDrinksAPI200Response> SearchDrinksAPIAsync(string? query = default(string?), string? glassTypes = default(string?), string? flavors = default(string?), string? diet = default(string?), string? includeIngredients = default(string?), string? excludeIngredients = default(string?), double? minCalories = default(double?), double? maxCalories = default(double?), double? minCarbs = default(double?), double? maxCarbs = default(double?), double? minProtein = default(double?), double? maxProtein = default(double?), double? minFat = default(double?), double? maxFat = default(double?), double? minAlcoholPercent = default(double?), double? maxAlcoholPercent = default(double?), double? minCaffeine = default(double?), double? maxCaffeine = default(double?), string? sort = default(string?), string? sortDirection = default(string?), int? offset = default(int?), int? number = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SearchDrinksAPI200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<SearchDrinksAPI200Response>> SearchDrinksAPIWithHttpInfoAsync(string? query = default(string?), string? glassTypes = default(string?), string? flavors = default(string?), string? diet = default(string?), string? includeIngredients = default(string?), string? excludeIngredients = default(string?), double? minCalories = default(double?), double? maxCalories = default(double?), double? minCarbs = default(double?), double? maxCarbs = default(double?), double? minProtein = default(double?), double? maxProtein = default(double?), double? minFat = default(double?), double? maxFat = default(double?), double? minAlcoholPercent = default(double?), double? maxAlcoholPercent = default(double?), double? minCaffeine = default(double?), double? maxCaffeine = default(double?), string? sort = default(string?), string? sortDirection = default(string?), int? offset = default(int?), int? number = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Search Recipes API
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SearchRecipesAPI200Response</returns>
        System.Threading.Tasks.Task<SearchRecipesAPI200Response> SearchRecipesAPIAsync(string? query = default(string?), string? cuisines = default(string?), string? excludeCuisines = default(string?), string? mealType = default(string?), string? diet = default(string?), string? intolerances = default(string?), string? equipment = default(string?), string? includeIngredients = default(string?), string? excludeIngredients = default(string?), bool? fillIngredients = default(bool?), bool? addRecipeInformation = default(bool?), int? maxTime = default(int?), int? minServings = default(int?), int? maxServings = default(int?), double? minCalories = default(double?), double? maxCalories = default(double?), double? minCarbs = default(double?), double? maxCarbs = default(double?), double? minProtein = default(double?), double? maxProtein = default(double?), double? minFat = default(double?), double? maxFat = default(double?), double? minSugar = default(double?), double? maxSugar = default(double?), double? minFiber = default(double?), double? maxFiber = default(double?), double? minFolate = default(double?), double? maxFolate = default(double?), double? minFolicAcid = default(double?), double? maxFolicAcid = default(double?), double? minIodine = default(double?), double? maxIodine = default(double?), double? minIron = default(double?), double? maxIron = default(double?), double? minZinc = default(double?), double? maxZinc = default(double?), double? minMagnesium = default(double?), double? maxMagnesium = default(double?), double? minManganese = default(double?), double? maxManganese = default(double?), double? minPhosphorus = default(double?), double? maxPhosphorus = default(double?), double? minPotassium = default(double?), double? maxPotassium = default(double?), double? minSodium = default(double?), double? maxSodium = default(double?), double? minSelenium = default(double?), double? maxSelenium = default(double?), double? minCopper = default(double?), double? maxCopper = default(double?), double? minCalcium = default(double?), double? maxCalcium = default(double?), double? minCholine = default(double?), double? maxCholine = default(double?), double? minCholesterol = default(double?), double? maxCholesterol = default(double?), double? minFluoride = default(double?), double? maxFluoride = default(double?), double? minAlcohol = default(double?), double? maxAlcohol = default(double?), double? minCaffeine = default(double?), double? maxCaffeine = default(double?), double? minSaturatedFat = default(double?), double? maxSaturatedFat = default(double?), double? minVitaminA = default(double?), double? maxVitaminA = default(double?), double? minVitaminC = default(double?), double? maxVitaminC = default(double?), double? minVitaminD = default(double?), double? maxVitaminD = default(double?), double? minVitaminE = default(double?), double? maxVitaminE = default(double?), double? minVitaminK = default(double?), double? maxVitaminK = default(double?), double? minVitaminB1 = default(double?), double? maxVitaminB1 = default(double?), double? minVitaminB2 = default(double?), double? maxVitaminB2 = default(double?), double? minVitaminB3 = default(double?), double? maxVitaminB3 = default(double?), double? minVitaminB5 = default(double?), double? maxVitaminB5 = default(double?), double? minVitaminB6 = default(double?), double? maxVitaminB6 = default(double?), double? minVitaminB12 = default(double?), double? maxVitaminB12 = default(double?), string? sort = default(string?), string? sortDirection = default(string?), int? offset = default(int?), int? number = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SearchRestaurantsAPI200Response</returns>
        System.Threading.Tasks.Task<SearchRestaurantsAPI200Response> SearchRestaurantsAPIAsync(double lat, double lon, string? query = default(string?), int? distance = default(int?), double? budget = default(double?), double? minRating = default(double?), string? cuisine = default(string?), bool? isOpen = default(bool?), int? page = default(int?), string? sort = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SearchRestaurantsAPI200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<SearchRestaurantsAPI200Response>> SearchRestaurantsAPIWithHttpInfoAsync(double lat, double lon, string? query = default(string?), int? distance = default(int?), double? budget = default(double?), double? minRating = default(double?), string? cuisine = default(string?), bool? isOpen = default(bool?), int? page = default(int?), string? sort = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class FoodApi : IFoodApi
    {
        ...
        /// <summary>
        /// Compute Nutrition API Compute detailed nutritional information for a given recipe (list of ingredients). The API will return the nutritional information for each ingredient, as well as the total nutritional content for the entire recipe. Aside from macro and micro nutrients, the API also returns flavanoid information and food properties such as glycemic index, glycemic load, and inflammation score.
        /// </summary>
        /// <exception cref="apileague.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ingredients">A comma-separated list of the ingredients of the recipe.</param>
        /// <param name="servings">The number of servings the ingredients make. Nutrition is computed per serving. (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ComputeNutritionAPI200Response</returns>
        public ComputeNutritionAPI200Response ComputeNutritionAPI(string ingredients, int? servings = default(int?), bool? reduceOils = default(bool?), int operationIndex = 0)
        {
            apileague.Client.ApiResponse<ComputeNutritionAPI200Response> localVarResponse = ComputeNutritionAPIWithHttpInfo(ingredients, servings, reduceOils);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ComputeNutritionAPI200Response</returns>
        public apileague.Client.ApiResponse<ComputeNutritionAPI200Response> ComputeNutritionAPIWithHttpInfo(string ingredients, int? servings = default(int?), bool? reduceOils = default(bool?), int operationIndex = 0)
        {
            // verify the required parameter 'ingredients' is set
            if (ingredients == null)
            {
                throw new apileague.Client.ApiException(400, "Missing required parameter 'ingredients' when calling FoodApi->ComputeNutritionAPI");
            }
            ...
            localVarRequestOptions.Operation = "FoodApi.ComputeNutritionAPI";
            ...
            var localVarResponse = this.Client.Get<ComputeNutritionAPI200Response>("/compute-nutrition", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ComputeNutritionAPI", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ComputeNutritionAPI200Response</returns>
        public async System.Threading.Tasks.Task<ComputeNutritionAPI200Response> ComputeNutritionAPIAsync(string ingredients, int? servings = default(int?), bool? reduceOils = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            apileague.Client.ApiResponse<ComputeNutritionAPI200Response> localVarResponse = await ComputeNutritionAPIWithHttpInfoAsync(ingredients, servings, reduceOils, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ComputeNutritionAPI200Response)</returns>
        public async System.Threading.Tasks.Task<apileague.Client.ApiResponse<ComputeNutritionAPI200Response>> ComputeNutritionAPIWithHttpInfoAsync(string ingredients, int? servings = default(int?), bool? reduceOils = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ingredients' is set
            if (ingredients == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ComputeNutritionAPI200Response>("/compute-nutrition", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve Recipe Information API Get detailed recipe information such as dietary properties, macro and micro nutrients, used ingredients and their amounts, and more.
        /// </summary>
        /// <exception cref="apileague.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The id of the recipe to retrieve.</param>
        /// <param name="addWinePairing">Whether to pair a wine to the recipe. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RetrieveRecipeInformationAPI200Response</returns>
        public RetrieveRecipeInformationAPI200Response RetrieveRecipeInformationAPI(int id, bool? addWinePairing = default(bool?), int operationIndex = 0)
        {
            apileague.Client.ApiResponse<RetrieveRecipeInformationAPI200Response> localVarResponse = RetrieveRecipeInformationAPIWithHttpInfo(id, addWinePairing);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RetrieveRecipeInformationAPI200Response</returns>
        public apileague.Client.ApiResponse<RetrieveRecipeInformationAPI200Response> RetrieveRecipeInformationAPIWithHttpInfo(int id, bool? addWinePairing = default(bool?), int operationIndex = 0)
        {
            apileague.Client.RequestOptions localVarRequestOptions = new apileague.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "FoodApi.RetrieveRecipeInformationAPI";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<RetrieveRecipeInformationAPI200Response>("/retrieve-recipe", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("RetrieveRecipeInformationAPI", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RetrieveRecipeInformationAPI200Response</returns>
        public async System.Threading.Tasks.Task<RetrieveRecipeInformationAPI200Response> RetrieveRecipeInformationAPIAsync(int id, bool? addWinePairing = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            apileague.Client.ApiResponse<RetrieveRecipeInformationAPI200Response> localVarResponse = await RetrieveRecipeInformationAPIWithHttpInfoAsync(id, addWinePairing, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RetrieveRecipeInformationAPI200Response)</returns>
        public async System.Threading.Tasks.Task<apileague.Client.ApiResponse<RetrieveRecipeInformationAPI200Response>> RetrieveRecipeInformationAPIWithHttpInfoAsync(int id, bool? addWinePairing = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<RetrieveRecipeInformationAPI200Response>("/retrieve-recipe", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Search Drinks API Search for drinks by title, ingredients, flavor, type of glass, alcohol content, and more.
        /// </summary>
        /// <exception cref="apileague.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="query">The search query. (optional)</param>
        /// <param name="glassTypes">A comma-separated list (interpreted as OR) of glass types that the drink should be served in. (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>SearchDrinksAPI200Response</returns>
        public SearchDrinksAPI200Response SearchDrinksAPI(string? query = default(string?), string? glassTypes = default(string?), string? flavors = default(string?), string? diet = default(string?), string? includeIngredients = default(string?), string? excludeIngredients = default(string?), double? minCalories = default(double?), double? maxCalories = default(double?), double? minCarbs = default(double?), double? maxCarbs = default(double?), double? minProtein = default(double?), double? maxProtein = default(double?), double? minFat = default(double?), double? maxFat = default(double?), double? minAlcoholPercent = default(double?), double? maxAlcoholPercent = default(double?), double? minCaffeine = default(double?), double? maxCaffeine = default(double?), string? sort = default(string?), string? sortDirection = default(string?), int? offset = default(int?), int? number = default(int?), int operationIndex = 0)
        {
            apileague.Client.ApiResponse<SearchDrinksAPI200Response> localVarResponse = SearchDrinksAPIWithHttpInfo(query, glassTypes, flavors, diet, includeIngredients, excludeIngredients, minCalories, maxCalories, minCarbs, maxCarbs, minProtein, maxProtein, minFat, maxFat, minAlcoholPercent, maxAlcoholPercent, minCaffeine, maxCaffeine, sort, sortDirection, offset, number);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SearchDrinksAPI200Response</returns>
        public apileague.Client.ApiResponse<SearchDrinksAPI200Response> SearchDrinksAPIWithHttpInfo(string? query = default(string?), string? glassTypes = default(string?), string? flavors = default(string?), string? diet = default(string?), string? includeIngredients = default(string?), string? excludeIngredients = default(string?), double? minCalories = default(double?), double? maxCalories = default(double?), double? minCarbs = default(double?), double? maxCarbs = default(double?), double? minProtein = default(double?), double? maxProtein = default(double?), double? minFat = default(double?), double? maxFat = default(double?), double? minAlcoholPercent = default(double?), double? maxAlcoholPercent = default(double?), double? minCaffeine = default(double?), double? maxCaffeine = default(double?), string? sort = default(string?), string? sortDirection = default(string?), int? offset = default(int?), int? number = default(int?), int operationIndex = 0)
        {
            apileague.Client.RequestOptions localVarRequestOptions = new apileague.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "FoodApi.SearchDrinksAPI";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<SearchDrinksAPI200Response>("/search-drinks", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("SearchDrinksAPI", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SearchDrinksAPI200Response</returns>
        public async System.Threading.Tasks.Task<SearchDrinksAPI200Response> SearchDrinksAPIAsync(string? query = default(string?), string? glassTypes = default(string?), string? flavors = default(string?), string? diet = default(string?), string? includeIngredients = default(string?), string? excludeIngredients = default(string?), double? minCalories = default(double?), double? maxCalories = default(double?), double? minCarbs = default(double?), double? maxCarbs = default(double?), double? minProtein = default(double?), double? maxProtein = default(double?), double? minFat = default(double?), double? maxFat = default(double?), double? minAlcoholPercent = default(double?), double? maxAlcoholPercent = default(double?), double? minCaffeine = default(double?), double? maxCaffeine = default(double?), string? sort = default(string?), string? sortDirection = default(string?), int? offset = default(int?), int? number = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            apileague.Client.ApiResponse<SearchDrinksAPI200Response> localVarResponse = await SearchDrinksAPIWithHttpInfoAsync(query, glassTypes, flavors, diet, includeIngredients, excludeIngredients, minCalories, maxCalories, minCarbs, maxCarbs, minProtein, maxProtein, minFat, maxFat, minAlcoholPercent, maxAlcoholPercent, minCaffeine, maxCaffeine, sort, sortDirection, offset, number, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SearchDrinksAPI200Response)</returns>
        public async System.Threading.Tasks.Task<apileague.Client.ApiResponse<SearchDrinksAPI200Response>> SearchDrinksAPIWithHttpInfoAsync(string? query = default(string?), string? glassTypes = default(string?), string? flavors = default(string?), string? diet = default(string?), string? includeIngredients = default(string?), string? excludeIngredients = default(string?), double? minCalories = default(double?), double? maxCalories = default(double?), double? minCarbs = default(double?), double? maxCarbs = default(double?), double? minProtein = default(double?), double? maxProtein = default(double?), double? minFat = default(double?), double? maxFat = default(double?), double? minAlcoholPercent = default(double?), double? maxAlcoholPercent = default(double?), double? minCaffeine = default(double?), double? maxCaffeine = default(double?), string? sort = default(string?), string? sortDirection = default(string?), int? offset = default(int?), int? number = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<SearchDrinksAPI200Response>("/search-drinks", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Search Recipes API Search and filter thousands of recipes with natural language, e.g. pasta recipes without mushrooms but with truffles. You can filter by ingredients, diet, cuisine, meal type, macro and micro nutrition, intolerances, and much more.
        /// </summary>
        /// <exception cref="apileague.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="query">The search query. (optional)</param>
        /// <param name="cuisines">The cuisine(s) of the recipes. One or more, comma-separated (will be interpreted as &#39;OR&#39;). (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SearchRecipesAPI200Response</returns>
        public apileague.Client.ApiResponse<SearchRecipesAPI200Response> SearchRecipesAPIWithHttpInfo(string? query = default(string?), string? cuisines = default(string?), string? excludeCuisines = default(string?), string? mealType = default(string?), string? diet = default(string?), string? intolerances = default(string?), string? equipment = default(string?), string? includeIngredients = default(string?), string? excludeIngredients = default(string?), bool? fillIngredients = default(bool?), bool? addRecipeInformation = default(bool?), int? maxTime = default(int?), int? minServings = default(int?), int? maxServings = default(int?), double? minCalories = default(double?), double? maxCalories = default(double?), double? minCarbs = default(double?), double? maxCarbs = default(double?), double? minProtein = default(double?), double? maxProtein = default(double?), double? minFat = default(double?), double? maxFat = default(double?), double? minSugar = default(double?), double? maxSugar = default(double?), double? minFiber = default(double?), double? maxFiber = default(double?), double? minFolate = default(double?), double? maxFolate = default(double?), double? minFolicAcid = default(double?), double? maxFolicAcid = default(double?), double? minIodine = default(double?), double? maxIodine = default(double?), double? minIron = default(double?), double? maxIron = default(double?), double? minZinc = default(double?), double? maxZinc = default(double?), double? minMagnesium = default(double?), double? maxMagnesium = default(double?), double? minManganese = default(double?), double? maxManganese = default(double?), double? minPhosphorus = default(double?), double? maxPhosphorus = default(double?), double? minPotassium = default(double?), double? maxPotassium = default(double?), double? minSodium = default(double?), double? maxSodium = default(double?), double? minSelenium = default(double?), double? maxSelenium = default(double?), double? minCopper = default(double?), double? maxCopper = default(double?), double? minCalcium = default(double?), double? maxCalcium = default(double?), double? minCholine = default(double?), double? maxCholine = default(double?), double? minCholesterol = default(double?), double? maxCholesterol = default(double?), double? minFluoride = default(double?), double? maxFluoride = default(double?), double? minAlcohol = default(double?), double? maxAlcohol = default(double?), double? minCaffeine = default(double?), double? maxCaffeine = default(double?), double? minSaturatedFat = default(double?), double? maxSaturatedFat = default(double?), double? minVitaminA = default(double?), double? maxVitaminA = default(double?), double? minVitaminC = default(double?), double? maxVitaminC = default(double?), double? minVitaminD = default(double?), double? maxVitaminD = default(double?), double? minVitaminE = default(double?), double? maxVitaminE = default(double?), double? minVitaminK = default(double?), double? maxVitaminK = default(double?), double? minVitaminB1 = default(double?), double? maxVitaminB1 = default(double?), double? minVitaminB2 = default(double?), double? maxVitaminB2 = default(double?), double? minVitaminB3 = default(double?), double? maxVitaminB3 = default(double?), double? minVitaminB5 = default(double?), double? maxVitaminB5 = default(double?), double? minVitaminB6 = default(double?), double? maxVitaminB6 = default(double?), double? minVitaminB12 = default(double?), double? maxVitaminB12 = default(double?), string? sort = default(string?), string? sortDirection = default(string?), int? offset = default(int?), int? number = default(int?), int operationIndex = 0)
        {
            apileague.Client.RequestOptions localVarRequestOptions = new apileague.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "FoodApi.SearchRecipesAPI";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<SearchRecipesAPI200Response>("/search-recipes", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("SearchRecipesAPI", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SearchRecipesAPI200Response</returns>
        public async System.Threading.Tasks.Task<SearchRecipesAPI200Response> SearchRecipesAPIAsync(string? query = default(string?), string? cuisines = default(string?), string? excludeCuisines = default(string?), string? mealType = default(string?), string? diet = default(string?), string? intolerances = default(string?), string? equipment = default(string?), string? includeIngredients = default(string?), string? excludeIngredients = default(string?), bool? fillIngredients = default(bool?), bool? addRecipeInformation = default(bool?), int? maxTime = default(int?), int? minServings = default(int?), int? maxServings = default(int?), double? minCalories = default(double?), double? maxCalories = default(double?), double? minCarbs = default(double?), double? maxCarbs = default(double?), double? minProtein = default(double?), double? maxProtein = default(double?), double? minFat = default(double?), double? maxFat = default(double?), double? minSugar = default(double?), double? maxSugar = default(double?), double? minFiber = default(double?), double? maxFiber = default(double?), double? minFolate = default(double?), double? maxFolate = default(double?), double? minFolicAcid = default(double?), double? maxFolicAcid = default(double?), double? minIodine = default(double?), double? maxIodine = default(double?), double? minIron = default(double?), double? maxIron = default(double?), double? minZinc = default(double?), double? maxZinc = default(double?), double? minMagnesium = default(double?), double? maxMagnesium = default(double?), double? minManganese = default(double?), double? maxManganese = default(double?), double? minPhosphorus = default(double?), double? maxPhosphorus = default(double?), double? minPotassium = default(double?), double? maxPotassium = default(double?), double? minSodium = default(double?), double? maxSodium = default(double?), double? minSelenium = default(double?), double? maxSelenium = default(double?), double? minCopper = default(double?), double? maxCopper = default(double?), double? minCalcium = default(double?), double? maxCalcium = default(double?), double? minCholine = default(double?), double? maxCholine = default(double?), double? minCholesterol = default(double?), double? maxCholesterol = default(double?), double? minFluoride = default(double?), double? maxFluoride = default(double?), double? minAlcohol = default(double?), double? maxAlcohol = default(double?), double? minCaffeine = default(double?), double? maxCaffeine = default(double?), double? minSaturatedFat = default(double?), double? maxSaturatedFat = default(double?), double? minVitaminA = default(double?), double? maxVitaminA = default(double?), double? minVitaminC = default(double?), double? maxVitaminC = default(double?), double? minVitaminD = default(double?), double? maxVitaminD = default(double?), double? minVitaminE = default(double?), double? maxVitaminE = default(double?), double? minVitaminK = default(double?), double? maxVitaminK = default(double?), double? minVitaminB1 = default(double?), double? maxVitaminB1 = default(double?), double? minVitaminB2 = default(double?), double? maxVitaminB2 = default(double?), double? minVitaminB3 = default(double?), double? maxVitaminB3 = default(double?), double? minVitaminB5 = default(double?), double? maxVitaminB5 = default(double?), double? minVitaminB6 = default(double?), double? maxVitaminB6 = default(double?), double? minVitaminB12 = default(double?), double? maxVitaminB12 = default(double?), string? sort = default(string?), string? sortDirection = default(string?), int? offset = default(int?), int? number = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            apileague.Client.ApiResponse<SearchRecipesAPI200Response> localVarResponse = await SearchRecipesAPIWithHttpInfoAsync(query, cuisines, excludeCuisines, mealType, diet, intolerances, equipment, includeIngredients, excludeIngredients, fillIngredients, addRecipeInformation, maxTime, minServings, maxServings, minCalories, maxCalories, minCarbs, maxCarbs, minProtein, maxProtein, minFat, maxFat, minSugar, maxSugar, minFiber, maxFiber, minFolate, maxFolate, minFolicAcid, maxFolicAcid, minIodine, maxIodine, minIron, maxIron, minZinc, maxZinc, minMagnesium, maxMagnesium, minManganese, maxManganese, minPhosphorus, maxPhosphorus, minPotassium, maxPotassium, minSodium, maxSodium, minSelenium, maxSelenium, minCopper, maxCopper, minCalcium, maxCalcium, minCholine, maxCholine, minCholesterol, maxCholesterol, minFluoride, maxFluoride, minAlcohol, maxAlcohol, minCaffeine, maxCaffeine, minSaturatedFat, maxSaturatedFat, minVitaminA, maxVitaminA, minVitaminC, maxVitaminC, minVitaminD, maxVitaminD, minVitaminE, maxVitaminE, minVitaminK, maxVitaminK, minVitaminB1, maxVitaminB1, minVitaminB2, maxVitaminB2, minVitaminB3, maxVitaminB3, minVitaminB5, maxVitaminB5, minVitaminB6, maxVitaminB6, minVitaminB12, maxVitaminB12, sort, sortDirection, offset, number, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SearchRecipesAPI200Response)</returns>
        public async System.Threading.Tasks.Task<apileague.Client.ApiResponse<SearchRecipesAPI200Response>> SearchRecipesAPIWithHttpInfoAsync(string? query = default(string?), string? cuisines = default(string?), string? excludeCuisines = default(string?), string? mealType = default(string?), string? diet = default(string?), string? intolerances = default(string?), string? equipment = default(string?), string? includeIngredients = default(string?), string? excludeIngredients = default(string?), bool? fillIngredients = default(bool?), bool? addRecipeInformation = default(bool?), int? maxTime = default(int?), int? minServings = default(int?), int? maxServings = default(int?), double? minCalories = default(double?), double? maxCalories = default(double?), double? minCarbs = default(double?), double? maxCarbs = default(double?), double? minProtein = default(double?), double? maxProtein = default(double?), double? minFat = default(double?), double? maxFat = default(double?), double? minSugar = default(double?), double? maxSugar = default(double?), double? minFiber = default(double?), double? maxFiber = default(double?), double? minFolate = default(double?), double? maxFolate = default(double?), double? minFolicAcid = default(double?), double? maxFolicAcid = default(double?), double? minIodine = default(double?), double? maxIodine = default(double?), double? minIron = default(double?), double? maxIron = default(double?), double? minZinc = default(double?), double? maxZinc = default(double?), double? minMagnesium = default(double?), double? maxMagnesium = default(double?), double? minManganese = default(double?), double? maxManganese = default(double?), double? minPhosphorus = default(double?), double? maxPhosphorus = default(double?), double? minPotassium = default(double?), double? maxPotassium = default(double?), double? minSodium = default(double?), double? maxSodium = default(double?), double? minSelenium = default(double?), double? maxSelenium = default(double?), double? minCopper = default(double?), double? maxCopper = default(double?), double? minCalcium = default(double?), double? maxCalcium = default(double?), double? minCholine = default(double?), double? maxCholine = default(double?), double? minCholesterol = default(double?), double? maxCholesterol = default(double?), double? minFluoride = default(double?), double? maxFluoride = default(double?), double? minAlcohol = default(double?), double? maxAlcohol = default(double?), double? minCaffeine = default(double?), double? maxCaffeine = default(double?), double? minSaturatedFat = default(double?), double? maxSaturatedFat = default(double?), double? minVitaminA = default(double?), double? maxVitaminA = default(double?), double? minVitaminC = default(double?), double? maxVitaminC = default(double?), double? minVitaminD = default(double?), double? maxVitaminD = default(double?), double? minVitaminE = default(double?), double? maxVitaminE = default(double?), double? minVitaminK = default(double?), double? maxVitaminK = default(double?), double? minVitaminB1 = default(double?), double? maxVitaminB1 = default(double?), double? minVitaminB2 = default(double?), double? maxVitaminB2 = default(double?), double? minVitaminB3 = default(double?), double? maxVitaminB3 = default(double?), double? minVitaminB5 = default(double?), double? maxVitaminB5 = default(double?), double? minVitaminB6 = default(double?), double? maxVitaminB6 = default(double?), double? minVitaminB12 = default(double?), double? maxVitaminB12 = default(double?), string? sort = default(string?), string? sortDirection = default(string?), int? offset = default(int?), int? number = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<SearchRecipesAPI200Response>("/search-recipes", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Search Restaurants API Search through thousands of restaurants (in North America) by location, cuisine, budget, and more.
        /// </summary>
        /// <exception cref="apileague.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="lat">The latitude to search around.</param>
        /// <param name="lon">The longitude to search around.</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>SearchRestaurantsAPI200Response</returns>
        public SearchRestaurantsAPI200Response SearchRestaurantsAPI(double lat, double lon, string? query = default(string?), int? distance = default(int?), double? budget = default(double?), double? minRating = default(double?), string? cuisine = default(string?), bool? isOpen = default(bool?), int? page = default(int?), string? sort = default(string?), int operationIndex = 0)
        {
            apileague.Client.ApiResponse<SearchRestaurantsAPI200Response> localVarResponse = SearchRestaurantsAPIWithHttpInfo(lat, lon, query, distance, budget, minRating, cuisine, isOpen, page, sort);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SearchRestaurantsAPI200Response</returns>
        public apileague.Client.ApiResponse<SearchRestaurantsAPI200Response> SearchRestaurantsAPIWithHttpInfo(double lat, double lon, string? query = default(string?), int? distance = default(int?), double? budget = default(double?), double? minRating = default(double?), string? cuisine = default(string?), bool? isOpen = default(bool?), int? page = default(int?), string? sort = default(string?), int operationIndex = 0)
        {
            apileague.Client.RequestOptions localVarRequestOptions = new apileague.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "FoodApi.SearchRestaurantsAPI";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<SearchRestaurantsAPI200Response>("/search-restaurants", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("SearchRestaurantsAPI", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SearchRestaurantsAPI200Response</returns>
        public async System.Threading.Tasks.Task<SearchRestaurantsAPI200Response> SearchRestaurantsAPIAsync(double lat, double lon, string? query = default(string?), int? distance = default(int?), double? budget = default(double?), double? minRating = default(double?), string? cuisine = default(string?), bool? isOpen = default(bool?), int? page = default(int?), string? sort = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            apileague.Client.ApiResponse<SearchRestaurantsAPI200Response> localVarResponse = await SearchRestaurantsAPIWithHttpInfoAsync(lat, lon, query, distance, budget, minRating, cuisine, isOpen, page, sort, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SearchRestaurantsAPI200Response)</returns>
        public async System.Threading.Tasks.Task<apileague.Client.ApiResponse<SearchRestaurantsAPI200Response>> SearchRestaurantsAPIWithHttpInfoAsync(double lat, double lon, string? query = default(string?), int? distance = default(int?), double? budget = default(double?), double? minRating = default(double?), string? cuisine = default(string?), bool? isOpen = default(bool?), int? page = default(int?), string? sort = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<SearchRestaurantsAPI200Response>("/search-restaurants", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
