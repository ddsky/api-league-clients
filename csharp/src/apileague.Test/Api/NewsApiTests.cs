...
namespace apileague.Test.Api
{
    ...
    public class NewsApiTests : IDisposable
    {
        ...
        public void SearchNewsTest()
        {
            ...
            //int? offset = null;
            //int? number = null;
            //var response = instance.SearchNews(text, sourceCountries, language, minSentiment, maxSentiment, earliestPublishDate, latestPublishDate, newsSources, authors, entities, locationFilter, sort, sortDirection, offset, number);
