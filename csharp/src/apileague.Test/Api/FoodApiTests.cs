...
namespace apileague.Test.Api
{
    ...
    public class FoodApiTests : IDisposable
    {
        ...
        public void SearchDrinksTest()
        {
            ...
            //int? offset = null;
            //int? number = null;
            //var response = instance.SearchDrinks(query, glassTypes, flavors, diet, includeIngredients, excludeIngredients, minCalories, maxCalories, minCarbs, maxCarbs, minProtein, maxProtein, minFat, maxFat, minAlcoholPercent, maxAlcoholPercent, minCaffeine, maxCaffeine, sort, sortDirection, offset, number);
            //Assert.IsType<SearchDrinks200Response>(response);
        }
