...
module Api.Data exposing
    ...
    , encodeFindSimilarGamesAPI200Response
    , encodeFindSimilarGamesAPI200ResponseResultsInner
    ...
    , encodeRetrieveGameById200Response
    , encodeRetrieveGameById200ResponseOffersInner
    , encodeRetrieveGameById200ResponseOffersInnerPrice
    , encodeRetrieveGameById200ResponseOfficialStoresInner
    , encodeRetrieveGameById200ResponsePlaytime
    , encodeRetrieveGameById200ResponseRating
    ...
    , encodeSearchGamesAPI200Response
    , encodeSearchGamesAPI200ResponseActiveFilterOptionsInner
    , encodeSearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner
    , encodeSearchGamesAPI200ResponseFilterOptionsInner
    , encodeSearchGamesAPI200ResponseFilterOptionsInnerValuesInner
    , encodeSearchGamesAPI200ResponseResultsInner
    , encodeSearchGamesAPI200ResponseResultsInnerPlatformsInner
    , encodeSearchGamesAPI200ResponseResultsInnerRating
    , encodeSearchGamesAPI200ResponseSortingOptionsInner
    ...
    , artSearchAPI200ResponseDecoder
    ...
    , findSimilarGamesAPI200ResponseDecoder
    , findSimilarGamesAPI200ResponseResultsInnerDecoder
    ...
    , retrieveGameById200ResponseDecoder
    , retrieveGameById200ResponseOffersInnerDecoder
    , retrieveGameById200ResponseOffersInnerPriceDecoder
    , retrieveGameById200ResponseOfficialStoresInnerDecoder
    , retrieveGameById200ResponsePlaytimeDecoder
    , retrieveGameById200ResponseRatingDecoder
    ...
    , searchGamesAPI200ResponseDecoder
    , searchGamesAPI200ResponseActiveFilterOptionsInnerDecoder
    , searchGamesAPI200ResponseActiveFilterOptionsInnerValuesInnerDecoder
    , searchGamesAPI200ResponseFilterOptionsInnerDecoder
    , searchGamesAPI200ResponseFilterOptionsInnerValuesInnerDecoder
    , searchGamesAPI200ResponseResultsInnerDecoder
    , searchGamesAPI200ResponseResultsInnerPlatformsInnerDecoder
    , searchGamesAPI200ResponseResultsInnerRatingDecoder
    , searchGamesAPI200ResponseSortingOptionsInnerDecoder
...
type alias ArtSearchAPI200Response =
    { available : Maybe Int
    , number : Maybe Int
    , offset : Maybe Int
    , artworks : Maybe ( List SearchBooksAPI200ResponseBooksInnerInner )
    }
...
type alias FindSimilarGamesAPI200Response =
    { results : Maybe ( List FindSimilarGamesAPI200ResponseResultsInner )
    }


type alias FindSimilarGamesAPI200ResponseResultsInner =
    { image : Maybe String
    ...
    , genre : Maybe String
    , link : Maybe String
    , rating : Maybe SearchGamesAPI200ResponseResultsInnerRating
    , id : Maybe Int
    , adultOnly : Maybe Bool
    , screenshots : Maybe ( List Maybe String )
...
type alias RetrieveGameById200Response =
    { id : Maybe Int
    , name : Maybe String
    , image : Maybe String
    , gameplay : Maybe String
    , link : Maybe String
    , xUrl : Maybe String
    , rating : Maybe RetrieveGameById200ResponseRating
    , description : Maybe String
    , shortDescription : Maybe String
    , releaseDate : Maybe String
    , developer : Maybe String
    , playtime : Maybe RetrieveGameById200ResponsePlaytime
    , platforms : Maybe ( List SearchGamesAPI200ResponseResultsInnerPlatformsInner )
    , tags : Maybe ( List Maybe String )
    , genres : Maybe ( List SearchGamesAPI200ResponseResultsInnerPlatformsInner )
    , genre : Maybe String
    , themes : Maybe ( List SearchGamesAPI200ResponseResultsInnerPlatformsInner )
    , adultOnly : Maybe Bool
    , playModes : Maybe ( List SearchGamesAPI200ResponseResultsInnerPlatformsInner )
    , screenshots : Maybe ( List Maybe String )
    , videos : Maybe ( List Maybe String )
    , offers : Maybe ( List RetrieveGameById200ResponseOffersInner )
    , officialStores : Maybe ( List RetrieveGameById200ResponseOfficialStoresInner )
    , microTrailer : Maybe String
    }


type alias RetrieveGameById200ResponseOffersInner =
    { storeName : Maybe String
    , title : Maybe String
    , price : Maybe RetrieveGameById200ResponseOffersInnerPrice
    , platform : Maybe String
    , url : Maybe String
    }


type alias RetrieveGameById200ResponseOffersInnerPrice =
    { currency : Maybe String
    , discountPercent : Maybe Int
    , value : Maybe Float
    , initial : Maybe Float
    }


type alias RetrieveGameById200ResponseOfficialStoresInner =
    { url : Maybe String
    , source : Maybe String
    }


type alias RetrieveGameById200ResponsePlaytime =
...
type alias RetrieveGameById200ResponseRating =
    { count : Maybe Int
...
type alias SearchGamesAPI200Response =
    { sorting : Maybe Object
    , activeFilterOptions : Maybe ( List SearchGamesAPI200ResponseActiveFilterOptionsInner )
    , query : Maybe String
    , totalResults : Maybe Int
    , limit : Maybe Int
    , offset : Maybe Int
    , results : Maybe ( List SearchGamesAPI200ResponseResultsInner )
    , filterOptions : Maybe ( List SearchGamesAPI200ResponseFilterOptionsInner )
    , sortingOptions : Maybe ( List SearchGamesAPI200ResponseSortingOptionsInner )
    }


type alias SearchGamesAPI200ResponseActiveFilterOptionsInner =
    { key : Maybe String
    , connection : Maybe String
    , values : Maybe ( List SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner )
    }


type alias SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner =
    { match : Maybe String
    , value : Maybe String
    }


type alias SearchGamesAPI200ResponseFilterOptionsInner =
    { name : Maybe String
    , filterType : Maybe String
    , key : Maybe String
    , values : Maybe ( List SearchGamesAPI200ResponseFilterOptionsInnerValuesInner )
    , filterConnection : Maybe String
    }


type alias SearchGamesAPI200ResponseFilterOptionsInnerValuesInner =
    { name : Maybe String
    , count : Maybe Int
    , key : Maybe String
    }
...
type alias SearchGamesAPI200ResponseResultsInner =
    { image : Maybe String
    , shortDescription : Maybe String
    , year : Maybe Int
    , link : Maybe String
...
type alias SearchGamesAPI200ResponseResultsInnerPlatformsInner =
    { name : Maybe String
    , value : Maybe String
    }


type alias SearchGamesAPI200ResponseResultsInnerRating =
    { count : Maybe Int
    , mean : Maybe Float
    }


type alias SearchGamesAPI200ResponseSortingOptionsInner =
    { name : Maybe String
    , key : Maybe String
    , sort : Maybe String
    }
...
encodeArtSearchAPI200Response : ArtSearchAPI200Response -> Json.Encode.Value
encodeArtSearchAPI200Response =
    encodeObject << encodeArtSearchAPI200ResponsePairs


encodeArtSearchAPI200ResponseWithTag : ( String, String ) -> ArtSearchAPI200Response -> Json.Encode.Value
encodeArtSearchAPI200ResponseWithTag (tagField, tag) model =
    encodeObject (encodeArtSearchAPI200ResponsePairs model ++ [ encode tagField Json.Encode.string tag ])


encodeArtSearchAPI200ResponsePairs : ArtSearchAPI200Response -> List EncodedField
encodeArtSearchAPI200ResponsePairs model =
    let
        pairs =
            ...
            , maybeEncode "artworks" (Json.Encode.list encodeSearchBooksAPI200ResponseBooksInnerInner) model.artworks
            ]
    in
    pairs
...
encodeFindSimilarGamesAPI200Response : FindSimilarGamesAPI200Response -> Json.Encode.Value
encodeFindSimilarGamesAPI200Response =
    encodeObject << encodeFindSimilarGamesAPI200ResponsePairs


encodeFindSimilarGamesAPI200ResponseWithTag : ( String, String ) -> FindSimilarGamesAPI200Response -> Json.Encode.Value
encodeFindSimilarGamesAPI200ResponseWithTag (tagField, tag) model =
    encodeObject (encodeFindSimilarGamesAPI200ResponsePairs model ++ [ encode tagField Json.Encode.string tag ])


encodeFindSimilarGamesAPI200ResponsePairs : FindSimilarGamesAPI200Response -> List EncodedField
encodeFindSimilarGamesAPI200ResponsePairs model =
    let
        pairs =
            [ maybeEncode "results" (Json.Encode.list encodeFindSimilarGamesAPI200ResponseResultsInner) model.results
            ]
    in
    pairs


encodeFindSimilarGamesAPI200ResponseResultsInner : FindSimilarGamesAPI200ResponseResultsInner -> Json.Encode.Value
encodeFindSimilarGamesAPI200ResponseResultsInner =
    encodeObject << encodeFindSimilarGamesAPI200ResponseResultsInnerPairs


encodeFindSimilarGamesAPI200ResponseResultsInnerWithTag : ( String, String ) -> FindSimilarGamesAPI200ResponseResultsInner -> Json.Encode.Value
encodeFindSimilarGamesAPI200ResponseResultsInnerWithTag (tagField, tag) model =
    encodeObject (encodeFindSimilarGamesAPI200ResponseResultsInnerPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeFindSimilarGamesAPI200ResponseResultsInnerPairs : FindSimilarGamesAPI200ResponseResultsInner -> List EncodedField
encodeFindSimilarGamesAPI200ResponseResultsInnerPairs model =
    let
        pairs =
            [ maybeEncodeNullable "image" Json.Encode.string model.image
            , maybeEncodeNullable "short_description" Json.Encode.string model.shortDescription
            , maybeEncodeNullable "micro_trailer" Json.Encode.string model.microTrailer
            , maybeEncode "year" Json.Encode.int model.year
            , maybeEncodeNullable "name" Json.Encode.string model.name
            , maybeEncodeNullable "genre" Json.Encode.string model.genre
            , maybeEncodeNullable "link" Json.Encode.string model.link
            , maybeEncode "rating" encodeSearchGamesAPI200ResponseResultsInnerRating model.rating
            , maybeEncode "id" Json.Encode.int model.id
            ...
            , maybeEncodeNullable "gameplay" Json.Encode.string model.gameplay
            ]
    in
    pairs
...
encodeRetrieveGameById200Response : RetrieveGameById200Response -> Json.Encode.Value
encodeRetrieveGameById200Response =
    encodeObject << encodeRetrieveGameById200ResponsePairs


encodeRetrieveGameById200ResponseWithTag : ( String, String ) -> RetrieveGameById200Response -> Json.Encode.Value
encodeRetrieveGameById200ResponseWithTag (tagField, tag) model =
    encodeObject (encodeRetrieveGameById200ResponsePairs model ++ [ encode tagField Json.Encode.string tag ])


encodeRetrieveGameById200ResponsePairs : RetrieveGameById200Response -> List EncodedField
encodeRetrieveGameById200ResponsePairs model =
    let
        pairs =
            [ maybeEncode "id" Json.Encode.int model.id
            , maybeEncodeNullable "name" Json.Encode.string model.name
            ...
            , maybeEncodeNullable "gameplay" Json.Encode.string model.gameplay
            , maybeEncodeNullable "link" Json.Encode.string model.link
            , maybeEncodeNullable "x_url" Json.Encode.string model.xUrl
            , maybeEncode "rating" encodeRetrieveGameById200ResponseRating model.rating
            , maybeEncodeNullable "description" Json.Encode.string model.description
            , maybeEncodeNullable "short_description" Json.Encode.string model.shortDescription
            , maybeEncodeNullable "release_date" Json.Encode.string model.releaseDate
            , maybeEncodeNullable "developer" Json.Encode.string model.developer
            , maybeEncode "playtime" encodeRetrieveGameById200ResponsePlaytime model.playtime
            , maybeEncode "platforms" (Json.Encode.list encodeSearchGamesAPI200ResponseResultsInnerPlatformsInner) model.platforms
            , maybeEncode "tags" (Json.Encode.list Json.Encode.string) model.tags
            , maybeEncode "genres" (Json.Encode.list encodeSearchGamesAPI200ResponseResultsInnerPlatformsInner) model.genres
            , maybeEncodeNullable "genre" Json.Encode.string model.genre
            , maybeEncode "themes" (Json.Encode.list encodeSearchGamesAPI200ResponseResultsInnerPlatformsInner) model.themes
            , maybeEncode "adult_only" Json.Encode.bool model.adultOnly
            , maybeEncode "play_modes" (Json.Encode.list encodeSearchGamesAPI200ResponseResultsInnerPlatformsInner) model.playModes
            , maybeEncode "screenshots" (Json.Encode.list Json.Encode.string) model.screenshots
            , maybeEncode "videos" (Json.Encode.list Json.Encode.string) model.videos
            , maybeEncode "offers" (Json.Encode.list encodeRetrieveGameById200ResponseOffersInner) model.offers
            , maybeEncode "official_stores" (Json.Encode.list encodeRetrieveGameById200ResponseOfficialStoresInner) model.officialStores
            , maybeEncodeNullable "micro_trailer" Json.Encode.string model.microTrailer
            ]
    in
    pairs
...
encodeRetrieveGameById200ResponseOffersInner : RetrieveGameById200ResponseOffersInner -> Json.Encode.Value
encodeRetrieveGameById200ResponseOffersInner =
    encodeObject << encodeRetrieveGameById200ResponseOffersInnerPairs


encodeRetrieveGameById200ResponseOffersInnerWithTag : ( String, String ) -> RetrieveGameById200ResponseOffersInner -> Json.Encode.Value
encodeRetrieveGameById200ResponseOffersInnerWithTag (tagField, tag) model =
    encodeObject (encodeRetrieveGameById200ResponseOffersInnerPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeRetrieveGameById200ResponseOffersInnerPairs : RetrieveGameById200ResponseOffersInner -> List EncodedField
encodeRetrieveGameById200ResponseOffersInnerPairs model =
    let
        pairs =
            [ maybeEncodeNullable "store_name" Json.Encode.string model.storeName
            , maybeEncodeNullable "title" Json.Encode.string model.title
            , maybeEncode "price" encodeRetrieveGameById200ResponseOffersInnerPrice model.price
            , maybeEncodeNullable "platform" Json.Encode.string model.platform
            , maybeEncodeNullable "url" Json.Encode.string model.url
            ]
    in
    pairs
...
encodeRetrieveGameById200ResponseOffersInnerPrice : RetrieveGameById200ResponseOffersInnerPrice -> Json.Encode.Value
encodeRetrieveGameById200ResponseOffersInnerPrice =
    encodeObject << encodeRetrieveGameById200ResponseOffersInnerPricePairs


encodeRetrieveGameById200ResponseOffersInnerPriceWithTag : ( String, String ) -> RetrieveGameById200ResponseOffersInnerPrice -> Json.Encode.Value
encodeRetrieveGameById200ResponseOffersInnerPriceWithTag (tagField, tag) model =
    encodeObject (encodeRetrieveGameById200ResponseOffersInnerPricePairs model ++ [ encode tagField Json.Encode.string tag ])


encodeRetrieveGameById200ResponseOffersInnerPricePairs : RetrieveGameById200ResponseOffersInnerPrice -> List EncodedField
encodeRetrieveGameById200ResponseOffersInnerPricePairs model =
    let
        pairs =
            [ maybeEncodeNullable "currency" Json.Encode.string model.currency
            , maybeEncode "discount_percent" Json.Encode.int model.discountPercent
...
encodeRetrieveGameById200ResponseOfficialStoresInner : RetrieveGameById200ResponseOfficialStoresInner -> Json.Encode.Value
encodeRetrieveGameById200ResponseOfficialStoresInner =
    encodeObject << encodeRetrieveGameById200ResponseOfficialStoresInnerPairs


encodeRetrieveGameById200ResponseOfficialStoresInnerWithTag : ( String, String ) -> RetrieveGameById200ResponseOfficialStoresInner -> Json.Encode.Value
encodeRetrieveGameById200ResponseOfficialStoresInnerWithTag (tagField, tag) model =
    encodeObject (encodeRetrieveGameById200ResponseOfficialStoresInnerPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeRetrieveGameById200ResponseOfficialStoresInnerPairs : RetrieveGameById200ResponseOfficialStoresInner -> List EncodedField
encodeRetrieveGameById200ResponseOfficialStoresInnerPairs model =
    let
        pairs =
            [ maybeEncodeNullable "url" Json.Encode.string model.url
            , maybeEncodeNullable "source" Json.Encode.string model.source
            ]
    in
    pairs


encodeRetrieveGameById200ResponsePlaytime : RetrieveGameById200ResponsePlaytime -> Json.Encode.Value
encodeRetrieveGameById200ResponsePlaytime =
    encodeObject << encodeRetrieveGameById200ResponsePlaytimePairs


encodeRetrieveGameById200ResponsePlaytimeWithTag : ( String, String ) -> RetrieveGameById200ResponsePlaytime -> Json.Encode.Value
encodeRetrieveGameById200ResponsePlaytimeWithTag (tagField, tag) model =
    encodeObject (encodeRetrieveGameById200ResponsePlaytimePairs model ++ [ encode tagField Json.Encode.string tag ])


encodeRetrieveGameById200ResponsePlaytimePairs : RetrieveGameById200ResponsePlaytime -> List EncodedField
encodeRetrieveGameById200ResponsePlaytimePairs model =
    let
        pairs =
...
encodeRetrieveGameById200ResponseRating : RetrieveGameById200ResponseRating -> Json.Encode.Value
encodeRetrieveGameById200ResponseRating =
    encodeObject << encodeRetrieveGameById200ResponseRatingPairs


encodeRetrieveGameById200ResponseRatingWithTag : ( String, String ) -> RetrieveGameById200ResponseRating -> Json.Encode.Value
encodeRetrieveGameById200ResponseRatingWithTag (tagField, tag) model =
    encodeObject (encodeRetrieveGameById200ResponseRatingPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeRetrieveGameById200ResponseRatingPairs : RetrieveGameById200ResponseRating -> List EncodedField
encodeRetrieveGameById200ResponseRatingPairs model =
    let
        pairs =
            [ maybeEncode "count" Json.Encode.int model.count
            , maybeEncode "count_critics" Json.Encode.int model.countCritics
            , maybeEncode "mean_players" Json.Encode.float model.meanPlayers
            , maybeEncode "mean_critics" Json.Encode.float model.meanCritics
            , maybeEncode "mean" Json.Encode.float model.mean
...
encodeSearchGamesAPI200Response : SearchGamesAPI200Response -> Json.Encode.Value
encodeSearchGamesAPI200Response =
    encodeObject << encodeSearchGamesAPI200ResponsePairs


encodeSearchGamesAPI200ResponseWithTag : ( String, String ) -> SearchGamesAPI200Response -> Json.Encode.Value
encodeSearchGamesAPI200ResponseWithTag (tagField, tag) model =
    encodeObject (encodeSearchGamesAPI200ResponsePairs model ++ [ encode tagField Json.Encode.string tag ])


encodeSearchGamesAPI200ResponsePairs : SearchGamesAPI200Response -> List EncodedField
encodeSearchGamesAPI200ResponsePairs model =
    let
        pairs =
            [ maybeEncode "sorting" encodeObject model.sorting
            , maybeEncode "active_filter_options" (Json.Encode.list encodeSearchGamesAPI200ResponseActiveFilterOptionsInner) model.activeFilterOptions
            , maybeEncodeNullable "query" Json.Encode.string model.query
            , maybeEncode "total_results" Json.Encode.int model.totalResults
            , maybeEncode "limit" Json.Encode.int model.limit
            , maybeEncode "offset" Json.Encode.int model.offset
            , maybeEncode "results" (Json.Encode.list encodeSearchGamesAPI200ResponseResultsInner) model.results
            , maybeEncode "filter_options" (Json.Encode.list encodeSearchGamesAPI200ResponseFilterOptionsInner) model.filterOptions
            , maybeEncode "sorting_options" (Json.Encode.list encodeSearchGamesAPI200ResponseSortingOptionsInner) model.sortingOptions
            ]
    in
    pairs


encodeSearchGamesAPI200ResponseActiveFilterOptionsInner : SearchGamesAPI200ResponseActiveFilterOptionsInner -> Json.Encode.Value
encodeSearchGamesAPI200ResponseActiveFilterOptionsInner =
    encodeObject << encodeSearchGamesAPI200ResponseActiveFilterOptionsInnerPairs


encodeSearchGamesAPI200ResponseActiveFilterOptionsInnerWithTag : ( String, String ) -> SearchGamesAPI200ResponseActiveFilterOptionsInner -> Json.Encode.Value
encodeSearchGamesAPI200ResponseActiveFilterOptionsInnerWithTag (tagField, tag) model =
    encodeObject (encodeSearchGamesAPI200ResponseActiveFilterOptionsInnerPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeSearchGamesAPI200ResponseActiveFilterOptionsInnerPairs : SearchGamesAPI200ResponseActiveFilterOptionsInner -> List EncodedField
encodeSearchGamesAPI200ResponseActiveFilterOptionsInnerPairs model =
    let
        pairs =
            [ maybeEncodeNullable "key" Json.Encode.string model.key
            , maybeEncodeNullable "connection" Json.Encode.string model.connection
            , maybeEncode "values" (Json.Encode.list encodeSearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner) model.values
            ]
    in
    pairs


encodeSearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner : SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner -> Json.Encode.Value
encodeSearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner =
    encodeObject << encodeSearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInnerPairs


encodeSearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInnerWithTag : ( String, String ) -> SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner -> Json.Encode.Value
encodeSearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInnerWithTag (tagField, tag) model =
    encodeObject (encodeSearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInnerPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeSearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInnerPairs : SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner -> List EncodedField
encodeSearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInnerPairs model =
    let
        pairs =
            [ maybeEncodeNullable "match" Json.Encode.string model.match
            , maybeEncodeNullable "value" Json.Encode.string model.value
            ]
    in
    pairs
...
encodeSearchGamesAPI200ResponseFilterOptionsInner : SearchGamesAPI200ResponseFilterOptionsInner -> Json.Encode.Value
encodeSearchGamesAPI200ResponseFilterOptionsInner =
    encodeObject << encodeSearchGamesAPI200ResponseFilterOptionsInnerPairs


encodeSearchGamesAPI200ResponseFilterOptionsInnerWithTag : ( String, String ) -> SearchGamesAPI200ResponseFilterOptionsInner -> Json.Encode.Value
encodeSearchGamesAPI200ResponseFilterOptionsInnerWithTag (tagField, tag) model =
    encodeObject (encodeSearchGamesAPI200ResponseFilterOptionsInnerPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeSearchGamesAPI200ResponseFilterOptionsInnerPairs : SearchGamesAPI200ResponseFilterOptionsInner -> List EncodedField
encodeSearchGamesAPI200ResponseFilterOptionsInnerPairs model =
    let
        pairs =
            [ maybeEncodeNullable "name" Json.Encode.string model.name
            , maybeEncodeNullable "filter_type" Json.Encode.string model.filterType
            , maybeEncodeNullable "key" Json.Encode.string model.key
            , maybeEncode "values" (Json.Encode.list encodeSearchGamesAPI200ResponseFilterOptionsInnerValuesInner) model.values
            , maybeEncodeNullable "filter_connection" Json.Encode.string model.filterConnection
            ]
    in
    pairs


encodeSearchGamesAPI200ResponseFilterOptionsInnerValuesInner : SearchGamesAPI200ResponseFilterOptionsInnerValuesInner -> Json.Encode.Value
encodeSearchGamesAPI200ResponseFilterOptionsInnerValuesInner =
    encodeObject << encodeSearchGamesAPI200ResponseFilterOptionsInnerValuesInnerPairs


encodeSearchGamesAPI200ResponseFilterOptionsInnerValuesInnerWithTag : ( String, String ) -> SearchGamesAPI200ResponseFilterOptionsInnerValuesInner -> Json.Encode.Value
encodeSearchGamesAPI200ResponseFilterOptionsInnerValuesInnerWithTag (tagField, tag) model =
    encodeObject (encodeSearchGamesAPI200ResponseFilterOptionsInnerValuesInnerPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeSearchGamesAPI200ResponseFilterOptionsInnerValuesInnerPairs : SearchGamesAPI200ResponseFilterOptionsInnerValuesInner -> List EncodedField
encodeSearchGamesAPI200ResponseFilterOptionsInnerValuesInnerPairs model =
    let
        pairs =
            [ maybeEncodeNullable "name" Json.Encode.string model.name
            , maybeEncode "count" Json.Encode.int model.count
...
encodeSearchGamesAPI200ResponseResultsInner : SearchGamesAPI200ResponseResultsInner -> Json.Encode.Value
encodeSearchGamesAPI200ResponseResultsInner =
    encodeObject << encodeSearchGamesAPI200ResponseResultsInnerPairs


encodeSearchGamesAPI200ResponseResultsInnerWithTag : ( String, String ) -> SearchGamesAPI200ResponseResultsInner -> Json.Encode.Value
encodeSearchGamesAPI200ResponseResultsInnerWithTag (tagField, tag) model =
    encodeObject (encodeSearchGamesAPI200ResponseResultsInnerPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeSearchGamesAPI200ResponseResultsInnerPairs : SearchGamesAPI200ResponseResultsInner -> List EncodedField
encodeSearchGamesAPI200ResponseResultsInnerPairs model =
    let
        pairs =
            [ maybeEncodeNullable "image" Json.Encode.string model.image
            , maybeEncodeNullable "short_description" Json.Encode.string model.shortDescription
...
encodeSearchGamesAPI200ResponseResultsInnerPlatformsInner : SearchGamesAPI200ResponseResultsInnerPlatformsInner -> Json.Encode.Value
encodeSearchGamesAPI200ResponseResultsInnerPlatformsInner =
    encodeObject << encodeSearchGamesAPI200ResponseResultsInnerPlatformsInnerPairs


encodeSearchGamesAPI200ResponseResultsInnerPlatformsInnerWithTag : ( String, String ) -> SearchGamesAPI200ResponseResultsInnerPlatformsInner -> Json.Encode.Value
encodeSearchGamesAPI200ResponseResultsInnerPlatformsInnerWithTag (tagField, tag) model =
    encodeObject (encodeSearchGamesAPI200ResponseResultsInnerPlatformsInnerPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeSearchGamesAPI200ResponseResultsInnerPlatformsInnerPairs : SearchGamesAPI200ResponseResultsInnerPlatformsInner -> List EncodedField
encodeSearchGamesAPI200ResponseResultsInnerPlatformsInnerPairs model =
    let
        pairs =
            [ maybeEncodeNullable "name" Json.Encode.string model.name
            , maybeEncodeNullable "value" Json.Encode.string model.value
...
encodeSearchGamesAPI200ResponseResultsInnerRating : SearchGamesAPI200ResponseResultsInnerRating -> Json.Encode.Value
encodeSearchGamesAPI200ResponseResultsInnerRating =
    encodeObject << encodeSearchGamesAPI200ResponseResultsInnerRatingPairs


encodeSearchGamesAPI200ResponseResultsInnerRatingWithTag : ( String, String ) -> SearchGamesAPI200ResponseResultsInnerRating -> Json.Encode.Value
encodeSearchGamesAPI200ResponseResultsInnerRatingWithTag (tagField, tag) model =
    encodeObject (encodeSearchGamesAPI200ResponseResultsInnerRatingPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeSearchGamesAPI200ResponseResultsInnerRatingPairs : SearchGamesAPI200ResponseResultsInnerRating -> List EncodedField
encodeSearchGamesAPI200ResponseResultsInnerRatingPairs model =
    let
        pairs =
            [ maybeEncode "count" Json.Encode.int model.count
            , maybeEncode "mean" Json.Encode.float model.mean
...
encodeSearchGamesAPI200ResponseSortingOptionsInner : SearchGamesAPI200ResponseSortingOptionsInner -> Json.Encode.Value
encodeSearchGamesAPI200ResponseSortingOptionsInner =
    encodeObject << encodeSearchGamesAPI200ResponseSortingOptionsInnerPairs


encodeSearchGamesAPI200ResponseSortingOptionsInnerWithTag : ( String, String ) -> SearchGamesAPI200ResponseSortingOptionsInner -> Json.Encode.Value
encodeSearchGamesAPI200ResponseSortingOptionsInnerWithTag (tagField, tag) model =
    encodeObject (encodeSearchGamesAPI200ResponseSortingOptionsInnerPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeSearchGamesAPI200ResponseSortingOptionsInnerPairs : SearchGamesAPI200ResponseSortingOptionsInner -> List EncodedField
encodeSearchGamesAPI200ResponseSortingOptionsInnerPairs model =
    let
        pairs =
            [ maybeEncodeNullable "name" Json.Encode.string model.name
            , maybeEncodeNullable "key" Json.Encode.string model.key
            , maybeEncodeNullable "sort" Json.Encode.string model.sort
            ]
    in
    pairs
...
artSearchAPI200ResponseDecoder : Json.Decode.Decoder ArtSearchAPI200Response
artSearchAPI200ResponseDecoder =
    Json.Decode.succeed ArtSearchAPI200Response
        ...
        |> maybeDecode "artworks" (Json.Decode.list searchBooksAPI200ResponseBooksInnerInnerDecoder) Nothing
...
findSimilarGamesAPI200ResponseDecoder : Json.Decode.Decoder FindSimilarGamesAPI200Response
findSimilarGamesAPI200ResponseDecoder =
    Json.Decode.succeed FindSimilarGamesAPI200Response
        |> maybeDecode "results" (Json.Decode.list findSimilarGamesAPI200ResponseResultsInnerDecoder) Nothing


findSimilarGamesAPI200ResponseResultsInnerDecoder : Json.Decode.Decoder FindSimilarGamesAPI200ResponseResultsInner
findSimilarGamesAPI200ResponseResultsInnerDecoder =
    Json.Decode.succeed FindSimilarGamesAPI200ResponseResultsInner
        |> maybeDecodeNullable "image" Json.Decode.string Nothing
        |> maybeDecodeNullable "short_description" Json.Decode.string Nothing
        |> maybeDecodeNullable "micro_trailer" Json.Decode.string Nothing
        |> maybeDecode "year" Json.Decode.int Nothing
        |> maybeDecodeNullable "name" Json.Decode.string Nothing
        |> maybeDecodeNullable "genre" Json.Decode.string Nothing
        |> maybeDecodeNullable "link" Json.Decode.string Nothing
        |> maybeDecode "rating" searchGamesAPI200ResponseResultsInnerRatingDecoder Nothing
        |> maybeDecode "id" Json.Decode.int Nothing
        |> maybeDecode "adult_only" Json.Decode.bool Nothing
        |> maybeDecode "screenshots" (Json.Decode.list Json.Decode.string) Nothing
        |> maybeDecodeNullable "gameplay" Json.Decode.string Nothing
...
retrieveGameById200ResponseDecoder : Json.Decode.Decoder RetrieveGameById200Response
retrieveGameById200ResponseDecoder =
    Json.Decode.succeed RetrieveGameById200Response
        |> maybeDecode "id" Json.Decode.int Nothing
        |> maybeDecodeNullable "name" Json.Decode.string Nothing
        |> maybeDecodeNullable "image" Json.Decode.string Nothing
        |> maybeDecodeNullable "gameplay" Json.Decode.string Nothing
        |> maybeDecodeNullable "link" Json.Decode.string Nothing
        |> maybeDecodeNullable "x_url" Json.Decode.string Nothing
        |> maybeDecode "rating" retrieveGameById200ResponseRatingDecoder Nothing
        |> maybeDecodeNullable "description" Json.Decode.string Nothing
        |> maybeDecodeNullable "short_description" Json.Decode.string Nothing
        |> maybeDecodeNullable "release_date" Json.Decode.string Nothing
        |> maybeDecodeNullable "developer" Json.Decode.string Nothing
        |> maybeDecode "playtime" retrieveGameById200ResponsePlaytimeDecoder Nothing
        |> maybeDecode "platforms" (Json.Decode.list searchGamesAPI200ResponseResultsInnerPlatformsInnerDecoder) Nothing
        |> maybeDecode "tags" (Json.Decode.list Json.Decode.string) Nothing
        |> maybeDecode "genres" (Json.Decode.list searchGamesAPI200ResponseResultsInnerPlatformsInnerDecoder) Nothing
        |> maybeDecodeNullable "genre" Json.Decode.string Nothing
        |> maybeDecode "themes" (Json.Decode.list searchGamesAPI200ResponseResultsInnerPlatformsInnerDecoder) Nothing
        |> maybeDecode "adult_only" Json.Decode.bool Nothing
        |> maybeDecode "play_modes" (Json.Decode.list searchGamesAPI200ResponseResultsInnerPlatformsInnerDecoder) Nothing
        |> maybeDecode "screenshots" (Json.Decode.list Json.Decode.string) Nothing
        |> maybeDecode "videos" (Json.Decode.list Json.Decode.string) Nothing
        |> maybeDecode "offers" (Json.Decode.list retrieveGameById200ResponseOffersInnerDecoder) Nothing
        |> maybeDecode "official_stores" (Json.Decode.list retrieveGameById200ResponseOfficialStoresInnerDecoder) Nothing
        |> maybeDecodeNullable "micro_trailer" Json.Decode.string Nothing


retrieveGameById200ResponseOffersInnerDecoder : Json.Decode.Decoder RetrieveGameById200ResponseOffersInner
retrieveGameById200ResponseOffersInnerDecoder =
    Json.Decode.succeed RetrieveGameById200ResponseOffersInner
        |> maybeDecodeNullable "store_name" Json.Decode.string Nothing
        |> maybeDecodeNullable "title" Json.Decode.string Nothing
        |> maybeDecode "price" retrieveGameById200ResponseOffersInnerPriceDecoder Nothing
        |> maybeDecodeNullable "platform" Json.Decode.string Nothing
        |> maybeDecodeNullable "url" Json.Decode.string Nothing


retrieveGameById200ResponseOffersInnerPriceDecoder : Json.Decode.Decoder RetrieveGameById200ResponseOffersInnerPrice
retrieveGameById200ResponseOffersInnerPriceDecoder =
    Json.Decode.succeed RetrieveGameById200ResponseOffersInnerPrice
        |> maybeDecodeNullable "currency" Json.Decode.string Nothing
        |> maybeDecode "discount_percent" Json.Decode.int Nothing
        |> maybeDecode "value" Json.Decode.float Nothing
        |> maybeDecode "initial" Json.Decode.float Nothing


retrieveGameById200ResponseOfficialStoresInnerDecoder : Json.Decode.Decoder RetrieveGameById200ResponseOfficialStoresInner
retrieveGameById200ResponseOfficialStoresInnerDecoder =
    Json.Decode.succeed RetrieveGameById200ResponseOfficialStoresInner
        |> maybeDecodeNullable "url" Json.Decode.string Nothing
        |> maybeDecodeNullable "source" Json.Decode.string Nothing


retrieveGameById200ResponsePlaytimeDecoder : Json.Decode.Decoder RetrieveGameById200ResponsePlaytime
retrieveGameById200ResponsePlaytimeDecoder =
    Json.Decode.succeed RetrieveGameById200ResponsePlaytime
...
retrieveGameById200ResponseRatingDecoder : Json.Decode.Decoder RetrieveGameById200ResponseRating
retrieveGameById200ResponseRatingDecoder =
    Json.Decode.succeed RetrieveGameById200ResponseRating
        |> maybeDecode "count" Json.Decode.int Nothing
        |> maybeDecode "count_critics" Json.Decode.int Nothing
        |> maybeDecode "mean_players" Json.Decode.float Nothing
        |> maybeDecode "mean_critics" Json.Decode.float Nothing
        |> maybeDecode "mean" Json.Decode.float Nothing
...
searchGamesAPI200ResponseDecoder : Json.Decode.Decoder SearchGamesAPI200Response
searchGamesAPI200ResponseDecoder =
    Json.Decode.succeed SearchGamesAPI200Response
        |> maybeDecode "sorting" objectDecoder Nothing
        |> maybeDecode "active_filter_options" (Json.Decode.list searchGamesAPI200ResponseActiveFilterOptionsInnerDecoder) Nothing
        |> maybeDecodeNullable "query" Json.Decode.string Nothing
        |> maybeDecode "total_results" Json.Decode.int Nothing
        |> maybeDecode "limit" Json.Decode.int Nothing
        |> maybeDecode "offset" Json.Decode.int Nothing
        |> maybeDecode "results" (Json.Decode.list searchGamesAPI200ResponseResultsInnerDecoder) Nothing
        |> maybeDecode "filter_options" (Json.Decode.list searchGamesAPI200ResponseFilterOptionsInnerDecoder) Nothing
        |> maybeDecode "sorting_options" (Json.Decode.list searchGamesAPI200ResponseSortingOptionsInnerDecoder) Nothing


searchGamesAPI200ResponseActiveFilterOptionsInnerDecoder : Json.Decode.Decoder SearchGamesAPI200ResponseActiveFilterOptionsInner
searchGamesAPI200ResponseActiveFilterOptionsInnerDecoder =
    Json.Decode.succeed SearchGamesAPI200ResponseActiveFilterOptionsInner
        |> maybeDecodeNullable "key" Json.Decode.string Nothing
        |> maybeDecodeNullable "connection" Json.Decode.string Nothing
        |> maybeDecode "values" (Json.Decode.list searchGamesAPI200ResponseActiveFilterOptionsInnerValuesInnerDecoder) Nothing


searchGamesAPI200ResponseActiveFilterOptionsInnerValuesInnerDecoder : Json.Decode.Decoder SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner
searchGamesAPI200ResponseActiveFilterOptionsInnerValuesInnerDecoder =
    Json.Decode.succeed SearchGamesAPI200ResponseActiveFilterOptionsInnerValuesInner
        |> maybeDecodeNullable "match" Json.Decode.string Nothing
        |> maybeDecodeNullable "value" Json.Decode.string Nothing


searchGamesAPI200ResponseFilterOptionsInnerDecoder : Json.Decode.Decoder SearchGamesAPI200ResponseFilterOptionsInner
searchGamesAPI200ResponseFilterOptionsInnerDecoder =
    Json.Decode.succeed SearchGamesAPI200ResponseFilterOptionsInner
        |> maybeDecodeNullable "name" Json.Decode.string Nothing
        |> maybeDecodeNullable "filter_type" Json.Decode.string Nothing
        |> maybeDecodeNullable "key" Json.Decode.string Nothing
        |> maybeDecode "values" (Json.Decode.list searchGamesAPI200ResponseFilterOptionsInnerValuesInnerDecoder) Nothing
        |> maybeDecodeNullable "filter_connection" Json.Decode.string Nothing


searchGamesAPI200ResponseFilterOptionsInnerValuesInnerDecoder : Json.Decode.Decoder SearchGamesAPI200ResponseFilterOptionsInnerValuesInner
searchGamesAPI200ResponseFilterOptionsInnerValuesInnerDecoder =
    Json.Decode.succeed SearchGamesAPI200ResponseFilterOptionsInnerValuesInner
        |> maybeDecodeNullable "name" Json.Decode.string Nothing
        |> maybeDecode "count" Json.Decode.int Nothing
        |> maybeDecodeNullable "key" Json.Decode.string Nothing


searchGamesAPI200ResponseResultsInnerDecoder : Json.Decode.Decoder SearchGamesAPI200ResponseResultsInner
searchGamesAPI200ResponseResultsInnerDecoder =
    Json.Decode.succeed SearchGamesAPI200ResponseResultsInner
        |> maybeDecodeNullable "image" Json.Decode.string Nothing
        |> maybeDecodeNullable "short_description" Json.Decode.string Nothing
        |> maybeDecode "year" Json.Decode.int Nothing
        |> maybeDecodeNullable "link" Json.Decode.string Nothing
...
searchGamesAPI200ResponseResultsInnerPlatformsInnerDecoder : Json.Decode.Decoder SearchGamesAPI200ResponseResultsInnerPlatformsInner
searchGamesAPI200ResponseResultsInnerPlatformsInnerDecoder =
    Json.Decode.succeed SearchGamesAPI200ResponseResultsInnerPlatformsInner
        |> maybeDecodeNullable "name" Json.Decode.string Nothing
        |> maybeDecodeNullable "value" Json.Decode.string Nothing


searchGamesAPI200ResponseResultsInnerRatingDecoder : Json.Decode.Decoder SearchGamesAPI200ResponseResultsInnerRating
searchGamesAPI200ResponseResultsInnerRatingDecoder =
    Json.Decode.succeed SearchGamesAPI200ResponseResultsInnerRating
        |> maybeDecode "count" Json.Decode.int Nothing
        |> maybeDecode "mean" Json.Decode.float Nothing


searchGamesAPI200ResponseSortingOptionsInnerDecoder : Json.Decode.Decoder SearchGamesAPI200ResponseSortingOptionsInner
searchGamesAPI200ResponseSortingOptionsInnerDecoder =
    Json.Decode.succeed SearchGamesAPI200ResponseSortingOptionsInner
        |> maybeDecodeNullable "name" Json.Decode.string Nothing
        |> maybeDecodeNullable "key" Json.Decode.string Nothing
        |> maybeDecodeNullable "sort" Json.Decode.string Nothing
