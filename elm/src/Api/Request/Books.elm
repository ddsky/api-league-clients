...
-}
findSimilarBooksAPI : Int -> Maybe Int -> Api.Request Api.Data.FindSimilarBooksAPI200Response
findSimilarBooksAPI id_query number_query =
    Api.request
        "GET"
        "/list-similar-books"
        []
        [ ( "id", Just <| String.fromInt id_query ), ( "number", Maybe.map String.fromInt number_query ) ]
        []
        Nothing
        Api.Data.findSimilarBooksAPI200ResponseDecoder
...
-}
searchBooksAPI : Maybe String -> Maybe Int -> Maybe Int -> Maybe Float -> Maybe Float -> Maybe String -> Maybe String -> Maybe String -> Maybe String -> Maybe String -> Maybe String -> Maybe Bool -> Maybe Int -> Maybe Int -> Api.Request Api.Data.SearchBooksAPI200Response
searchBooksAPI query_query earliestPublishYear_query latestPublishYear_query minRating_query maxRating_query genres_query authors_query isbn_query oclc_query sort_query sortDirection_query groupResults_query offset_query number_query =
    Api.request
        "GET"
        "/search-books"
        []
        ...
        []
        Nothing
        Api.Data.searchBooksAPI200ResponseDecoder
