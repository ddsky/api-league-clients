...
-}
rescaleImage : String -> Int -> Int -> Bool -> Api.Request File
...
-}
searchIcons : String -> Maybe Bool -> Maybe Int -> Api.Request Api.Data.SearchIcons200Response
searchIcons query_query onlyPublicDomain_query number_query =
    Api.request
        "GET"
        "/search-icons"
        []
        ...
        []
        Nothing
        Api.Data.searchIcons200ResponseDecoder
