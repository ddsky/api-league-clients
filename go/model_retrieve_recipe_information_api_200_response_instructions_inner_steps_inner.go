...
// checks if the RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner{}

// RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner struct for RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner
type RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner struct {
	...
	Equipment []SearchDrinksAPI200ResponseDrinksInnerInstructionsInnerStepsInnerIngredientsInner `json:"equipment,omitempty"`
...
func NewRetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner() *RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner {
	this := RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner{}
	return &this
}
...
// SetEquipment gets a reference to the given []SearchDrinksAPI200ResponseDrinksInnerInstructionsInnerStepsInnerIngredientsInner and assigns it to the Equipment field.
...
func (o *RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner) SetStepNil() {
	o.Step.Set(nil)
}
...
func (o RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner) MarshalJSON() ([]byte, error) {
...
func (o RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner) ToMap() (map[string]interface{}, error) {
...
type NullableRetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner struct {
	value *RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner
	isSet bool
}

func (v NullableRetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner) Get() *RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner {
	return v.value
}

func (v *NullableRetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner) Set(val *RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableRetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableRetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner(val *RetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner) *NullableRetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner {
	return &NullableRetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner{value: val, isSet: true}
}

func (v NullableRetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRetrieveRecipeInformationAPI200ResponseInstructionsInnerStepsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
