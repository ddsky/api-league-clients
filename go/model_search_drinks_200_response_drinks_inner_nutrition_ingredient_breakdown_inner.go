...
// checks if the SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner{}

// SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner struct for SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner
type SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner struct {
	Name NullableString `json:"name,omitempty"`
	Amount *int32 `json:"amount,omitempty"`
	Unit NullableString `json:"unit,omitempty"`
	Id *int32 `json:"id,omitempty"`
	Nutrients []SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInnerNutrientsInner `json:"nutrients,omitempty"`
}
...
func NewSearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner() *SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner {
	this := SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner{}
	return &this
}
...
func (o *SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner) SetUnitNil() {
	o.Unit.Set(nil)
}
...
func (o *SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner) GetNutrients() []SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInnerNutrientsInner {
	if o == nil || IsNil(o.Nutrients) {
		var ret []SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInnerNutrientsInner
		return ret
	}
	return o.Nutrients
}
...
// SetNutrients gets a reference to the given []SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInnerNutrientsInner and assigns it to the Nutrients field.
...
func (o SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner) MarshalJSON() ([]byte, error) {
...
func (o SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner) ToMap() (map[string]interface{}, error) {
...
type NullableSearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner struct {
	value *SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner
	isSet bool
}

func (v NullableSearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner) Get() *SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner {
	return v.value
}

func (v *NullableSearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner) Set(val *SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner(val *SearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner) *NullableSearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner {
	return &NullableSearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner{value: val, isSet: true}
}

func (v NullableSearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchDrinks200ResponseDrinksInnerNutritionIngredientBreakdownInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
