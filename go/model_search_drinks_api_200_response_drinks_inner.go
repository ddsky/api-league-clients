...
// checks if the SearchDrinksAPI200ResponseDrinksInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchDrinksAPI200ResponseDrinksInner{}

// SearchDrinksAPI200ResponseDrinksInner struct for SearchDrinksAPI200ResponseDrinksInner
type SearchDrinksAPI200ResponseDrinksInner struct {
	Flavors []*string `json:"flavors,omitempty"`
	Instructions []SearchDrinksAPI200ResponseDrinksInnerInstructionsInner `json:"instructions,omitempty"`
	Images []*string `json:"images,omitempty"`
	Nutrition *SearchDrinksAPI200ResponseDrinksInnerNutrition `json:"nutrition,omitempty"`
	GlassType NullableString `json:"glass_type,omitempty"`
	Credits *SearchDrinksAPI200ResponseDrinksInnerCredits `json:"credits,omitempty"`
	PricePerServing *float32 `json:"price_per_serving,omitempty"`
	Description NullableString `json:"description,omitempty"`
	Ingredients []SearchDrinksAPI200ResponseDrinksInnerIngredientsInner `json:"ingredients,omitempty"`
...
func NewSearchDrinksAPI200ResponseDrinksInner() *SearchDrinksAPI200ResponseDrinksInner {
	this := SearchDrinksAPI200ResponseDrinksInner{}
	return &this
}
...
func (o *SearchDrinksAPI200ResponseDrinksInner) GetInstructions() []SearchDrinksAPI200ResponseDrinksInnerInstructionsInner {
	if o == nil || IsNil(o.Instructions) {
		var ret []SearchDrinksAPI200ResponseDrinksInnerInstructionsInner
		return ret
	}
...
// SetInstructions gets a reference to the given []SearchDrinksAPI200ResponseDrinksInnerInstructionsInner and assigns it to the Instructions field.
...
func (o *SearchDrinksAPI200ResponseDrinksInner) GetNutrition() SearchDrinksAPI200ResponseDrinksInnerNutrition {
	if o == nil || IsNil(o.Nutrition) {
		var ret SearchDrinksAPI200ResponseDrinksInnerNutrition
		return ret
	}
	return *o.Nutrition
}
...
// SetNutrition gets a reference to the given SearchDrinksAPI200ResponseDrinksInnerNutrition and assigns it to the Nutrition field.
...
func (o *SearchDrinksAPI200ResponseDrinksInner) SetGlassTypeNil() {
	o.GlassType.Set(nil)
}
...
func (o *SearchDrinksAPI200ResponseDrinksInner) GetCredits() SearchDrinksAPI200ResponseDrinksInnerCredits {
	if o == nil || IsNil(o.Credits) {
		var ret SearchDrinksAPI200ResponseDrinksInnerCredits
		return ret
	}
	return *o.Credits
}
...
// SetCredits gets a reference to the given SearchDrinksAPI200ResponseDrinksInnerCredits and assigns it to the Credits field.
...
func (o *SearchDrinksAPI200ResponseDrinksInner) SetDescriptionNil() {
...
func (o *SearchDrinksAPI200ResponseDrinksInner) GetIngredients() []SearchDrinksAPI200ResponseDrinksInnerIngredientsInner {
	if o == nil || IsNil(o.Ingredients) {
		var ret []SearchDrinksAPI200ResponseDrinksInnerIngredientsInner
		return ret
	}
...
// SetIngredients gets a reference to the given []SearchDrinksAPI200ResponseDrinksInnerIngredientsInner and assigns it to the Ingredients field.
...
func (o *SearchDrinksAPI200ResponseDrinksInner) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o SearchDrinksAPI200ResponseDrinksInner) MarshalJSON() ([]byte, error) {
...
func (o SearchDrinksAPI200ResponseDrinksInner) ToMap() (map[string]interface{}, error) {
...
type NullableSearchDrinksAPI200ResponseDrinksInner struct {
	value *SearchDrinksAPI200ResponseDrinksInner
	isSet bool
}

func (v NullableSearchDrinksAPI200ResponseDrinksInner) Get() *SearchDrinksAPI200ResponseDrinksInner {
	return v.value
}

func (v *NullableSearchDrinksAPI200ResponseDrinksInner) Set(val *SearchDrinksAPI200ResponseDrinksInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchDrinksAPI200ResponseDrinksInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchDrinksAPI200ResponseDrinksInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchDrinksAPI200ResponseDrinksInner(val *SearchDrinksAPI200ResponseDrinksInner) *NullableSearchDrinksAPI200ResponseDrinksInner {
	return &NullableSearchDrinksAPI200ResponseDrinksInner{value: val, isSet: true}
}

func (v NullableSearchDrinksAPI200ResponseDrinksInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchDrinksAPI200ResponseDrinksInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
