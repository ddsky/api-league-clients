...
// checks if the SearchDrinks200ResponseDrinksInnerIngredientsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchDrinks200ResponseDrinksInnerIngredientsInner{}

// SearchDrinks200ResponseDrinksInnerIngredientsInner struct for SearchDrinks200ResponseDrinksInnerIngredientsInner
type SearchDrinks200ResponseDrinksInnerIngredientsInner struct {
	Image NullableString `json:"image,omitempty"`
	NameClean NullableString `json:"name_clean,omitempty"`
	Amount *int32 `json:"amount,omitempty"`
	Unit NullableString `json:"unit,omitempty"`
	Measures *SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasures `json:"measures,omitempty"`
...
func NewSearchDrinks200ResponseDrinksInnerIngredientsInner() *SearchDrinks200ResponseDrinksInnerIngredientsInner {
	this := SearchDrinks200ResponseDrinksInnerIngredientsInner{}
	return &this
}
...
func (o *SearchDrinks200ResponseDrinksInnerIngredientsInner) GetImageOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SearchDrinks200ResponseDrinksInnerIngredientsInner) SetImageNil() {
	o.Image.Set(nil)
}
...
func (o *SearchDrinks200ResponseDrinksInnerIngredientsInner) SetNameCleanNil() {
	o.NameClean.Set(nil)
}
...
func (o *SearchDrinks200ResponseDrinksInnerIngredientsInner) SetUnitNil() {
	o.Unit.Set(nil)
}
...
func (o *SearchDrinks200ResponseDrinksInnerIngredientsInner) GetMeasures() SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasures {
	if o == nil || IsNil(o.Measures) {
		var ret SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasures
		return ret
	}
	return *o.Measures
}
...
// SetMeasures gets a reference to the given SearchDrinks200ResponseDrinksInnerIngredientsInnerMeasures and assigns it to the Measures field.
...
func (o *SearchDrinks200ResponseDrinksInnerIngredientsInner) SetOriginalNil() {
	o.Original.Set(nil)
}
...
func (o *SearchDrinks200ResponseDrinksInnerIngredientsInner) SetOriginalName(v string) {
	o.OriginalName.Set(&v)
}
// SetOriginalNameNil sets the value for OriginalName to be an explicit nil
func (o *SearchDrinks200ResponseDrinksInnerIngredientsInner) SetOriginalNameNil() {
...
func (o *SearchDrinks200ResponseDrinksInnerIngredientsInner) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *SearchDrinks200ResponseDrinksInnerIngredientsInner) GetId() int32 {
	if o == nil || IsNil(o.Id) {
		var ret int32
		return ret
	}
...
func (o *SearchDrinks200ResponseDrinksInnerIngredientsInner) SetAisleNil() {
	o.Aisle.Set(nil)
}
...
func (o *SearchDrinks200ResponseDrinksInnerIngredientsInner) SetConsistencyNil() {
...
func (o SearchDrinks200ResponseDrinksInnerIngredientsInner) MarshalJSON() ([]byte, error) {
...
func (o SearchDrinks200ResponseDrinksInnerIngredientsInner) ToMap() (map[string]interface{}, error) {
...
type NullableSearchDrinks200ResponseDrinksInnerIngredientsInner struct {
	value *SearchDrinks200ResponseDrinksInnerIngredientsInner
	isSet bool
}

func (v NullableSearchDrinks200ResponseDrinksInnerIngredientsInner) Get() *SearchDrinks200ResponseDrinksInnerIngredientsInner {
	return v.value
}

func (v *NullableSearchDrinks200ResponseDrinksInnerIngredientsInner) Set(val *SearchDrinks200ResponseDrinksInnerIngredientsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchDrinks200ResponseDrinksInnerIngredientsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchDrinks200ResponseDrinksInnerIngredientsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchDrinks200ResponseDrinksInnerIngredientsInner(val *SearchDrinks200ResponseDrinksInnerIngredientsInner) *NullableSearchDrinks200ResponseDrinksInnerIngredientsInner {
	return &NullableSearchDrinks200ResponseDrinksInnerIngredientsInner{value: val, isSet: true}
}

func (v NullableSearchDrinks200ResponseDrinksInnerIngredientsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchDrinks200ResponseDrinksInnerIngredientsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
