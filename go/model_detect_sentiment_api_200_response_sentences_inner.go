...
// checks if the DetectSentimentAPI200ResponseSentencesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetectSentimentAPI200ResponseSentencesInner{}

// DetectSentimentAPI200ResponseSentencesInner struct for DetectSentimentAPI200ResponseSentencesInner
type DetectSentimentAPI200ResponseSentencesInner struct {
...
func NewDetectSentimentAPI200ResponseSentencesInner() *DetectSentimentAPI200ResponseSentencesInner {
	this := DetectSentimentAPI200ResponseSentencesInner{}
	return &this
}
...
func (o *DetectSentimentAPI200ResponseSentencesInner) SetSentimentNil() {
	o.Sentiment.Set(nil)
}
...
func (o DetectSentimentAPI200ResponseSentencesInner) MarshalJSON() ([]byte, error) {
...
func (o DetectSentimentAPI200ResponseSentencesInner) ToMap() (map[string]interface{}, error) {
...
type NullableDetectSentimentAPI200ResponseSentencesInner struct {
	value *DetectSentimentAPI200ResponseSentencesInner
	isSet bool
}

func (v NullableDetectSentimentAPI200ResponseSentencesInner) Get() *DetectSentimentAPI200ResponseSentencesInner {
	return v.value
}

func (v *NullableDetectSentimentAPI200ResponseSentencesInner) Set(val *DetectSentimentAPI200ResponseSentencesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDetectSentimentAPI200ResponseSentencesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDetectSentimentAPI200ResponseSentencesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDetectSentimentAPI200ResponseSentencesInner(val *DetectSentimentAPI200ResponseSentencesInner) *NullableDetectSentimentAPI200ResponseSentencesInner {
	return &NullableDetectSentimentAPI200ResponseSentencesInner{value: val, isSet: true}
}

func (v NullableDetectSentimentAPI200ResponseSentencesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDetectSentimentAPI200ResponseSentencesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
