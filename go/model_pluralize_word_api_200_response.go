...
// checks if the PluralizeWordAPI200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PluralizeWordAPI200Response{}

// PluralizeWordAPI200Response struct for PluralizeWordAPI200Response
type PluralizeWordAPI200Response struct {
...
func NewPluralizeWordAPI200Response() *PluralizeWordAPI200Response {
	this := PluralizeWordAPI200Response{}
	return &this
}
...
func (o *PluralizeWordAPI200Response) SetOriginalNil() {
	o.Original.Set(nil)
}
...
func (o *PluralizeWordAPI200Response) SetPluralNil() {
	o.Plural.Set(nil)
}
...
func (o PluralizeWordAPI200Response) MarshalJSON() ([]byte, error) {
...
func (o PluralizeWordAPI200Response) ToMap() (map[string]interface{}, error) {
...
type NullablePluralizeWordAPI200Response struct {
	value *PluralizeWordAPI200Response
	isSet bool
}

func (v NullablePluralizeWordAPI200Response) Get() *PluralizeWordAPI200Response {
	return v.value
}

func (v *NullablePluralizeWordAPI200Response) Set(val *PluralizeWordAPI200Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePluralizeWordAPI200Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePluralizeWordAPI200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePluralizeWordAPI200Response(val *PluralizeWordAPI200Response) *NullablePluralizeWordAPI200Response {
	return &NullablePluralizeWordAPI200Response{value: val, isSet: true}
}

func (v NullablePluralizeWordAPI200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePluralizeWordAPI200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
