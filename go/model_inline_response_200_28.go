...
type InlineResponse20028 struct {
	Images []InlineResponse20028Images `json:"images,omitempty"`
}
...
func (o *InlineResponse20028) GetImages() []InlineResponse20028Images {
	if o == nil || o.Images == nil {
		var ret []InlineResponse20028Images
		return ret
	}
	return o.Images
}
...
// SetImages gets a reference to the given []InlineResponse20028Images and assigns it to the Images field.
