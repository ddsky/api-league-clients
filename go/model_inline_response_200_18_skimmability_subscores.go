...
// InlineResponse20018SkimmabilitySubscores struct for InlineResponse20018SkimmabilitySubscores
type InlineResponse20018SkimmabilitySubscores struct {
...
func NewInlineResponse20018SkimmabilitySubscores() *InlineResponse20018SkimmabilitySubscores {
	this := InlineResponse20018SkimmabilitySubscores{}
	return &this
}
...
func (o *InlineResponse20018SkimmabilitySubscores) SetBulletPointRatioScore(v []int32) {
...
func (o InlineResponse20018SkimmabilitySubscores) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20018SkimmabilitySubscores struct {
	value *InlineResponse20018SkimmabilitySubscores
	isSet bool
}

func (v NullableInlineResponse20018SkimmabilitySubscores) Get() *InlineResponse20018SkimmabilitySubscores {
	return v.value
}

func (v *NullableInlineResponse20018SkimmabilitySubscores) Set(val *InlineResponse20018SkimmabilitySubscores) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20018SkimmabilitySubscores) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20018SkimmabilitySubscores) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20018SkimmabilitySubscores(val *InlineResponse20018SkimmabilitySubscores) *NullableInlineResponse20018SkimmabilitySubscores {
	return &NullableInlineResponse20018SkimmabilitySubscores{value: val, isSet: true}
}

func (v NullableInlineResponse20018SkimmabilitySubscores) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20018SkimmabilitySubscores) UnmarshalJSON(src []byte) error {
	v.isSet = true
