...
func (r ApiConvertUnitsRequest) Execute() (*InlineResponse20030, *http.Response, error) {
...
func (a *MathApiService) ConvertUnitsExecute(r ApiConvertUnitsRequest) (*InlineResponse20030, *http.Response, error) {
	var (
	...
	localVarQueryParams.Add("source-amount", parameterToString(*r.sourceAmount, ""))
	localVarQueryParams.Add("source-unit", parameterToString(*r.sourceUnit, ""))
	localVarQueryParams.Add("target-unit", parameterToString(*r.targetUnit, ""))
	if r.foodName != nil {
		localVarQueryParams.Add("food-name", parameterToString(*r.foodName, ""))
	}
