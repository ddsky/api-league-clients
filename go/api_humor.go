...
func (r ApiGenerateNonsenseWordRequest) Execute() (*InlineResponse2008, *http.Response, error) {
...
func (a *HumorApiService) GenerateNonsenseWordExecute(r ApiGenerateNonsenseWordRequest) (*InlineResponse2008, *http.Response, error) {
	var (
...
func (r ApiRandomJokeRequest) Execute() (*InlineResponse2004Jokes, *http.Response, error) {
...
func (a *HumorApiService) RandomJokeExecute(r ApiRandomJokeRequest) (*InlineResponse2004Jokes, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *InlineResponse2004Jokes
	)
...
func (r ApiRandomMemeRequest) Execute() (*InlineResponse2006, *http.Response, error) {
...
func (a *HumorApiService) RandomMemeExecute(r ApiRandomMemeRequest) (*InlineResponse2006, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if r.maxAgeDays != nil {
		localVarQueryParams.Add("max-age-days", parameterToString(*r.maxAgeDays, ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiSearchGifsRequest) Execute() (*InlineResponse2007, *http.Response, error) {
...
func (a *HumorApiService) SearchGifsExecute(r ApiSearchGifsRequest) (*InlineResponse2007, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiSearchJokesRequest) Execute() (*InlineResponse2004, *http.Response, error) {
...
func (a *HumorApiService) SearchJokesExecute(r ApiSearchJokesRequest) (*InlineResponse2004, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiSearchMemesRequest) Execute() (*InlineResponse2005, *http.Response, error) {
...
func (a *HumorApiService) SearchMemesExecute(r ApiSearchMemesRequest) (*InlineResponse2005, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
