...
// checks if the SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner{}

// SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner struct for SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner
type SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner struct {
...
func NewSearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner() *SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner {
	this := SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner{}
	return &this
}
...
func (o *SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner) SetUnitNil() {
	o.Unit.Set(nil)
}
...
func (o SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner) MarshalJSON() ([]byte, error) {
...
func (o SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner) ToMap() (map[string]interface{}, error) {
...
type NullableSearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner struct {
	value *SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner
	isSet bool
}

func (v NullableSearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner) Get() *SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner {
	return v.value
}

func (v *NullableSearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner) Set(val *SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner(val *SearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner) *NullableSearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner {
	return &NullableSearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner{value: val, isSet: true}
}

func (v NullableSearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchDrinksAPI200ResponseDrinksInnerNutritionNutrientsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
