...
func (r ApiDetectMainImageColorRequest) Execute() ([]InlineResponse20029, *http.Response, error) {
...
func (a *MediaApiService) DetectMainImageColorExecute(r ApiDetectMainImageColorRequest) ([]InlineResponse20029, *http.Response, error) {
	var (
...
func (a *MediaApiService) RescaleImageExecute(r ApiRescaleImageRequest) (map[string]interface{}, *http.Response, error) {
	...
	localVarQueryParams.Add("crop", parameterToString(*r.crop, ""))
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiSearchRoyaltyFreeImagesRequest) Execute() (*InlineResponse20028, *http.Response, error) {
...
func (a *MediaApiService) SearchRoyaltyFreeImagesExecute(r ApiSearchRoyaltyFreeImagesRequest) (*InlineResponse20028, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
