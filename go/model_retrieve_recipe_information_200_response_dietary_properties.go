...
// checks if the RetrieveRecipeInformation200ResponseDietaryProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RetrieveRecipeInformation200ResponseDietaryProperties{}

// RetrieveRecipeInformation200ResponseDietaryProperties struct for RetrieveRecipeInformation200ResponseDietaryProperties
type RetrieveRecipeInformation200ResponseDietaryProperties struct {
...
func NewRetrieveRecipeInformation200ResponseDietaryProperties() *RetrieveRecipeInformation200ResponseDietaryProperties {
	this := RetrieveRecipeInformation200ResponseDietaryProperties{}
	return &this
}
...
func (o *RetrieveRecipeInformation200ResponseDietaryProperties) HasVegan() bool {
	if o != nil && !IsNil(o.Vegan) {
		return true
	}
...
func (o *RetrieveRecipeInformation200ResponseDietaryProperties) SetGapsNil() {
	o.Gaps.Set(nil)
}
...
func (o RetrieveRecipeInformation200ResponseDietaryProperties) MarshalJSON() ([]byte, error) {
...
func (o RetrieveRecipeInformation200ResponseDietaryProperties) ToMap() (map[string]interface{}, error) {
...
type NullableRetrieveRecipeInformation200ResponseDietaryProperties struct {
	value *RetrieveRecipeInformation200ResponseDietaryProperties
	isSet bool
}

func (v NullableRetrieveRecipeInformation200ResponseDietaryProperties) Get() *RetrieveRecipeInformation200ResponseDietaryProperties {
	return v.value
}

func (v *NullableRetrieveRecipeInformation200ResponseDietaryProperties) Set(val *RetrieveRecipeInformation200ResponseDietaryProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableRetrieveRecipeInformation200ResponseDietaryProperties) IsSet() bool {
	return v.isSet
}

func (v *NullableRetrieveRecipeInformation200ResponseDietaryProperties) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRetrieveRecipeInformation200ResponseDietaryProperties(val *RetrieveRecipeInformation200ResponseDietaryProperties) *NullableRetrieveRecipeInformation200ResponseDietaryProperties {
	return &NullableRetrieveRecipeInformation200ResponseDietaryProperties{value: val, isSet: true}
}

func (v NullableRetrieveRecipeInformation200ResponseDietaryProperties) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRetrieveRecipeInformation200ResponseDietaryProperties) UnmarshalJSON(src []byte) error {
	v.isSet = true
