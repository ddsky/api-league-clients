...
// checks if the TopNewsAPI200ResponseTopNewsInnerNewsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TopNewsAPI200ResponseTopNewsInnerNewsInner{}

// TopNewsAPI200ResponseTopNewsInnerNewsInner struct for TopNewsAPI200ResponseTopNewsInnerNewsInner
type TopNewsAPI200ResponseTopNewsInnerNewsInner struct {
...
func NewTopNewsAPI200ResponseTopNewsInnerNewsInner() *TopNewsAPI200ResponseTopNewsInnerNewsInner {
	this := TopNewsAPI200ResponseTopNewsInnerNewsInner{}
	return &this
}
...
func (o *TopNewsAPI200ResponseTopNewsInnerNewsInner) SetSummary(v string) {
	o.Summary.Set(&v)
}
// SetSummaryNil sets the value for Summary to be an explicit nil
func (o *TopNewsAPI200ResponseTopNewsInnerNewsInner) SetSummaryNil() {
	o.Summary.Set(nil)
}
...
func (o *TopNewsAPI200ResponseTopNewsInnerNewsInner) SetImageNil() {
	o.Image.Set(nil)
}
...
func (o *TopNewsAPI200ResponseTopNewsInnerNewsInner) GetId() int32 {
	if o == nil || IsNil(o.Id) {
		var ret int32
		return ret
	}
...
func (o *TopNewsAPI200ResponseTopNewsInnerNewsInner) SetTextNil() {
	o.Text.Set(nil)
}
...
func (o *TopNewsAPI200ResponseTopNewsInnerNewsInner) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o *TopNewsAPI200ResponseTopNewsInnerNewsInner) HasPublishDate() bool {
...
func (o *TopNewsAPI200ResponseTopNewsInnerNewsInner) SetPublishDateNil() {
...
func (o *TopNewsAPI200ResponseTopNewsInnerNewsInner) SetUrlNil() {
	o.Url.Set(nil)
}
...
// and a boolean to check if the value has been set.
func (o *TopNewsAPI200ResponseTopNewsInnerNewsInner) GetAuthorsOk() ([]*string, bool) {
	if o == nil || IsNil(o.Authors) {
		return nil, false
	}
...
func (o TopNewsAPI200ResponseTopNewsInnerNewsInner) MarshalJSON() ([]byte, error) {
...
func (o TopNewsAPI200ResponseTopNewsInnerNewsInner) ToMap() (map[string]interface{}, error) {
...
type NullableTopNewsAPI200ResponseTopNewsInnerNewsInner struct {
	value *TopNewsAPI200ResponseTopNewsInnerNewsInner
	isSet bool
}

func (v NullableTopNewsAPI200ResponseTopNewsInnerNewsInner) Get() *TopNewsAPI200ResponseTopNewsInnerNewsInner {
	return v.value
}

func (v *NullableTopNewsAPI200ResponseTopNewsInnerNewsInner) Set(val *TopNewsAPI200ResponseTopNewsInnerNewsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTopNewsAPI200ResponseTopNewsInnerNewsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTopNewsAPI200ResponseTopNewsInnerNewsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTopNewsAPI200ResponseTopNewsInnerNewsInner(val *TopNewsAPI200ResponseTopNewsInnerNewsInner) *NullableTopNewsAPI200ResponseTopNewsInnerNewsInner {
	return &NullableTopNewsAPI200ResponseTopNewsInnerNewsInner{value: val, isSet: true}
}

func (v NullableTopNewsAPI200ResponseTopNewsInnerNewsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTopNewsAPI200ResponseTopNewsInnerNewsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
