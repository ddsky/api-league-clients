...
// InlineResponse20026Entities struct for InlineResponse20026Entities
type InlineResponse20026Entities struct {
...
func NewInlineResponse20026Entities() *InlineResponse20026Entities {
	this := InlineResponse20026Entities{}
	return &this
}
...
func (o *InlineResponse20026Entities) SetImageNil() {
	o.Image.Set(nil)
}
...
func (o *InlineResponse20026Entities) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o *InlineResponse20026Entities) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o InlineResponse20026Entities) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20026Entities struct {
	value *InlineResponse20026Entities
	isSet bool
}

func (v NullableInlineResponse20026Entities) Get() *InlineResponse20026Entities {
	return v.value
}

func (v *NullableInlineResponse20026Entities) Set(val *InlineResponse20026Entities) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20026Entities) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20026Entities) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20026Entities(val *InlineResponse20026Entities) *NullableInlineResponse20026Entities {
	return &NullableInlineResponse20026Entities{value: val, isSet: true}
}

func (v NullableInlineResponse20026Entities) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20026Entities) UnmarshalJSON(src []byte) error {
	v.isSet = true
