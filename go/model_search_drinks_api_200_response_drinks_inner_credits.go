...
// checks if the SearchDrinksAPI200ResponseDrinksInnerCredits type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchDrinksAPI200ResponseDrinksInnerCredits{}

// SearchDrinksAPI200ResponseDrinksInnerCredits struct for SearchDrinksAPI200ResponseDrinksInnerCredits
type SearchDrinksAPI200ResponseDrinksInnerCredits struct {
...
func NewSearchDrinksAPI200ResponseDrinksInnerCredits() *SearchDrinksAPI200ResponseDrinksInnerCredits {
	this := SearchDrinksAPI200ResponseDrinksInnerCredits{}
	return &this
}
...
func (o *SearchDrinksAPI200ResponseDrinksInnerCredits) SetTextNil() {
	o.Text.Set(nil)
}
...
func (o *SearchDrinksAPI200ResponseDrinksInnerCredits) SetSourceNameNil() {
...
func (o *SearchDrinksAPI200ResponseDrinksInnerCredits) SetSourceUrlNil() {
	o.SourceUrl.Set(nil)
}
...
func (o SearchDrinksAPI200ResponseDrinksInnerCredits) MarshalJSON() ([]byte, error) {
...
func (o SearchDrinksAPI200ResponseDrinksInnerCredits) ToMap() (map[string]interface{}, error) {
...
type NullableSearchDrinksAPI200ResponseDrinksInnerCredits struct {
	value *SearchDrinksAPI200ResponseDrinksInnerCredits
	isSet bool
}

func (v NullableSearchDrinksAPI200ResponseDrinksInnerCredits) Get() *SearchDrinksAPI200ResponseDrinksInnerCredits {
	return v.value
}

func (v *NullableSearchDrinksAPI200ResponseDrinksInnerCredits) Set(val *SearchDrinksAPI200ResponseDrinksInnerCredits) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchDrinksAPI200ResponseDrinksInnerCredits) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchDrinksAPI200ResponseDrinksInnerCredits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchDrinksAPI200ResponseDrinksInnerCredits(val *SearchDrinksAPI200ResponseDrinksInnerCredits) *NullableSearchDrinksAPI200ResponseDrinksInnerCredits {
	return &NullableSearchDrinksAPI200ResponseDrinksInnerCredits{value: val, isSet: true}
}

func (v NullableSearchDrinksAPI200ResponseDrinksInnerCredits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchDrinksAPI200ResponseDrinksInnerCredits) UnmarshalJSON(src []byte) error {
	v.isSet = true
