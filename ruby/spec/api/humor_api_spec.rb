...
describe 'HumorApi' do
  ...
  # @option opts [Float] :max_age_days The maximum age of the meme in days.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Float] :number The number of gifs to return in range [1,10]
  ...
  # @option opts [Float] :max_length The maximum length of the joke in letters.
  # @option opts [Float] :offset The number of jokes to skip, between 0 and 1000.
  # @option opts [Float] :number The number of jokes, between 1 and 10.
  ...
  # @option opts [Float] :min_rating The minimum rating in range [0.0,1.0] of the meme.
  # @option opts [Float] :max_age_days The maximum age of the meme in days.
  # @option opts [Float] :offset The number of memes to skip, between 0 and 1000.
  # @option opts [Float] :number The number of memes, between 0 and 10.
