...
module OpenapiClient
  class MediaApi
    ...
    # @return [Array<InlineResponse20029>]
    ...
    # @param url [String] The url of the image for which the colors should be detected.
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<InlineResponse20029>, Integer, Hash)>] Array<InlineResponse20029> data, response status code and response headers
    def detect_main_image_color_with_http_info(url, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<InlineResponse20029>'
    ...
    def search_royalty_free_images_with_http_info(query, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InlineResponse20028'
