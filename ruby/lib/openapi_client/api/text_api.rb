...
module OpenapiClient
  class TextApi
    ...
    # @param text [String] The text to tag the part of speech.
    # @param [Hash] opts the optional parameters
    # @return [Array<(PartOfSpeechTagging200Response, Integer, Hash)>] PartOfSpeechTagging200Response data, response status code and response headers
    def part_of_speech_tagging_with_http_info(text, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PartOfSpeechTagging200Response'
    ...
    # @param text [String] The text to be stemmed.
    # @param [Hash] opts the optional parameters
    # @return [Array<(TextStemming200Response, Integer, Hash)>] TextStemming200Response data, response status code and response headers
    def text_stemming_with_http_info(text, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'TextStemming200Response'
