...
public class ScoreTextAPI200ResponseSkimmabilitySubscores {
  ...
  public ScoreTextAPI200ResponseSkimmabilitySubscores bulletPointRatioScore(List<Integer> bulletPointRatioScore) {
    this.bulletPointRatioScore = bulletPointRatioScore;
    return this;
  }

  public ScoreTextAPI200ResponseSkimmabilitySubscores addBulletPointRatioScoreItem(Integer bulletPointRatioScoreItem) {
  ...
  public ScoreTextAPI200ResponseSkimmabilitySubscores imageScore(List<Integer> imageScore) {
    this.imageScore = imageScore;
    return this;
  }

  public ScoreTextAPI200ResponseSkimmabilitySubscores addImageScoreItem(Integer imageScoreItem) {
  ...
  public ScoreTextAPI200ResponseSkimmabilitySubscores highlightedWordRatioScore(List<Integer> highlightedWordRatioScore) {
    this.highlightedWordRatioScore = highlightedWordRatioScore;
    return this;
  }

  public ScoreTextAPI200ResponseSkimmabilitySubscores addHighlightedWordRatioScoreItem(Integer highlightedWordRatioScoreItem) {
  ...
  public ScoreTextAPI200ResponseSkimmabilitySubscores videoScore(List<Integer> videoScore) {
    this.videoScore = videoScore;
    return this;
  }

  public ScoreTextAPI200ResponseSkimmabilitySubscores addVideoScoreItem(Integer videoScoreItem) {
  ...
  public ScoreTextAPI200ResponseSkimmabilitySubscores paragraphScore(List<Integer> paragraphScore) {
    this.paragraphScore = paragraphScore;
    return this;
  }

  public ScoreTextAPI200ResponseSkimmabilitySubscores addParagraphScoreItem(Integer paragraphScoreItem) {
  ...
  public ScoreTextAPI200ResponseSkimmabilitySubscores paragraphHeadlineRatioScore(List<Integer> paragraphHeadlineRatioScore) {
    this.paragraphHeadlineRatioScore = paragraphHeadlineRatioScore;
    return this;
  }

  public ScoreTextAPI200ResponseSkimmabilitySubscores addParagraphHeadlineRatioScoreItem(Integer paragraphHeadlineRatioScoreItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bulletPointRatioScore, scoreTextAPI200ResponseSkimmabilitySubscores.bulletPointRatioScore) &&
        Objects.equals(this.imageScore, scoreTextAPI200ResponseSkimmabilitySubscores.imageScore) &&
        Objects.equals(this.highlightedWordRatioScore, scoreTextAPI200ResponseSkimmabilitySubscores.highlightedWordRatioScore) &&
        Objects.equals(this.videoScore, scoreTextAPI200ResponseSkimmabilitySubscores.videoScore) &&
        Objects.equals(this.paragraphScore, scoreTextAPI200ResponseSkimmabilitySubscores.paragraphScore) &&
        Objects.equals(this.paragraphHeadlineRatioScore, scoreTextAPI200ResponseSkimmabilitySubscores.paragraphHeadlineRatioScore);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScoreTextAPI200ResponseSkimmabilitySubscores
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScoreTextAPI200ResponseSkimmabilitySubscores.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScoreTextAPI200ResponseSkimmabilitySubscores is not found in the empty JSON string", ScoreTextAPI200ResponseSkimmabilitySubscores.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScoreTextAPI200ResponseSkimmabilitySubscores.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScoreTextAPI200ResponseSkimmabilitySubscores` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScoreTextAPI200ResponseSkimmabilitySubscores.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScoreTextAPI200ResponseSkimmabilitySubscores' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScoreTextAPI200ResponseSkimmabilitySubscores> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScoreTextAPI200ResponseSkimmabilitySubscores.class));

       return (TypeAdapter<T>) new TypeAdapter<ScoreTextAPI200ResponseSkimmabilitySubscores>() {
           @Override
           public void write(JsonWriter out, ScoreTextAPI200ResponseSkimmabilitySubscores value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScoreTextAPI200ResponseSkimmabilitySubscores read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScoreTextAPI200ResponseSkimmabilitySubscores given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScoreTextAPI200ResponseSkimmabilitySubscores
   * @throws IOException if the JSON string is invalid with respect to ScoreTextAPI200ResponseSkimmabilitySubscores
   */
  public static ScoreTextAPI200ResponseSkimmabilitySubscores fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScoreTextAPI200ResponseSkimmabilitySubscores.class);
  }

  /**
   * Convert an instance of ScoreTextAPI200ResponseSkimmabilitySubscores to an JSON string
   *
   * @return JSON string
   */
