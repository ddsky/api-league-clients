...
public class MediaApi {
     ...
     * @see <a href="https://apileague.com/apis/rescale-image-api/">Rescale Image Documentation</a>
     */
    public File rescaleImage(String url, Integer width, Integer height, Boolean crop) throws ApiException {
        ApiResponse<File> localVarResp = rescaleImageWithHttpInfo(url, width, height, crop);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://apileague.com/apis/rescale-image-api/">Rescale Image Documentation</a>
     */
    public ApiResponse<File> rescaleImageWithHttpInfo(String url, Integer width, Integer height, Boolean crop) throws ApiException {
     ...
     * @see <a href="https://apileague.com/apis/rescale-image-api/">Rescale Image Documentation</a>
     */
    public okhttp3.Call rescaleImageAsync(String url, Integer width, Integer height, Boolean crop, final ApiCallback<File> _callback) throws ApiException {
     ...
     * Read entire docs
     * @see <a href="https://apileague.com/apis/search-icons-api/">Search Icons Documentation</a>
     */
    public okhttp3.Call searchIconsCall(String query, Boolean onlyPublicDomain, Integer number, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchIconsValidateBeforeCall(String query, Boolean onlyPublicDomain, Integer number, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'query' is set
        if (query == null) {
            throw new ApiException("Missing the required parameter 'query' when calling searchIcons(Async)");
        }

        return searchIconsCall(query, onlyPublicDomain, number, _callback);
     ...
     * @see <a href="https://apileague.com/apis/search-icons-api/">Search Icons Documentation</a>
     */
    public SearchIcons200Response searchIcons(String query, Boolean onlyPublicDomain, Integer number) throws ApiException {
        ApiResponse<SearchIcons200Response> localVarResp = searchIconsWithHttpInfo(query, onlyPublicDomain, number);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://apileague.com/apis/search-icons-api/">Search Icons Documentation</a>
     */
    public ApiResponse<SearchIcons200Response> searchIconsWithHttpInfo(String query, Boolean onlyPublicDomain, Integer number) throws ApiException {
        okhttp3.Call localVarCall = searchIconsValidateBeforeCall(query, onlyPublicDomain, number, null);
        Type localVarReturnType = new TypeToken<SearchIcons200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Search Icons (asynchronously)
     * Search through millions of icons to match any topic you want.
     * @param query The search query. (required)
     * @param onlyPublicDomain If true, only public domain icons will be returned. (optional)
     * @param number The number of icons to return in range [1,100] (optional)
     ...
     * @see <a href="https://apileague.com/apis/search-icons-api/">Search Icons Documentation</a>
     */
    public okhttp3.Call searchIconsAsync(String query, Boolean onlyPublicDomain, Integer number, final ApiCallback<SearchIcons200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchIconsValidateBeforeCall(query, onlyPublicDomain, number, _callback);
        Type localVarReturnType = new TypeToken<SearchIcons200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
