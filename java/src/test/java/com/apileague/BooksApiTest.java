...
public class BooksApiTest {
     ...
     */
    @Test
    public void findSimilarBooksAPITest() throws ApiException {
        Integer id = null;
        Integer number = null;
        FindSimilarBooksAPI200Response response = api.findSimilarBooksAPI(id, number);
     ...
     */
    @Test
    public void searchBooksAPITest() throws ApiException {
        String query = null;
        ...
        Integer offset = null;
        Integer number = null;
        SearchBooksAPI200Response response = api.searchBooksAPI(query, earliestPublishYear, latestPublishYear, minRating, maxRating, genres, authors, isbn, oclc, sort, sortDirection, groupResults, offset, number);
        // TODO: test validations
    }
